      ...
      public:                                                                                                                                                                                          \
        ...
        {                                                                                                                                                                                              \
            ...
            listSize = 1;                                                                                                                                                                              \
                                                                                                                                                                                                       ...
                                                                                                                                                                                                       \
        Maestro_CORBA_Sequence##T(Maestro_CORBA_Sequence##T& l) : Maestro_CORBA_Base(l)                                                                                                                \
        {                                                                                                                                                                                              \
            listSize = l.size();                                                                                                                                                                       \
            if(listSize)                                                                                                                                                                               \
            {                                                                                                                                                                                          \
        ...
        {                                                                                                                                                                                              \
            ...
            {                                                                                                                                                                                          \
                ...
                list = 0;                                                                                                                                                                              \
                                                                                                                                                                                                       ...
                                                                                                                                                                                                       \
        virtual ~Maestro_CORBA_Sequence##T() { clear(); }                                                                                                                                              \
                                                                                                                                                                                                       \
        virtual Maestro_CORBA_Sequence##T& operator=(Maestro_CORBA_Sequence##T& l)                                                                                                                     \
        {                                                                                                                                                                                              \
            if(this != &l)                                                                                                                                                                             \
            {                                                                                                                                                                                          \
                clear();                                                                                                                                                                               \
...
class Maestro_CORBA_Message : public Maestro_Base
{
  public:
    ...
    MAESTRO_INLINE Maestro_CORBA_Message(void* data, unsigned size, void (*onRelease)(void*) = 0, void* env = 0);
    ...
    MAESTRO_INLINE virtual Maestro_CORBA_Message& operator>>(Maestro_CORBA_Short& v);

    MAESTRO_INLINE virtual Maestro_CORBA_Message& operator>>(Maestro_CORBA_UShort& v);

    MAESTRO_INLINE virtual Maestro_CORBA_Message& operator>>(Maestro_CORBA_Long& v);

    MAESTRO_INLINE virtual Maestro_CORBA_Message& operator>>(Maestro_CORBA_ULong& v);

    // This also takes care of Maestro_CORBA_Char and Maestro_CORBA_Boolean
    MAESTRO_INLINE virtual Maestro_CORBA_Message& operator>>(Maestro_CORBA_Octet& v);
    ...
    MAESTRO_INLINE virtual Maestro_CORBA_Message& operator>>(Maestro_CORBA_Base& v);

    MAESTRO_INLINE Maestro_CORBA_Message& operator<<(Maestro_CORBA_Base& v);
...
typedef Maestro_OrderedSet(Maestro_CORBA_Message) Maestro_CORBA_MessageList;

typedef Maestro_CORBA_Sequence(Maestro_CORBA_Octet) Maestro_CORBA_OctetSequence_Base;

class Maestro_CORBA_OctetSequence : virtual public Maestro_CORBA_OctetSequence_Base
{
  public:
    Maestro_CORBA_OctetSequence() : Maestro_CORBA_OctetSequence_Base() {}

    Maestro_CORBA_OctetSequence(Maestro_CORBA_Octet o) : Maestro_CORBA_OctetSequence_Base(o) {}

    Maestro_CORBA_OctetSequence(Maestro_CORBA_OctetSequence& seq) : Maestro_CORBA_Base(seq), Maestro_CORBA_OctetSequence_Base(seq) {}

    Maestro_CORBA_OctetSequence(Maestro_CORBA_Octet* data, unsigned nelem) : Maestro_CORBA_OctetSequence_Base(data, nelem) {}
...
void operator>>(Maestro_CORBA_OctetSequence& seq, Maestro_CORBA_Serializable& ser);
...
Maestro_Message& operator>>(Maestro_Message& msg, Maestro_CORBA_String& str);
...
{
    Maestro_CORBA_Exception(Maestro_CORBA_String name, Maestro_CORBA_ExceptionCode minor_code, Maestro_CORBA_CompletionStatus status);
