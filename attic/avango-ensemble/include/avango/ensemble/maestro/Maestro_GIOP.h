...
struct Maestro_IOP_TaggedProfile : virtual public Maestro_CORBA_Serializable
{
    Maestro_IOP_TaggedProfile();

    Maestro_IOP_TaggedProfile(Maestro_IOP_ProfileId profileTag, Maestro_CORBA_OctetSequence& profileData);
...
typedef Maestro_CORBA_Sequence(Maestro_IOP_TaggedProfile) Maestro_IOP_TaggedProfileList;

const char* const MAESTRO_IOP_IOR_PREFIX = "IOR:";

/********************** Maestro_IOP_IOR *********************/

struct Maestro_IOP_IOR : virtual public Maestro_CORBA_Serializable
{
    Maestro_IOP_IOR() {}
    Maestro_IOP_IOR(Maestro_CORBA_String& typeId, Maestro_IOP_TaggedProfileList& profileList);
...
struct Maestro_IOP_ServiceContext : virtual public Maestro_CORBA_Serializable
{
    Maestro_IOP_ServiceContext() {}
    Maestro_IOP_ServiceContext(Maestro_IOP_ServiceContext& ctx);
    Maestro_IOP_ServiceContext(Maestro_IOP_ServiceID contextId, Maestro_CORBA_OctetSequence& contextData);
...
typedef Maestro_CORBA_Sequence(Maestro_IOP_ServiceContext) Maestro_IOP_ServiceContextList;
...
struct Maestro_GIOP_Version : virtual public Maestro_CORBA_Serializable
{
    Maestro_GIOP_Version();
...
struct Maestro_GIOP_MessageHeader : virtual public Maestro_CORBA_Serializable
{
    Maestro_GIOP_MessageHeader();

    Maestro_GIOP_MessageHeader(Maestro_CORBA_Octet msgType, Maestro_CORBA_ULong msgSize);
...
struct Maestro_GIOP_RequestHeader : virtual public Maestro_CORBA_Serializable
{
    Maestro_GIOP_RequestHeader() {}

    Maestro_GIOP_RequestHeader(Maestro_CORBA_ULong requestId, Maestro_CORBA_Boolean responseExpected, Maestro_CORBA_OctetSequence& objectKey, Maestro_CORBA_String& operationName);
...
struct Maestro_GIOP_ReplyHeader : virtual public Maestro_CORBA_Serializable
{
    Maestro_GIOP_ReplyHeader() {}

    Maestro_GIOP_ReplyHeader(Maestro_CORBA_ULong requestId, Maestro_GIOP_ReplyStatusType replyStatus);
...
struct Maestro_GIOP_CancelRequestHeader : virtual public Maestro_CORBA_Serializable
{
...
struct Maestro_GIOP_LocateRequestHeader : virtual public Maestro_CORBA_Serializable
{
    Maestro_GIOP_LocateRequestHeader() {}
    Maestro_GIOP_LocateRequestHeader(Maestro_CORBA_ULong requestId, Maestro_CORBA_OctetSequence& objectKey);
...
struct Maestro_GIOP_LocateReplyHeader : virtual public Maestro_CORBA_Serializable
{
    Maestro_GIOP_LocateReplyHeader() {}
    Maestro_GIOP_LocateReplyHeader(Maestro_CORBA_ULong requestId, Maestro_GIOP_LocateStatusType locateStatus);
...
struct Maestro_IIOP_ProfileBody : virtual public Maestro_CORBA_Serializable
{
    Maestro_IIOP_ProfileBody();
    Maestro_IIOP_ProfileBody(Maestro_CORBA_String& hostName, Maestro_CORBA_UShort portNumber, Maestro_CORBA_OctetSequence& objectKey);
...
struct Maestro_IIOP_TaggedProfile : Maestro_IOP_TaggedProfile
{
    ...
    Maestro_IIOP_TaggedProfile(Maestro_CORBA_String& hostName, Maestro_CORBA_UShort portNumber, Maestro_CORBA_OctetSequence& objectKey);

    Maestro_IIOP_TaggedProfile(Maestro_CORBA_String& hostName, Maestro_CORBA_UShort portNumber, Maestro_CORBA_String& objectKey);
};
...
struct Maestro_IIOP_IOR : Maestro_IOP_IOR
{
    ...
    Maestro_IIOP_IOR(Maestro_CORBA_String& object_key, Maestro_CORBA_String& host, Maestro_CORBA_UShort port, Maestro_CORBA_String& interface_name);

    Maestro_IIOP_IOR(Maestro_CORBA_OctetSequence& object_key, Maestro_CORBA_String& host, Maestro_CORBA_UShort port, Maestro_CORBA_String& interface_name);
};
