...
class Maestro_GroupMember : virtual public Maestro_Base
{
  public:
    ...
    MAESTRO_INLINE virtual void send(Maestro_EndpID& dest, Maestro_Message& msg, Maestro_MsgSendView& sendView, Maestro_GrpMemb_MsgOptions& msgOps);
    ...
    MAESTRO_INLINE virtual void cast(Maestro_Message& msg, Maestro_MsgSendView& sendView, Maestro_GrpMemb_MsgOptions& msgOps);
  ...
  protected:
    ...
    virtual void grpMemb_ReceiveCast_Callback(Maestro_EndpID&, Maestro_Message&) {}

    virtual void grpMemb_ReceiveSend_Callback(Maestro_EndpID&, Maestro_Message&) {}

    // View callbacks:

    virtual void grpMemb_ViewMsg_Callback(Maestro_GrpMemb_ViewData&, Maestro_Message&) {}

    virtual void grpMemb_MergeState_Callback(Maestro_MessageList /*in*/&, Maestro_Message /*out*/&) {}

    virtual void grpMemb_ViewStateInfo_Callback(Maestro_EndpID /*in*/&, Maestro_GrpMemb_ViewData /*in*/&, Maestro_Message /*in*/&, Maestro_Message /*out*/&, int /*out*/&) {}

    virtual void grpMemb_AcceptedView_Callback(Maestro_GrpMemb_ViewData&, Maestro_Message&) {}

    // The group is blocked for a view change:

    virtual void grpMemb_Block_Callback() {}
    ...
    virtual void grpMemb_Heartbeat_Callback(unsigned) {}
  ...
  private:
    ...
    MAESTRO_INLINE static void receiveCast_Dispatcher(hot_gctx_t gctx, void* env, hot_endpt_t* origin, hot_msg_t msg);

    // Received a point-to-point message.
    MAESTRO_INLINE static void receiveSend_Dispatcher(hot_gctx_t gctx, void* env, hot_endpt_t* origin, hot_msg_t msg);

    // Accepted a new view.
    MAESTRO_INLINE static void acceptedView_Dispatcher(hot_gctx_t gctx, void* env, hot_view_state_t* view_state);
    ...
    // The group is blocked for a view change.
    MAESTRO_INLINE static void block_Dispatcher(hot_gctx_t gctx, void* env);
