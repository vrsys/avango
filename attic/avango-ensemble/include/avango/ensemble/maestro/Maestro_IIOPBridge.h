...
class Maestro_IIOP_BridgeBase : virtual public Maestro_Base
{
  public:
...
class Maestro_IIOP_ConnRef : virtual public Maestro_Base
{
  public:
    Maestro_IIOP_ConnRef() {}
    Maestro_IIOP_ConnRef(Maestro_IIOP_ConnId cid_, Maestro_IIOP_Connection* conn_);
...
typedef Maestro_OrderedSet(Maestro_IIOP_ConnRef) Maestro_IIOP_ConnRefList_Base;
...
class Maestro_IIOP_Connection : virtual public Maestro_Base
{
    friend class Maestro_IIOP_Server;

  public:
    Maestro_IIOP_Connection(Maestro_IIOP_Server* srv_, int fd_, Maestro_IIOP_ConnId connId_);
...
{
    Maestro_IIOP_Reply(Maestro_GIOP_MsgType msgType, Maestro_IIOP_Client* clt);
...
class Maestro_IIOP_Client : virtual public Maestro_IIOP_BridgeBase
{
  public:
    ...
    virtual Maestro_Status locateRequest(Maestro_CORBA_OctetSequence& object_key,
                                         /*OUT*/ Maestro_CORBA_ULong& request_id);
  ...
  protected:
    ...
    virtual void reply_Callback(Maestro_CORBA_ULong, Maestro_GIOP_ReplyStatusType, Maestro_CORBA_Message&) {}

    virtual void locateReply_Callback(Maestro_CORBA_ULong, Maestro_GIOP_LocateStatusType) {}
...
{
    Maestro_IIOP_Request(Maestro_GIOP_MsgType msgType, Maestro_IIOP_Server* srv, Maestro_IIOP_ConnId id);
...
class Maestro_IIOP_Server : virtual public Maestro_IIOP_BridgeBase
{
  ...
  public:
    ...
    virtual Maestro_Status requestReply(Maestro_CORBA_ULong request_id, Maestro_GIOP_ReplyStatusType reply_status, Maestro_CORBA_Message& reply_body, Maestro_IIOP_ConnId cid);

    virtual Maestro_Status locateReply(Maestro_CORBA_ULong request_id, Maestro_GIOP_LocateStatusType locate_status, Maestro_IIOP_ConnId cid);
  ...
  protected:
    ...
    virtual void request_Callback(Maestro_CORBA_ULong, Maestro_CORBA_Boolean, Maestro_CORBA_OctetSequence&, Maestro_CORBA_String&, Maestro_GIOP_Principal&, Maestro_CORBA_Message&, Maestro_IIOP_ConnId)
    {
    }

    virtual void locateRequest_Callback(Maestro_CORBA_ULong, Maestro_CORBA_OctetSequence&, Maestro_IIOP_ConnId) {}

    virtual void cancelRequest_Callback(Maestro_CORBA_ULong, Maestro_IIOP_ConnId) {}
