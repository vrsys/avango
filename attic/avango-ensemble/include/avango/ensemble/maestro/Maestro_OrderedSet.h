...
#define Maestro_OrderedSet(T)                                                                                                                                                                          \
    ...
    {                                                                                                                                                                                                  \
      public:                                                                                                                                                                                          \
        Maestro_OrderedSet##T(Maestro_ErrorHandler* error_handler = 0) : Maestro_Base(error_handler)                                                                                                   \
        {                                                                                                                                                                                              \
            list = 0;                                                                                                                                                                                  \
            listSize = 0;                                                                                                                                                                              \
        }                                                                                                                                                                                              \
                                                                                                                                                                                                       \
        Maestro_OrderedSet##T(T& t, Maestro_ErrorHandler* error_handler = 0) : Maestro_Base(error_handler)                                                                                             \
        {                                                                                                                                                                                              \
            list = new T*[1];                                                                                                                                                                          \
            list[0] = new T(t);                                                                                                                                                                        \
            listSize = 1;                                                                                                                                                                              \
                                                                                                                                                                                                       ...
                                                                                                                                                                                                       \
        Maestro_OrderedSet##T(Maestro_OrderedSet##T& l, Maestro_ErrorHandler* error_handler = 0) : Maestro_Base(error_handler)                                                                         \
        {                                                                                                                                                                                              \
            listSize = l.size();                                                                                                                                                                       \
            if(listSize)                                                                                                                                                                               \
            {                                                                                                                                                                                          \
                ...
                list = 0;                                                                                                                                                                              \
                                                                                                                                                                                                       ...
                                                                                                                                                                                                       \
        Maestro_OrderedSet##T(T* tp, unsigned nelem, Maestro_ErrorHandler* error_handler = 0) : Maestro_Base(error_handler)                                                                            \
        {                                                                                                                                                                                              \
            listSize = nelem;                                                                                                                                                                          \
            if(listSize)                                                                                                                                                                               \
            {                                                                                                                                                                                          \
                ...
                list = 0;                                                                                                                                                                              \
                                                                                                                                                                                                       ...
                                                                                                                                                                                                       \
        virtual ~Maestro_OrderedSet##T() { clear(); }                                                                                                                                                  \
                                                                                                                                                                                                       \
            ...
            {                                                                                                                                                                                          \
                ...
                {                                                                                                                                                                                      \
                    ...
                    msg >> *(list[i]);                                                                                                                                                                 \
                                                                                                                                                                                                       ...
                                                                                                                                                                                                       \
        int messageMagic() const { return MAESTRO_MESSAGE_MAGIC_ORDERED_SET; }                                                                                                                         \
                                                                                                                                                                                                       \
