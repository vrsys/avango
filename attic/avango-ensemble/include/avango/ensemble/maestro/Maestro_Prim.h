...
struct Maestro_Prim_DelayedMessage : public Maestro_Base
{
    ...
    Maestro_Prim_DelayedMessage(Maestro_PrimMsgType type, Maestro_EndpID& dst, Maestro_Message& delayed_msg, Maestro_Prim_MsgOptions mops)
    {
        msg <<= delayed_msg;
        msgType = type;
        msgOps = mops;
    ...
    Maestro_Prim_DelayedMessage(Maestro_PrimMsgType type, Maestro_Message& delayed_msg, Maestro_Prim_MsgOptions mops)
    {
        msg <<= delayed_msg;
        msgType = type;
        msgOps = mops;
...
typedef Maestro_OrderedSet(Maestro_Prim_DelayedMessage) Maestro_Prim_DelayedMessageList;
...
class Maestro_Prim : public Maestro_CSX
{
  ...
  protected:
    ...
    virtual void prim_AcceptedView_Callback(Maestro_Prim_ViewData&, Maestro_Message&) {}
    ...
    virtual void prim_ReceiveCast_Callback(Maestro_EndpID&, Maestro_Message&) {}

    virtual void prim_ReceiveScast_Callback(Maestro_EndpID&, Maestro_Message&) {}

    virtual void prim_ReceiveSend_Callback(Maestro_EndpID&, Maestro_Message&) {}

    virtual void prim_ReceiveLsend_Callback(Maestro_EndpID&, Maestro_Message&) {}
  ...
  private:
    ...
    MAESTRO_INLINE void csx_AcceptedView_Callback(Maestro_Prim_ViewData& viewData, Maestro_Message& viewMsg);

    // Message callbacks:

    void csx_ReceiveCast_Callback(Maestro_EndpID& origin, Maestro_Message& msg) { prim_ReceiveCast_Callback(origin, msg); }

    void csx_ReceiveScast_Callback(Maestro_EndpID& origin, Maestro_Message& msg) { prim_ReceiveScast_Callback(origin, msg); }

    void csx_ReceiveSend_Callback(Maestro_EndpID& origin, Maestro_Message& msg) { prim_ReceiveSend_Callback(origin, msg); }

    void csx_ReceiveLsend_Callback(Maestro_EndpID& origin, Maestro_Message& msg) { prim_ReceiveLsend_Callback(origin, msg); }
