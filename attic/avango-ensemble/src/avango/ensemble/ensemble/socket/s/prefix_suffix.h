...
skt_sendto_info_t* skt_Sendto_info_val(value info_v) { return (skt_sendto_info_t*)Field(info_v, 1); }

void skt_Sendto_info_free(value info_v) { free(skt_Sendto_info_val(info_v)); }
...
int prefixed2_gather_p(value prefix1_v, value prefix2_v, value ofs2_v, value len2_v, value iova_v)
{
    value t_v, iov_v;
    int i, nvecs, len, iovlen;
    char* buf;
