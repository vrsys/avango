...
namespace
{
osg::Vec3 BoundingSphereGetCenter(const osg::BoundingSphere& b) { return b.center(); }
...
void init_OSGBoundingSphere(void)
{
    ...
    class_<av::osg::BoundingSphere, av::Link<av::osg::BoundingSphere>, bases<av::FieldContainer>, boost::noncopyable>("BoundingSphere", "docstring", no_init).def("__repr__", BoundingSphereString);
}
