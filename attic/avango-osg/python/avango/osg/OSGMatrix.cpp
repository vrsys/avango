...
namespace
{
osg::Matrix::value_type MatrixGetElement(const osg::Matrix& m, int row, int col) { return m(row, col); }

void MatrixSetElement(osg::Matrix& m, int row, int col, osg::Matrix::value_type value) { m(row, col) = value; }

osg::Vec3 MatrixGetTranslate(const osg::Matrix& m) { return m.getTrans(); }

osg::Vec3 MatrixGetScale(const osg::Matrix& m) { return m.getScale(); }

osg::Matrix MatrixMakeScale(osg::Matrix::value_type v) { return osg::Matrix::scale(v, v, v); }
...
osg::Vec3 MatrixToHpr(osg::Matrix& rotation)
{
    ...
    else
    {
        ...
        if((osg::equivalent(sh, 0.0, magic_epsilon) && osg::equivalent(ch, 0.0, magic_epsilon)) || (osg::equivalent(sr, 0.0, magic_epsilon) && osg::equivalent(cr, 0.0, magic_epsilon)))
        {
...
void init_OSGMatrix(void)
{
    ...
    void (osg::Matrix::*mrot3)(osg::Matrix::value_type, osg::Matrix::value_type, osg::Matrix::value_type, osg::Matrix::value_type) = &osg::Matrix::makeRotate;
    void (osg::Matrix::*mrot4)(const osg::Quat&) = &osg::Matrix::makeRotate;
    void (osg::Matrix::*mrot5)(osg::Matrix::value_type, const osg::Vec3&, osg::Matrix::value_type, const osg::Vec3&, osg::Matrix::value_type, const osg::Vec3&) = &osg::Matrix::makeRotate;
    ...
    osg::Matrix (*makeRot3)(osg::Matrix::value_type, osg::Matrix::value_type, osg::Matrix::value_type, osg::Matrix::value_type) = &osg::Matrix::rotate;
    osg::Matrix (*makeRot4)(const osg::Quat&) = &osg::Matrix::rotate;
    osg::Matrix (*makeRot5)(osg::Matrix::value_type, const osg::Vec3&, osg::Matrix::value_type, const osg::Vec3&, osg::Matrix::value_type, const osg::Vec3&) = &osg::Matrix::rotate;
