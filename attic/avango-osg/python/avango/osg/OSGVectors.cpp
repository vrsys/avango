...
namespace
{
osg::Vec2 operator*(osg::Vec2::value_type lhs, osg::Vec2 rhs) { return rhs * lhs; }

osg::Vec3 operator*(osg::Vec3::value_type lhs, osg::Vec3 rhs) { return rhs * lhs; }

osg::Vec3 operator*(osg::Vec3 lhs, osg::Quat rhs) { return rhs * lhs; }

osg::Vec4 operator*(osg::Vec4::value_type lhs, osg::Vec4 rhs) { return rhs * lhs; }
...
osg::Vec2::value_type distanceVec2(const osg::Vec2& pos1, const osg::Vec2& pos2) { return (pos1 - pos2).length(); }

osg::Vec3::value_type distanceVec3(const osg::Vec3& pos1, const osg::Vec3& pos2) { return (pos1 - pos2).length(); }
} // namespace
