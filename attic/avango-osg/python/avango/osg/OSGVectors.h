...
template <class T>
void setX(T* self, typename T::value_type value)
{
    self->_v[0] = value;
}
template <class T>
void setY(T* self, typename T::value_type value)
{
    self->_v[1] = value;
}
template <class T>
void setZ(T* self, typename T::value_type value)
{
    self->_v[2] = value;
}
template <class T>
void setW(T* self, typename T::value_type value)
{
    self->_v[3] = value;
}
