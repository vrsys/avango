...
av::osg::Box::Box()
    : MatrixTransform(),
      ...
      mGeode(new ::osg::Geode), mDimChanged(false) //,
...
/* virtual */ void av::osg::Box::fieldHasChangedLocalSideEffect(const av::Field& field)
{
...
/* virtual */ void av::osg::Box::evaluateLocalSideEffect()
{
...
::osg::ref_ptr<::osg::Box> av::osg::Box::getOsgBox() const { return mBox; }

::osg::ref_ptr<::osg::ShapeDrawable> av::osg::Box::getOsgShapeDrawable() const { return mShapeDrawable; }
