...
av::osg::Camera::Camera(::osg::Camera* osgcamera) :
  Transform(osgcamera),
  mOsgCamera(osgcamera)
{
  ...
  AV_FC_ADD_ADAPTOR_FIELD(ViewMatrix,
                          boost::bind(&Camera::getViewMatrixCB, this, _1),
                          boost::bind(&Camera::setViewMatrixCB, this, _1));
  AV_FC_ADD_ADAPTOR_FIELD(ProjectionMatrix,
                          boost::bind(&Camera::getProjectionMatrixCB, this, _1),
                          boost::bind(&Camera::setProjectionMatrixCB, this, _1));
  AV_FC_ADD_ADAPTOR_FIELD(Viewport,
                          boost::bind(&Camera::getViewportCB, this, _1),
                          boost::bind(&Camera::setViewportCB, this, _1));
  AV_FC_ADD_ADAPTOR_FIELD(RenderOrder,
                          boost::bind(&Camera::getRenderOrderCB, this, _1),
                          boost::bind(&Camera::setRenderOrderCB, this, _1));
  AV_FC_ADD_ADAPTOR_FIELD(RenderTargetImplementation,
                          boost::bind(&Camera::getRenderTargetImplementationCB, this, _1),
                          boost::bind(&Camera::setRenderTargetImplementationCB, this, _1));
  AV_FC_ADD_ADAPTOR_FIELD(Attachment,
                          boost::bind(&Camera::getAttachmentCB, this, _1),
                          boost::bind(&Camera::setAttachmentCB, this, _1));
}
...
::osg::Camera*
av::osg::Camera::getOsgCamera() const
{
  return mOsgCamera;
}

void
av::osg::Camera::getClearMaskCB(const av::SFInt::GetValueEvent& event)
{
  *(event.getValuePtr()) = mOsgCamera->getClearMask();
}
...
void
av::osg::Camera::getClearColorCB(const av::osg::SFVec4::GetValueEvent& event)
{
  *(event.getValuePtr()) = mOsgCamera->getClearColor();
}

void
av::osg::Camera::setClearColorCB(const av::osg::SFVec4::SetValueEvent& event)
{
  mOsgCamera->setClearColor(event.getValue());
}

void
av::osg::Camera::getViewMatrixCB(const av::osg::SFMatrix::GetValueEvent& event)
{
  *(event.getValuePtr()) = mOsgCamera->getViewMatrix();
}

void
av::osg::Camera::setViewMatrixCB(const av::osg::SFMatrix::SetValueEvent& event)
{
  mOsgCamera->setViewMatrix(event.getValue());
}

void
av::osg::Camera::getProjectionMatrixCB(const av::osg::SFMatrix::GetValueEvent& event)
{
  *(event.getValuePtr()) = mOsgCamera->getProjectionMatrix();
}

void
av::osg::Camera::setProjectionMatrixCB(const av::osg::SFMatrix::SetValueEvent& event)
{
  mOsgCamera->setProjectionMatrix(event.getValue());
}

void
av::osg::Camera::getViewportCB(const av::osg::SFVec4::GetValueEvent& event)
{
  ::osg::Vec4 result;
...
void
av::osg::Camera::setViewportCB(const av::osg::SFVec4::SetValueEvent& event)
{
...
void
av::osg::Camera::getRenderOrderCB(const av::SFInt::GetValueEvent& event)
{
  *(event.getValuePtr()) = mOsgCamera->getRenderOrder();
}

void
av::osg::Camera::setRenderOrderCB(const av::SFInt::SetValueEvent& event)
{
  mOsgCamera->setRenderOrder(static_cast< ::osg::Camera::RenderOrder >(event.getValue()));
}

void
av::osg::Camera::getRenderTargetImplementationCB(const av::SFInt::GetValueEvent& event)
{
  *(event.getValuePtr()) = mOsgCamera->getRenderTargetImplementation();
}

void
av::osg::Camera::setRenderTargetImplementationCB(const av::SFInt::SetValueEvent& event)
{
  mOsgCamera->setRenderTargetImplementation(static_cast< ::osg::Camera::RenderTargetImplementation >(event.getValue()));
}

/* virtual */ void
av::osg::Camera::getAttachmentCB(const av::osg::MFCameraAttachment::GetValueEvent& event)
{
  ::osg::Camera::BufferAttachmentMap& buffer_map(mOsgCamera->getBufferAttachmentMap());
  MFCameraAttachment::ContainerType attachments;
  for (::osg::Camera::BufferAttachmentMap::const_iterator i = buffer_map.begin();
       i != buffer_map.end(); ++i)
  {
...
/* virtual */ void
av::osg::Camera::setAttachmentCB(const av::osg::MFCameraAttachment::SetValueEvent& event)
{
  ::osg::Camera::BufferAttachmentMap& buffer_map(mOsgCamera->getBufferAttachmentMap());
  ...
  // Add given ones
  for (MFCameraAttachment::ContainerType::const_iterator i = event.getValue().begin();
       i != event.getValue().end(); ++i)
  {
