...
av::osg::ClipNode::ClipNode(::osg::ClipNode* osggroup) : Group(osggroup), mOsgClipNode(osggroup)
{
    AV_FC_ADD_ADAPTOR_FIELD(ClipPlanes, boost::bind(&av::osg::ClipNode::getClipPlaneCB, this, _1), boost::bind(&av::osg::ClipNode::setClipPlaneCB, this, _1));
}

/* virtual */
av::osg::ClipNode::~ClipNode() {}

/* static */ void av::osg::ClipNode::initClass()
{
...
::osg::ClipNode* av::osg::ClipNode::getOsgClipNode() const { return mOsgClipNode; }

void av::osg::ClipNode::createClipBox(::osg::Vec3 min, ::osg::Vec3 max)
{
...
/* virtual */ void av::osg::ClipNode::getClipPlaneCB(const av::osg::MFClipPlane::GetValueEvent& event)
{
...
/* virtual */ void av::osg::ClipNode::setClipPlaneCB(const av::osg::MFClipPlane::SetValueEvent& event)
{
    int num_clipPlanes = mOsgClipNode->getNumClipPlanes();
