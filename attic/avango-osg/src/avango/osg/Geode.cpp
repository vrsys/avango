...
av::osg::Geode::Geode(::osg::Geode* osggeode) : Node(osggeode), mOsgGeode(osggeode)
{
    AV_FC_ADD_ADAPTOR_FIELD(Drawables, boost::bind(&Geode::getDrawablesCB, this, _1), boost::bind(&Geode::setDrawablesCB, this, _1));
}

av::osg::Geode::~Geode() {}

void av::osg::Geode::initClass()
{
...
::osg::Geode* av::osg::Geode::getOsgGeode() const { return mOsgGeode; }

/* virtual */ void av::osg::Geode::getDrawablesCB(const av::osg::MFDrawable::GetValueEvent& event)
{
...
/* virtual */ void av::osg::Geode::setDrawablesCB(const av::osg::MFDrawable::SetValueEvent& event)
{
    int num_drawables = mOsgGeode->getNumDrawables();
