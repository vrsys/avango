...
av::osg::LayerGroup::LayerGroup(::osg::Group* osggroup) : Group(osggroup), mOsgGroup(osggroup), mLayerModeChanged(false), mChildrenChanged(false), mFirstDrawable(0)
{
...
void av::osg::LayerGroup::initClass()
{
...
/* virtual */ void av::osg::LayerGroup::fieldHasChangedLocalSideEffect(const av::Field& field)
{
...
/* virtual */ void av::osg::LayerGroup::evaluateLocalSideEffect()
{
...
/* virtual */ void av::osg::LayerGroup::setChildrenCB(const av::osg::MFNode::SetValueEvent& event)
{
    Group::setChildrenCB(event);
    mChildrenChanged = true;
}

void av::osg::LayerGroup::updateDrawCallbacks(::osg::Node* osg_node, ::osg::Drawable*& firstdrawable)
{
...
av::osg::LayerGroup::DrawCallbackBaseLayer::DrawCallbackBaseLayer(::osg::Node* osg_node, int mode, ::osg::Drawable* firstdrawable) : mNode(osg_node), mMode(mode), mFirstDrawable(firstdrawable) {}

/* virtual */ void av::osg::LayerGroup::DrawCallbackBaseLayer::drawImplementation(::osg::RenderInfo& renderInfo, const ::osg::Drawable*) const
{
...
bool av::osg::LayerGroup::DrawCallbackBaseLayer::drawWithStencil(::osg::RenderInfo& renderInfo, ::osg::Node* osg_node, bool firstdrawablefound) const
{
    ...
    if(osg_geode != 0)
    {
        ...
        if(osg_geode->getStateSet() != 0)
            state->pushStateSet(osg_geode->getStateSet());
        state->apply();
    ...
    if(osg_group != 0)
    {
        ...
        if(firstdrawablefound == true && osg_group->getStateSet() != 0)
            state->pushStateSet(osg_group->getStateSet());
        state->apply();
        ...
        if(firstdrawablefound == true && osg_group->getStateSet() != 0 && osg_group != mNode)
            state->popStateSet();
        state->apply();
