...
av::osg::LoadFile::LoadFile() : MatrixTransform(), mFilenameChanged(false), mFilename(), mOldFilename()
{
...
void av::osg::LoadFile::initClass()
{
...
::osg::Node* av::osg::LoadFile::getLoadedNode() const { return mLoadedNode.get(); }

/* virtual */ void av::osg::LoadFile::fieldHasChangedLocalSideEffect(const av::Field& field)
{
...
/* virtual */ void av::osg::LoadFile::evaluateLocalSideEffect()
{
