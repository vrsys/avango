...
av::osg::Program::Program(::osg::Program* osgprogram) : StateAttribute(osgprogram), mOsgProgram(osgprogram)
{
    AV_FC_ADD_ADAPTOR_FIELD(ShaderList, boost::bind(&Program::getShaderListCB, this, _1), boost::bind(&Program::setShaderListCB, this, _1));
}

av::osg::Program::~Program() {}

void av::osg::Program::initClass()
{
...
::osg::Program* av::osg::Program::getOsgProgram() const { return mOsgProgram; }

/* virtual */ void av::osg::Program::getShaderListCB(const av::osg::MFShader::GetValueEvent& event)
{
...
/* virtual */ void av::osg::Program::setShaderListCB(const av::osg::MFShader::SetValueEvent& event)
{
...
void av::osg::Program::touchFields() { ShaderList.touch(); }
