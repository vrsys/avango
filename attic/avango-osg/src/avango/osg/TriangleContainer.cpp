...
void av::osg::TriangleContainer::updateNormal()
{
...
void av::osg::TriangleContainer::updateColor()
{
...
void av::osg::TriangleContainer::fieldHasChangedLocalSideEffect(const av::Field& field)
{
...
unsigned av::osg::TriangleContainer::getTriangleCount() const { return mTriangleCount; }

unsigned av::osg::TriangleContainer::getNormalCount() const { return mNormalCount; }
