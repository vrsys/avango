...
av::osg::NetMatrixTransform::NetMatrixTransform() : MatrixTransform(), NetNode()
{
    ...
    AV_FC_ADD_ADAPTOR_FIELD(SharedContainers, boost::bind(&NetMatrixTransform::getSharedContainersCB, this, _1), boost::bind(&NetMatrixTransform::setSharedContainersCB, this, _1));
...
/* static */ void av::osg::NetMatrixTransform::initClass()
{
...
/* virtual */ void av::osg::NetMatrixTransform::fieldHasChangedLocalSideEffect(const Field& field)
{
...
/* virtual */ void av::osg::NetMatrixTransform::evaluate() { MatrixTransform::evaluate(); }

/* virtual */ void av::osg::NetMatrixTransform::refImpl() {}

/* virtual */ void av::osg::NetMatrixTransform::unrefImpl() {}

/* virtual */ int av::osg::NetMatrixTransform::refCountImpl() { return 1; }

/* virtual */ void av::osg::NetMatrixTransform::_join(const std::string& fragment)
{
...
/* virtual */ void av::osg::NetMatrixTransform::_acceptNewView(const std::vector<std::string>& members, const std::vector<std::string>& newMembers, const std::vector<std::string>& departedMembers)
{
...
/* virtual */ void av::osg::NetMatrixTransform::_getStateFragment(const std::string& fragment, Msg& stateMsg)
{
...
/* virtual */ void av::osg::NetMatrixTransform::_setStateFragment(const std::string& fragment, Msg& stateMsg)
{
...
/* virtual */ void av::osg::NetMatrixTransform::_removeStateFragment(const std::string& fragment)
{
...
void av::osg::NetMatrixTransform::fragmentChildrenChanged() { Children.touch(); }

void av::osg::NetMatrixTransform::sharedContainersChanged() { SharedContainers.touch(); }

/* virtual */
void av::osg::NetMatrixTransform::getChildrenCB(const av::osg::MFNode::GetValueEvent& event)
{
    ...
    for(EIDGrpMap::iterator grpIter = mGroupMap.begin(); grpIter != mGroupMap.end(); ++grpIter)
    {
...
/* virtual */
void av::osg::NetMatrixTransform::setChildrenCB(const av::osg::MFNode::SetValueEvent& event)
{
    for(EIDGrpMap::iterator grpIter = mGroupMap.begin(); grpIter != mGroupMap.end(); ++grpIter)
    {
    ...
    for(MFNode::ContainerType::const_iterator nodeIter = event.getValue().begin(); nodeIter != event.getValue().end(); ++nodeIter)
    {
        ...
        if(node->isDistributed())
        {
            ...
            {
                AVANGO_LOG(logger, av::logging::WARN, boost::str(boost::format("cannot find node @0x%1% (created by '%2%') in group map") % node.getPtr() % node->netCreator()));
            }
        }
        else
        {
...
/* virtual */ void av::osg::NetMatrixTransform::getSharedContainersCB(const av::MFContainer::GetValueEvent& event)
{
...
/* virtual */ void av::osg::NetMatrixTransform::setSharedContainersCB(const MFContainer::SetValueEvent& event)
{
