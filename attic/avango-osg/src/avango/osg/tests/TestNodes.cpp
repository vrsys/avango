...
{
  public:
    InitNodeFixture() { av::osg::Init::initClass(); }
};
...
TEST_FIXTURE(InitNodeFixture, testGroupNodes)
{
    ...
    av::osg::ObjectLink* av_g_root_objectlink = dynamic_cast<av::osg::ObjectLink*>(osg_g_root_ref_ptr->getUserData());
    av::osg::ObjectLink* av_g_child1_objectlink = dynamic_cast<av::osg::ObjectLink*>(osg_g_child1->getUserData());
    av::osg::ObjectLink* av_g_child2_objectlink = dynamic_cast<av::osg::ObjectLink*>(osg_g_child2->getUserData());
...
TEST_FIXTURE(InitNodeFixture, testMatrixTransform)
{
    ...
    ::osg::Matrix osg_m(0.0, 0.1, 0.2, 0.3, 1.0, 1.1, 1.2, 1.3, 2.0, 2.1, 2.2, 2.3, 3.0, 3.1, 2.2, 3.3);
