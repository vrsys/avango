...
av::osg::viewer::View::View(::osgViewer::View* osgview) : av::osg::Object(osgview), mOsgView(osgview), mOsgStateSetManipulator(new ::osgGA::StateSetManipulator()), mStatsMode(0)
{
    AV_FC_ADD_ADAPTOR_FIELD(MasterCamera, boost::bind(&av::osg::viewer::View::getMasterCameraCB, this, _1), boost::bind(&av::osg::viewer::View::setMasterCameraCB, this, _1));

    AV_FC_ADD_FIELD(SlaveCameras, MFCamera::ContainerType());

    AV_FC_ADD_ADAPTOR_FIELD(Scene, boost::bind(&av::osg::viewer::View::getSceneCB, this, _1), boost::bind(&av::osg::viewer::View::setSceneCB, this, _1));
...
/* static */ void av::osg::viewer::View::initClass()
{
...
/* virtual */ void av::osg::viewer::View::fieldHasChangedLocalSideEffect(const Field& field)
{
    ...
    if(&field == &SlaveCameras)
    {
        ...
        for(MFCamera::ContainerType::const_iterator camera = slave_cameras.begin(); camera != slave_cameras.end(); ++camera)
        {
            if(camera->isValid())
            {
...
/* virtual */ void av::osg::viewer::View::evaluateLocalSideEffect()
{
...
::osgViewer::View* av::osg::viewer::View::getOsgView() const { return mOsgView; }

/* virtual */ void av::osg::viewer::View::getMasterCameraCB(const SFCamera::GetValueEvent& event) { *(event.getValuePtr()) = get_from_osg_object<Camera>(mOsgView->getCamera()); }

/* virtual */ void av::osg::viewer::View::setMasterCameraCB(const SFCamera::SetValueEvent& event)
{
...
/* virtual */ void av::osg::viewer::View::getSceneCB(const SFNode::GetValueEvent& event) { *(event.getValuePtr()) = get_from_osg_object<Node>(mOsgView->getSceneData()); }

/* virtual */ void av::osg::viewer::View::setSceneCB(const SFNode::SetValueEvent& event) { mOsgView->setSceneData(event.getValue().isValid() ? event.getValue()->getOsgNode() : 0); }
