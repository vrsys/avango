...
{
public:
  MirrorCamera(osg::ref_ptr<osg::Camera> camera, osg::Matrix from_origin) :
    m_camera(camera),
    m_from_origin(from_origin)
  {
  }
...
{
public:
  RotateCallback(osg::Vec3 axis, double speed) :
    m_axis(axis),
    m_angle(0.),
    m_speed(speed)
  {
...
class ScreenCoord :
  public shade::ShaderBase<ScreenCoord, shade::shaders::Initializeable, shade::shaders::PerStageGettable<shade::vec2> >
{
public:

  /*virtual*/ shade::void_<> init_vertex(void)
  {
    return invoke< shade::void_<> >("ScreenCoord_init_vertex_impl");
  }

  /*virtual*/ shade::vec2<> get_fragment(void)
  {
    return invoke< shade::vec2<> >("ScreenCoord_get_fragment_impl");
  }
...
class Reflection :
  public shade::ShaderBase<Reflection, shade::shaders::IMaterial>
{
public:
  /*virtual*/ shade::vec4<> shade(void)
  {
    return invoke< shade::vec4<> >("Reflection_shade_impl");
  }
...
osg::ref_ptr<osg::Group> build_satellites(void)
{
  ...
  struct
  {
    ...
    { osg::Vec4(1., 0., 0., 1.), osg::Vec3(2., 0., 0.) },
