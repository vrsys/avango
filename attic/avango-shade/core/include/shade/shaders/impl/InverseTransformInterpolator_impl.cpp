...
void shade::shaders::InverseTransformInterpolator<T>::generate_weighting(formatter::Generator& generator, const std::string& component, int index) const
{
    std::string class_name(InverseTransformInterpolator<T>::get_class_name());
...
template <template <class> class T>
void shade::shaders::InverseTransformInterpolator<T>::init_post_geometry_inline(formatter::Generator& generator) const
{
    T<Type> type;
    std::string class_name(InverseTransformInterpolator<T>::get_class_name());
    ...
    generator.handle_function_call_parameter_begin();
    {
        generator.handle_function_call_begin();
        generator.handle_function_call_name_begin();
        generator.handle_identifier("Geometry_transform_inverse");
        generator.handle_function_call_name_end();
        generator.handle_function_call_parameter_list_begin();
        generator.handle_function_call_parameter_begin();
        generator.handle_identifier("geometry");
...
template <template <class> class T>
shade::void_<> shade::shaders::InverseTransformInterpolator<T>::init_post_geometry(void)
{
    return this->template invoke_inline<void_<>>(boost::bind(&InverseTransformInterpolator<T>::init_post_geometry_inline, boost::ref(*this), _1));
}
