...
namespace shade
{
  ...
  namespace types
  {
    ...
    public:
      ...
      {
      public:
        InIterator(InIteratorImpl* impl) :
          m_impl(impl)
        {
        }

        InIterator(const InIterator& other) :
        ...
        const boost::shared_ptr<Shader> operator*(void) const
        {
      ...
      {
      public:
        OutIterator(OutIteratorImpl* impl) :
          m_impl(impl)
        {
        }

        OutIterator(const OutIterator& other) :
          m_impl(other.m_impl->clone())
        {
        }
        ...
        boost::shared_ptr<Shader>& operator*(void)
        {
          return m_impl->dereference();
        }
