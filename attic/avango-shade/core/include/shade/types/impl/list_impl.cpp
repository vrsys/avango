...
shade::list_base<Container, Qualifier>::list_base(void) : TypeBase<list_base<Container, Qualifier>, Qualifier>(formatter::Constants::list)
{
}
...
template <class Container, class Qualifier>
shade::list_base<Container, Qualifier>::Accessor::Accessor(list_base<Container, Qualifier>& l) : m_list(l), m_touched(false)
{
}
...
template <class T, class Qualifier>
shade::list<std::vector<boost::shared_ptr<T>>, Qualifier>::ListInIteratorImpl::ListInIteratorImpl(typename std::vector<boost::shared_ptr<T>>::const_iterator iter) : m_iter(iter)
{
}
...
template <class T, class Qualifier>
shade::list<std::vector<boost::shared_ptr<T>>, Qualifier>::ListOutIteratorImpl::ListOutIteratorImpl(std::vector<boost::shared_ptr<T>>& container) : m_container(container)
{
}
