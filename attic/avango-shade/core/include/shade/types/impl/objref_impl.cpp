...
template<class P, class Qualifier> boost::shared_ptr<shade::Type::State> shade::objref_base<P, Qualifier>::create_state(const PipelineState& ps) const
{
...
template<class P, class Qualifier> shade::objref_base<P, Qualifier>::objref_base(void) :
  TypeBase<objref_base<P, Qualifier>, Qualifier>(formatter::Constants::objref)
{
}

template<class P, class Qualifier> P shade::objref_base<P, Qualifier>::operator->(void)
{
  return m_ref;
}

template<class P, class Qualifier> P shade::objref_base<P, Qualifier>::get(void) const
{
  return m_ref;
}

template<class P, class Qualifier> P& shade::objref_base<P, Qualifier>::operator=(const P& v)
{
  m_ref = v;
...
template<class P, class Qualifier> shade::objref_base<P, Qualifier>::operator bool(void)
{
