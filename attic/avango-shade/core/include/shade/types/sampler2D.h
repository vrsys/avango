...
#ifndef shade_types_sampler2D_H
#define shade_types_sampler2D_H shade_types_sampler2D_H
...
class sampler2D : public TypeBase<sampler2D, uniform>, public types::TextureAccessor
{
  public:
    sampler2D(void);
