...
#ifndef shade_types_sampler2DArray_H
#define shade_types_sampler2DArray_H shade_types_sampler2DArray_H
...
namespace shade
{
class sampler2DArray : public TypeBase<sampler2DArray, uniform>, public types::TextureAccessor
{
  public:
    sampler2DArray(void);
...
#endif /* shade_types_sampler2DArray_H */
