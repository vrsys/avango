...
#ifndef shade_types_samplerCube_H
#define shade_types_samplerCube_H shade_types_samplerCube_H
...
namespace shade
{
class samplerCube : public TypeBase<samplerCube, uniform>, public types::TextureAccessor
{
  public:
    samplerCube(void);
...
#endif /* shade_types_samplerCube_H */
