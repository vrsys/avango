...
#define SHADE__DEF_FUNC(r, class_, value) (class_::def(&class_::BOOST_PP_TUPLE_ELEM(2, 0, value), BOOST_PP_STRINGIZE(BOOST_PP_TUPLE_ELEM(2, 0, value)), BOOST_PP_TUPLE_ELEM(2, 1, value)))

#define SHADE__ENUM_DEF(class_, seq) BOOST_PP_SEQ_ENUM(BOOST_PP_SEQ_FOR_EACH(SHADE__DEF_FUNC, class_, seq)),

#define SHADE__DEF(type_, var, class_, seq) type_ class_::var[] = {BOOST_PP_IF(BOOST_PP_SEQ_SIZE(seq), SHADE__ENUM_DEF, SHADE__EMPTY2)(class_, seq) type_()};
...
#define SHADE__TEMPLATE_T_Q_DEF(type_, var, class_, seq)                                                                                                                                               \
    ...
    type_ class_<T, Q>::var[] = {BOOST_PP_IF(BOOST_PP_SEQ_SIZE(seq), SHADE__ENUM_DEF, SHADE__EMPTY2)(class_, seq) type_()};
...
#define SHADE__TEMPLATE_T_DEF(type_, var, class_, seq)                                                                                                                                                 \
    ...
    type_ class_<T>::var[] = {BOOST_PP_IF(BOOST_PP_SEQ_SIZE(seq), SHADE__ENUM_DEF, SHADE__EMPTY2)(class_, seq) type_()};
...
#define SHADE_TEMPLATE_T_Q_INIT(class_, file, method_seq, attribute_seq)                                                                                                                               \
    template <template <class> class T, class Q>                                                                                                                                                       \
    const std::string class_<T, Q>::class_name(BOOST_PP_STRINGIZE(class_));                                                                                                                            \
    template <template <class> class T, class Q>                                                                                                                                                       \
    const std::string class_<T, Q>::source_name(file);                                                                                                                                                 \
...
#define SHADE_TEMPLATE_T_INIT(class_, file, method_seq, attribute_seq)                                                                                                                                 \
    template <template <class> class T>                                                                                                                                                                \
    const std::string class_<T>::class_name(BOOST_PP_STRINGIZE(class_));                                                                                                                               \
    template <template <class> class T>                                                                                                                                                                \
    const std::string class_<T>::source_name(file);                                                                                                                                                    \
