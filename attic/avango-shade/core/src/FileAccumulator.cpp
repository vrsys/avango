...
shade::FileAccumulator::FileAccumulator(const FileResolver& resolver) :
  m_resolver(resolver),
  m_glsl_version(0),
  m_requires_gpu_shader4_ext(false)
{
}
...
std::string shade::FileAccumulator::get_str() const
{
  return m_content;
}

int shade::FileAccumulator::get_glsl_version(void) const
{
  return m_glsl_version;
}

bool shade::FileAccumulator::requires_gpu_shader4_ext(void) const
{
  return m_requires_gpu_shader4_ext;
}
