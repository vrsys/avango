...
namespace
{
  ...
  {
  public:
    ContentState(Generator& generator, Scope& scope, const FunctionCall& call, std::ostream& error_log) :
  ...
  {
  public:
    IdentifierElement(std::string name) :
      m_name(name)
    {
    }
  ...
  {
  public:
    VerbatimElement(std::string code) :
      m_code(code)
    {
    }
    ...
    /*virtual*/ void get_content(Generator& generator, Scope&, const FunctionCall&, std::ostream& error_log) const
    {
      generator.handle_verbatim(m_code);
    }
  ...
  {
  public:
    LiteralObjrefElement(ReferenceValue::Index ref) :
      m_ref(ref)
    {
    }
    ...
    /*virtual*/ void get_content(Generator& generator, Scope&, const FunctionCall&, std::ostream& error_log) const
    {
      generator.handle_literal_objref(m_ref);
    }

    /*virtual*/ boost::shared_ptr<const Value> evaluate(const Scope& scope) const
    {
      return boost::shared_ptr<const Value>(new ReferenceValue(m_ref));
    }

    ReferenceValue::Index value(void) const
    {
      return m_ref;
    }
  ...
  {
  public:
    LiteralListElement(ReferenceValue::Index begin, ReferenceValue::Index end) :
      m_begin(begin),
      m_end(end)
    {
    }
    ...
    /*virtual*/ void get_content(Generator& generator, Scope&, const FunctionCall&, std::ostream& error_log) const
    {
      generator.handle_literal_list(m_begin, m_end);
    }

    /*virtual*/ boost::shared_ptr<const Value> evaluate(const Scope& scope) const
    {
      return boost::shared_ptr<const Value>(new ListValue(m_begin, m_end));
    }
  ...
  public:
    ...
    /*virtual*/ boost::shared_ptr<const Value> evaluate(const Scope& scope) const
    {
      return boost::shared_ptr<const Value>(new IntValue(m_value));
    }
  ...
  {
  public:
    LiteralFloatElement(float value) :
      m_value(value)
    {
    }
  ...
  {
  public:
    LiteralVec2Element(float x, float y) :
      m_x(x),
      m_y(y)
    {
    }
  ...
  {
  public:
    LiteralVec3Element(float x, float y, float z) :
      m_x(x),
      m_y(y),
      m_z(z)
    {
  ...
  {
  public:
    LiteralVec4Element(float x, float y, float z, float w) :
      m_x(x),
      m_y(y),
      m_z(z),
      m_w(w)
  ...
  {
  public:
    TypeElement(Constants::Type type) :
      m_type(type)
    {
    }
    ...
    /*virtual*/ void get_content(Generator& generator, Scope&, const FunctionCall&, std::ostream& error_log) const
    {
      generator.handle_type(m_type);
    }

    Constants::Type value(void) const
    {
      return m_type;
    }
  ...
  public:
    ...
    void set_type(boost::shared_ptr<Element> type)
    {
      m_type = type;
    }

    void set_size(boost::shared_ptr<Element> size)
    {
      m_size = size;
    }
  ...
  {
  public:
    QualifierElement(Constants::Qualifier qualifier) :
    ...
    /*virtual*/ void get_content(Generator& generator, Scope&, const FunctionCall&, std::ostream& error_log) const
    {
      generator.handle_qualifier(m_qualifier);
    }
  ...
  {
  public:
    OperatorElement(Constants::Operator op) :
      m_op(op)
    {
    }
    ...
    /*virtual*/ void get_content(Generator& generator, Scope&, const FunctionCall&, std::ostream& error_log) const
    {
      generator.handle_operator(m_op);
    }

    Constants::Operator value(void) const
    {
      return m_op;
    }
  ...
  public:
    ...
    FunctionDefinitionElement(const std::string& name) :
      MethodTemplate(name),
      m_code_block_enabled(false)
    {
    }

    /*virtual*/ bool instantiate(const std::string& name, const ValueList& values, 
        Generator& generator, const ScopeLayer& global_scope, std::ostream& error_log,
        shade::parser::FunctionCall call) const
    {
    ...
    /*virtual*/ void get_content(Generator& generator, Scope& scope, const FunctionCall& call, std::ostream& error_log) const
    {
      get_named_content(generator, scope, call, error_log, get_name());
    }
    ...
    void set_parameter_type(boost::shared_ptr<Element> type)
    {
    ...
    void enable_code_block(void)
    {
      m_code_block_enabled = true;
    }
    void set_code(boost::shared_ptr<Element> code)
    {
      m_code = code;
    }
  ...
  private:
    ...
    public:
      ...
      FunctionParameterGenerator(Generator& generator, Scope& scope, const FunctionCall& call, std::ostream& error_log) :
        ContentState(generator, scope, call, error_log)
      {
      }
    ...
    void get_named_content(Generator& generator, Scope& scope, const FunctionCall& call, std::ostream& error_log, const std::string name) const
    {
      ...
      std::for_each(m_parameters.begin(), m_parameters.end(),
          FunctionParameterGenerator(generator, scope, call, error_log));
  ...
  public:
    ...
    /*virtual*/ void get_content(Generator& generator, Scope& scope, const FunctionCall& call, std::ostream& error_log) const
    {
      ...
      if (name)
      {
        ...
        std::for_each(m_parameters.begin(), m_parameters.end(),
            ValueListBuilder(value_list, scope));
      ...
      std::for_each(m_parameters.begin(), m_parameters.end(),
          FunctionCallParameterGenerator(generator, scope, call, error_log));
    ...
    /*virtual*/ boost::shared_ptr<const Value> evaluate(const Scope& scope) const
    {
      ...
      else if (function->value() == "shade_get_base_object")
      {
        ...
        boost::shared_ptr<const IntValue> num_classes
          (boost::dynamic_pointer_cast<const IntValue>(scope.get_value("shade_num_classes")));
        if (!num_classes)
          return noresult;
    ...
    void set_name(boost::shared_ptr<Element> name)
    {
      m_name = name;
    }

    boost::shared_ptr<Element> get_name(void)
    {
      return m_name;
    }

    void set_parameter(boost::shared_ptr<Element> name)
    {
    ...
    boost::shared_ptr<const Element> get_parameter(int index)
    {
  ...
  private:
    ...
    ReferenceValue::Index get_base_object(ReferenceValue::Index reference, int num_classes) const
    {
      return reference % num_classes;
    }

    int get_object_index(ReferenceValue::Index reference, int num_classes) const
    {
      return (reference-get_base_object(reference, num_classes))/num_classes;
    }

    ReferenceValue::Index get_object(ReferenceValue::Index reference, int index, int num_classes) const
    {
      return get_base_object(reference, num_classes) + num_classes*index;
    }
    ...
    public:
      ...
      ValueListBuilder(ValueList& value_list, Scope& scope) :
    ...
    public:
      ...
      FunctionCallParameterGenerator(Generator& generator, Scope& scope, const FunctionCall& call, std::ostream& error_log) :
        ContentState(generator, scope, call, error_log)
      {
      }
  ...
  public:
    ...
    /*virtual*/ void get_content(Generator& generator, Scope& scope, const FunctionCall& call, std::ostream& error_log) const
    {
      ...
      if (!m_qualifiers.empty())
      {
        ...
        std::for_each(m_qualifiers.begin(), m_qualifiers.end(),
            VarDefQualifierGenerator(generator, scope, call, error_log));
    ...
    boost::shared_ptr<const Element> get_type(void) const
    {
      return m_type;
    }
    ...
    boost::shared_ptr<const Element> get_name(void) const
    {
      return m_name;
    }

    void set_qualifier(boost::shared_ptr<Element> qualifier)
    {
    ...
    boost::shared_ptr<const Element> get_code(void) const
    {
      return m_code;
    }
  ...
  private:
    ...
    public:
      ...
      VarDefQualifierGenerator(Generator& generator, Scope& scope, const FunctionCall& call, std::ostream& error_log) :
        ContentState(generator, scope, call, error_log)
      {
      }
  ...
  public:
    ...
    /*virtual*/ void get_content(Generator& generator, Scope& scope, const FunctionCall& call, std::ostream& error_log) const
    {
      ...
      if ((!condition) || (!condition->get_name()
            || (condition->get_num_parameters() != 2))
          || (!condition->get_parameter(0))
          || (!condition->get_parameter(1)))
      {
        get_literal_content(generator, scope, call, error_log);
        return;
      }
      ...
      if ((!increment) || (!increment->get_name()
            || (increment->get_num_parameters() != 1))
          || (!increment->get_parameter(0)))
      {
        get_literal_content(generator, scope, call, error_log);
        return;
      }
    ...
    void set_init(boost::shared_ptr<Element> init)
    {
      m_init = init;
    }

    void set_condition(boost::shared_ptr<Element> condition)
    {
      m_condition = condition;
    }

    void set_increment(boost::shared_ptr<Element> increment)
    {
  ...
  private:
    ...
    void get_optimized_content(Generator& generator, const Scope& scope, const FunctionCall& call, std::ostream& error_log, const std::string& var_name, ReferenceValue::Index list_begin, ReferenceValue::Index list_end) const
    {
  ...
  public:
    ...
    /*virtual*/ void get_content(Generator& generator, Scope& scope, const FunctionCall& call, std::ostream& error_log) const
    {
      ...
      for (std::vector<ElementPairPtr>::const_iterator case_iter = m_cases.begin();
          case_iter != m_cases.end(); ++case_iter)
      {
    ...
    void set_value(boost::shared_ptr<Element> value)
    {
      m_value = value;
    }

    void set_case_value(boost::shared_ptr<Element> value)
    {
      m_case_value = value;
    }
    ...
    void set_default(boost::shared_ptr<Element> default_)
    {
      m_default = default_;
    }
  ...
  private:
    ...
    public:
      ...
      SwitchCaseGenerator(Generator& generator, Scope& scope, const FunctionCall& call, std::ostream& error_log) :
        ContentState(generator, scope, call, error_log)
      {
      }
    ...
    void get_literal_content(Generator& generator, Scope& scope, const FunctionCall& call, std::ostream& error_log) const
    {
      ...
      std::for_each(m_cases.begin(), m_cases.end(),
          SwitchCaseGenerator(generator, scope, call, error_log));
      if (m_default)
      {
  ...
  public:
    ...
    /*virtual*/ void get_content(Generator& generator, Scope& scope, const FunctionCall& call, std::ostream& error_log) const
    {
      ...
      std::for_each(m_parameters.begin(), m_parameters.end(),
          SelfParameterGenerator(generator, scope, call, error_log));
  ...
  private:
    ...
    public:
      ...
      SelfParameterGenerator(Generator& generator, Scope& scope, const FunctionCall& call, std::ostream& error_log) :
        ContentState(generator, scope, call, error_log)
      {
      }
  ...
  public:
    ...
    template<class Iter> AccumulateElement(Iter begin, Iter end)
    {
    ...
    /*virtual*/ void get_content(Generator& generator, Scope& scope, const FunctionCall& call, std::ostream& error_log) const
    {
      std::for_each(m_elements.begin(), m_elements.end(),
          SubelementGenerator(generator, scope, call, error_log));
    }
  ...
  private:
    ...
    public:
      ...
      SubelementGenerator(Generator& generator, Scope& scope, const FunctionCall& call, std::ostream& error_log) :
        ContentState(generator, scope, call, error_log)
      {
      }

      void operator()(const boost::shared_ptr<Element>& element)
      {
        element->get_content(m_generator, m_scope, m_call, m_error_log);
      }
    };
  ...
  public:
    ...
    EnvironmentElement(shade::ShaderEnvironment env) :
      m_env(env)
    {
    }
...
ElementGenerator::ElementGenerator(void)
{
  init_elements();
}
...
boost::shared_ptr<MethodTemplate> ElementGenerator::get_method_template(void) const
{
  return boost::dynamic_pointer_cast<MethodTemplate>(get_element());
}
...
void ElementGenerator::add_element(boost::shared_ptr<parser::Element> element)
{
  m_elements.back().push_back(element);
}

void ElementGenerator::save_elements(void)
{
  m_elements.push_back(std::vector<boost::shared_ptr<Element> >());
}

void ElementGenerator::restore_elements(void)
{
  m_elements.pop_back();
}

void ElementGenerator::init_elements(void)
{
  save_elements();
}

void ElementGenerator::handle_identifier(const std::string& name)
{
  add_element(boost::shared_ptr<parser::Element>(new IdentifierElement(name)));
}

void ElementGenerator::handle_verbatim(const std::string& code)
{
  add_element(boost::shared_ptr<parser::Element>(new VerbatimElement(code)));
}

void ElementGenerator::handle_type(Constants::Type type)
{
  add_element(boost::shared_ptr<parser::Element>(new TypeElement(type)));
}

void ElementGenerator::handle_qualifier(Constants::Qualifier qualifier)
{
  add_element(boost::shared_ptr<parser::Element>(new QualifierElement(qualifier)));
}

void ElementGenerator::handle_operator(Constants::Operator op)
{
  add_element(boost::shared_ptr<parser::Element>(new OperatorElement(op)));
}


void ElementGenerator::handle_literal_objref(ObjectMap::Index ref)
{
  add_element(boost::shared_ptr<parser::Element>(new LiteralObjrefElement(ref)));
}

void ElementGenerator::handle_literal_list(ObjectMap::Index begin, ObjectMap::Index end)
{
  add_element(boost::shared_ptr<parser::Element>(new LiteralListElement(begin, end)));
}

void ElementGenerator::handle_literal_int(int value)
{
  add_element(boost::shared_ptr<parser::Element>(new LiteralIntElement(value)));
}

void ElementGenerator::handle_literal_float(float value)
{
  add_element(boost::shared_ptr<parser::Element>(new LiteralFloatElement(value)));
}

void ElementGenerator::handle_literal_vec2(float x, float y)
{
  add_element(boost::shared_ptr<parser::Element>(new LiteralVec2Element(x, y)));
}

void ElementGenerator::handle_literal_vec3(float x, float y, float z)
{
  add_element(boost::shared_ptr<parser::Element>(new LiteralVec3Element(x, y, z)));
}

void ElementGenerator::handle_literal_vec4(float x, float y, float z, float w)
{
  add_element(boost::shared_ptr<parser::Element>(new LiteralVec4Element(x, y, z, w)));
}


void ElementGenerator::handle_array_begin(void)
{
  add_element(boost::shared_ptr<parser::Element>(new ArrayElement()));
}

void ElementGenerator::handle_array_type_begin(void)
{
  save_elements();
}
...
void ElementGenerator::handle_array_size_begin(void)
{
  save_elements();
}
...
void ElementGenerator::handle_switch_begin(void)
{
  add_element(boost::shared_ptr<parser::Element>(new SwitchElement()));
}

void ElementGenerator::handle_switch_value_begin(void)
{
  save_elements();
}
...
void ElementGenerator::handle_switch_case_begin(void)
{
  save_elements();
}
...
void ElementGenerator::handle_switch_code_begin(void)
{
  save_elements();
}
...
void ElementGenerator::handle_switch_default_begin(void)
{
  save_elements();
}
...
void ElementGenerator::handle_for_begin(void)
{
  add_element(boost::shared_ptr<parser::Element>(new ForElement()));
}

void ElementGenerator::handle_for_init_begin(void)
{
  save_elements();
}
...
void ElementGenerator::handle_for_condition_begin(void)
{
  save_elements();
}
...
void ElementGenerator::handle_for_increment_begin(void)
{
  save_elements();
}
...
void ElementGenerator::handle_for_code_begin(void)
{
  save_elements();
}
...
void ElementGenerator::handle_var_definition_begin(void)
{
  add_element(boost::shared_ptr<parser::Element>(new VarDefinitionElement()));
}
...
void ElementGenerator::handle_var_definition_qualifier_begin(void)
{
  save_elements();
}
...
void ElementGenerator::handle_var_definition_type_begin(void)
{
  save_elements();
}
...
void ElementGenerator::handle_var_definition_name_begin(void)
{
  save_elements();
}
...
void ElementGenerator::handle_var_definition_code_begin(void)
{
  save_elements();
}
...
void ElementGenerator::handle_function_definition_return_type_begin(void)
{
  save_elements();
}
...
void ElementGenerator::handle_function_definition_name_begin(void)
{
  save_elements();
}
...
void ElementGenerator::handle_function_definition_parameter_type_begin(void)
{
  save_elements();
}
...
void ElementGenerator::handle_function_definition_parameter_name_begin(void)
{
  save_elements();
}
...
void ElementGenerator::handle_function_call_begin(void)
{
  add_element(boost::shared_ptr<parser::Element>(new FunctionCallElement()));
}

void ElementGenerator::handle_function_call_name_begin(void)
{
  save_elements();
}
...
void ElementGenerator::handle_function_call_parameter_begin(void)
{
  save_elements();
}
...
void ElementGenerator::handle_self_name_begin(void)
{
  save_elements();
}
...
void ElementGenerator::handle_self_parameter_type_begin(void)
{
  save_elements();
}
...
void ElementGenerator::handle_self_parameter_name_begin(void)
{
  save_elements();
}
...
boost::shared_ptr<Generator> ElementGenerator::construct(void) const
{
  return boost::shared_ptr<Generator>(new ElementGenerator);
}
