...
GL2Generator::GL2Generator(ShaderEnvironment env) : m_env(env), m_switch_needs_else(false), m_indentation_level(0) { m_code.setf(std::ios_base::scientific, std::ios_base::floatfield); }

std::string GL2Generator::get_code(void) const { return m_code.str(); }
...
void GL2Generator::handle_verbatim(const std::string& code) { m_code << code; }
...
void GL2Generator::handle_literal_objref(ObjectMap::Index ref) { m_code << boost::lexical_cast<std::string>(ref); }
...
void GL2Generator::handle_literal_int(int value) { m_code << boost::lexical_cast<std::string>(value); }

void GL2Generator::handle_literal_float(float value) { m_code << value; }
...
void GL2Generator::handle_array_begin(void) { m_type_is_array = true; }
...
void GL2Generator::handle_switch_value_begin(void) { indent() << "int shade_comparison_value = "; }

void GL2Generator::handle_switch_value_end(void) { m_code << ";\n"; }
...
void GL2Generator::handle_switch_case_end(void) { m_code << ")\n"; }

void GL2Generator::handle_switch_code_begin(void) { handle_block_begin(); }

void GL2Generator::handle_switch_code_end(void) { handle_block_end(); }
...
void GL2Generator::handle_switch_default_end(void) { handle_block_end(); }

void GL2Generator::handle_switch_end(void) { handle_block_end(); }

void GL2Generator::handle_for_begin(void) { indent() << "for ("; }

void GL2Generator::handle_for_init_begin(void) {}

void GL2Generator::handle_for_init_end(void) { m_code << "; "; }

void GL2Generator::handle_for_condition_begin(void) {}

void GL2Generator::handle_for_condition_end(void) { m_code << "; "; }

void GL2Generator::handle_for_increment_begin(void) {}

void GL2Generator::handle_for_increment_end(void) { m_code << ")\n"; }

void GL2Generator::handle_for_code_begin(void) { handle_block_begin(); }

void GL2Generator::handle_for_code_end(void) { handle_block_end(); }
...
void GL2Generator::handle_var_definition_qualifier_end(void) { m_code << " "; }

void GL2Generator::handle_var_definition_qualifier_list_end(void) {}

void GL2Generator::handle_var_definition_type_begin(void) { m_type_is_array = false; }

void GL2Generator::handle_var_definition_type_end(void) { m_code << " "; }
...
void GL2Generator::handle_var_definition_code_begin(void) { m_code << " = "; }

void GL2Generator::handle_var_definition_code_end(void) {}

void GL2Generator::handle_var_definition_end(void) {}

void GL2Generator::handle_statement_begin(void) { indent(); }

void GL2Generator::handle_statement_end(void) { m_code << ";\n"; }
...
void GL2Generator::handle_function_definition_return_type_end(void) { m_code << " "; }

void GL2Generator::handle_function_definition_name_begin(void) { m_function_has_code = false; }

void GL2Generator::handle_function_definition_name_end(void) { m_code << "("; }
...
void GL2Generator::handle_function_definition_parameter_type_end(void) { m_function_parameter_type_set = true; }
...
void GL2Generator::handle_function_definition_parameter_name_end(void) { m_function_parameter_needs_separator = true; }

void GL2Generator::handle_function_definition_parameter_list_end(void) { m_code << ")"; }
...
void GL2Generator::handle_function_call_parameter_list_begin(void) { m_function_parameter_needs_separator = false; }
...
void GL2Generator::handle_self_begin(void) { m_code << "#define "; }

void GL2Generator::handle_self_name_begin(void) {}

void GL2Generator::handle_self_name_end(void) {}

void GL2Generator::handle_self_parameter_list_begin(void) { m_code << " in OBJREF self"; }

void GL2Generator::handle_self_parameter_type_begin(void) { m_code << ", in "; }

void GL2Generator::handle_self_parameter_type_end(void) {}

void GL2Generator::handle_self_parameter_name_begin(void) { m_code << " "; }

void GL2Generator::handle_self_parameter_name_end(void) {}

void GL2Generator::handle_self_parameter_list_end(void) {}

void GL2Generator::handle_self_end(void) { m_code << "\n"; }
...
void GL2Generator::insert_define(const std::string& name, const std::string& value) { m_code << "#define " << name << " " << value << "\n"; }

void GL2Generator::insert_extension(const std::string& name, Extension::Behavior behavior)
{
    const char* behavior_names[] = {"require", "enable", "warn", "disable"};
...
void GL2Generator::insert_sl_version(int version) { m_code << "#version " << version << "\n"; }
...
boost::shared_ptr<Generator> GL2Generator::construct(void) const { return boost::shared_ptr<Generator>(new GL2Generator(m_env)); }
