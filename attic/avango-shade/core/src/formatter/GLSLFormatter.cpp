...
namespace
{
  void generate_void_objref_function(shade::formatter::Generator& generator,
      const std::string& name, shade::ObjectMap::Index ref)
  {
...
shade::GLSLFormatter::GLSLFormatter(ShaderEnvironment se) :
  Formatter(se),
  m_extern_generator(new formatter::GL2Generator(se)),
  m_main_generator(new formatter::GL2Generator(se))
{
...
shade::GLSLFormatter::GLSLFormatter(ShaderEnvironment se, const shade::formatter::Generator& generator) :
  Formatter(se),
  m_extern_generator(generator.construct()),
  m_main_generator(generator.construct())
{
...
boost::shared_ptr<shade::formatter::Generator> shade::GLSLFormatter::begin_insert_init_attribute(formatter::Constants::Type type, const std::string& obj, const std::string& name, formatter::Constants::Qualifier qualifier)
{
  insert_attribute_pre(qualifier);
...
void shade::GLSLFormatter::begin_property_dispatch_declaration(formatter::Generator& generator, const std::string& class_, const std::string& name, formatter::Constants::Type retval, bool setter) const
{
...
void shade::GLSLFormatter::insert_deferred_property_dispatcher(shade::ObjectMap::Index self, shade::ObjectMap::Index obj, const std::string& iface_getter, const std::string& getter, const std::string& iface_setter, const std::string& setter)
{
  if ((!m_dispatch_property_generator[0]) || (!m_dispatch_property_generator[1]))
    return;
...
void shade::GLSLFormatter::invoke(const std::string& class_, const std::string& main)
{
  generate_void_objref_function(*m_main_generator, get_method_name(class_, main), 0);
}
...
void shade::GLSLFormatter::insert_sources(const std::string& sources)
{
  m_sources = sources;
}
...
std::string shade::GLSLFormatter::get_method_name(const std::string& class_, const std::string& name)
{
  return class_+"_"+name;
}

std::string shade::GLSLFormatter::get_property_get_name(const std::string& class_, const std::string& name) const
{
  return class_+"_get_"+name;
}

std::string shade::GLSLFormatter::get_property_set_name(const std::string& class_, const std::string& name) const
{
  return class_+"_set_"+name;
}
