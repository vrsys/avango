...
SelfTranslator::SelfTranslator(void) :
  m_store_self_name(false),
  m_store_type(false),
  m_store_name(false)
{
}
...
void SelfTranslator::handle_self_name_begin(void)
{
  m_store_self_name = true;
}

void SelfTranslator::handle_self_name_end(void)
{
  m_store_self_name = false;
}
...
void SelfTranslator::handle_self_parameter_type_begin(void)
{
  m_store_type = true;
}

void SelfTranslator::handle_self_parameter_type_end(void)
{
  m_store_type = false;
}

void SelfTranslator::handle_self_parameter_name_begin(void)
{
  m_store_name = true;
}
