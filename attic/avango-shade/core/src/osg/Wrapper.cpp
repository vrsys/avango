...
shade::osg::Wrapper::Wrapper(::osg::StateSet* state) : m_state(state) {}
...
boost::shared_ptr<shade::Texture> shade::osg::Wrapper::make_canvas_texture(void) const { return boost::shared_ptr<shade::Texture>(); }
