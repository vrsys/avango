...
namespace shade
{
  ...
  namespace parser
  {
    ...
    public:
      ...
      template<class Iter> ComposedSegment(Iter begin, Iter end, const formatter::MarkBuffer::iterator& text_begin, const formatter::MarkBuffer::iterator& text_end) :
        Segment(text_begin, text_end)
      {
        ...
        std::transform(segments.begin(), segments.end()-1, segments.begin()+1, segments.begin(),
            bind(&ComposedSegment::do_difference, this, _1, _2));
