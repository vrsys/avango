...
void ValueList::add(boost::shared_ptr<const Value> parameter)
{
...
bool ValueList::has_self_parameter(void) const
{
  return !m_parameters.empty();
}

const Value& ValueList::get_self_parameter(void) const
{
