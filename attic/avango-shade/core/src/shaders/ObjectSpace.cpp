...
SHADE_CLASS_INIT(ObjectSpace, "ObjectSpace.glsl", SHADE_NONE, SHADE_DEFS((position)(normal)(eyepoint)))

shade::vec4<> ObjectSpace::transform(vec4<>) { return invoke<vec4<>>("ObjectSpace_transform_impl"); }
...
shade::vec3<shade::Type> ObjectSpace::get(void) { return invoke_inline<vec3<>>(boost::bind(&ObjectSpace::get_inline, boost::ref(*this), _1)); }

shade::vec3<> ObjectSpace::get_transformed_normal(void) { return invoke<vec3<>>("ObjectSpace_get_transformed_normal_impl"); }

shade::vec3<> ObjectSpace::get_transformed_eyepoint(void) { return invoke<vec3<>>("ObjectSpace_get_transformed_eyepoint_impl"); }

shade::void_<> ObjectSpace::init_vertex(void) { return invoke<void_<>>("ObjectSpace_init_vertex_impl"); }
