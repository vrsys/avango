...
namespace
{
  ...
  public:
    virtual shade::vec3<> illuminate(shade::vec3<>, shade::vec3<>)
    { return invoke< shade::vec3<> >("DirectionalLightSource_illuminate_impl"); };
...
SUITE(ListType)
{
  struct CompileFixture
  {
    ...
    CompileFixture(void) :
      ...
      point_light_source(new PointLightSource),
      directional_light_source(new DirectionalLightSource),
      component(material),
      acc(resolver)
    {
