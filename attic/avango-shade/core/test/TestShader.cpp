...
class BaseShader : public shade::ShaderBase<BaseShader>
{
  public:
    ...
    virtual shade::float_<> get_intensity(void) { return invoke<shade::float_<>>("get_intensity_impl"); };
...
shade::MethodAccessor BaseShader::methods[] = {BaseShader::def(&BaseShader::get_intensity, "get_intensity"), BaseShader::def(&BaseShader::illuminate, "illuminate"), shade::MethodAccessor()};
shade::AttributeAccessor BaseShader::attributes[] = {BaseShader::def(&BaseShader::m_angle, "angle"), shade::AttributeAccessor()};
...
shade::MethodAccessor SecondBaseShader::methods[] = {SecondBaseShader::def(&SecondBaseShader::get_color, "get_color"), shade::MethodAccessor()};
...
shade::AttributeAccessor DerivedShader::attributes[] = {DerivedShader::def(&DerivedShader::m_color, "color"), DerivedShader::def(&DerivedShader::m_ref_color, "ref_color"), shade::AttributeAccessor()};
...
shade::AttributeAccessor DoubleDerivedShader::attributes[] = {DoubleDerivedShader::def(&DoubleDerivedShader::m_color, "color"), shade::AttributeAccessor()};
