...
SUITE(StorageFormatter)
{
  ...
  TEST(WriteAttributes)
  {
    ...
    gmt.insert_attribute(shade::formatter::Constants::sampler2D, "obj_0x1", "tex",
        shade::formatter::Constants::uniform);
    gmt.insert_attribute(shade::formatter::Constants::float_, "obj_0x2", "luminance",
    ...
    CHECK_EQUAL(shade::formatter::Constants::vec3,
        gmt.get_attribute("obj_0x0", "color").type);
    CHECK_EQUAL(shade::formatter::Constants::none,
        gmt.get_attribute("obj_0x0", "color").qualifier);

    CHECK_EQUAL(shade::formatter::Constants::sampler2D,
        gmt.get_attribute("obj_0x1", "tex").type);
    CHECK_EQUAL(shade::formatter::Constants::uniform,
        gmt.get_attribute("obj_0x1", "tex").qualifier);

    CHECK_EQUAL(shade::formatter::Constants::float_,
        gmt.get_attribute("obj_0x2", "luminance").type);
    CHECK_EQUAL(shade::formatter::Constants::output,
        gmt.get_attribute("obj_0x2", "luminance").qualifier);
  }
  ...
  TEST(WriteAttributesWithInit)
  {
    ...
    generator = gmt.begin_insert_init_attribute(shade::formatter::Constants::vec3,
        "obj_0x3", "position",
        shade::formatter::Constants::const_);
    value.generate_constructor(*generator);
    gmt.end_insert_init_attribute();
    gmt.insert_attribute(shade::formatter::Constants::list,
        "obj_0x1", "lights");
    ...
    CHECK_EQUAL(shade::formatter::Constants::vec3,
        gmt.get_attribute("obj_0x3", "position").type);
    CHECK_EQUAL(shade::formatter::Constants::const_,
        gmt.get_attribute("obj_0x3", "position").qualifier);
    CHECK_EQUAL("<literal_vec3>1.1 2.2 3.3</literal_vec3>",
        gmt.get_attribute("obj_0x3", "position").initializer);

    CHECK_EQUAL(shade::formatter::Constants::list,
        gmt.get_attribute("obj_0x1", "lights").type);
    CHECK_EQUAL(shade::formatter::Constants::none,
        gmt.get_attribute("obj_0x1", "lights").qualifier);
  ...
  TEST(WriteAttributesAsArray)
  {
    ...
    CHECK_EQUAL(shade::formatter::Constants::vec3,
        gmt.get_attribute("obj_0x3", "position").type);
    CHECK_EQUAL(shade::formatter::Constants::input,
        gmt.get_attribute("obj_0x3", "position").qualifier);
