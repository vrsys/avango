...
SUITE(Type)
{
    ...
    struct TestCallback
    {
        TestCallback(const shade::Type* type) : m_type(type), was_modified(false) {}
    ...
    TEST(WriteAttribute)
    {
        ...
        CHECK_EQUAL(shade::formatter::Constants::vec3, fmt.get_attribute("obj_0x0", "color").type);
        CHECK_EQUAL(shade::formatter::Constants::none, fmt.get_attribute("obj_0x0", "color").qualifier);

        CHECK_EQUAL(shade::formatter::Constants::sampler2D, fmt.get_attribute("obj_0x1", "tex").type);
        CHECK_EQUAL(shade::formatter::Constants::uniform, fmt.get_attribute("obj_0x1", "tex").qualifier);

        CHECK_EQUAL(shade::formatter::Constants::float_, fmt.get_attribute("obj_0x2", "luminance").type);
        CHECK_EQUAL(shade::formatter::Constants::output, fmt.get_attribute("obj_0x2", "luminance").qualifier);
    }
    ...
    TEST(WriteAttributesWithInit)
    {
        ...
        CHECK_EQUAL(shade::formatter::Constants::vec3, fmt.get_attribute("obj_0x3", "position").type);
        CHECK_EQUAL(shade::formatter::Constants::const_, fmt.get_attribute("obj_0x3", "position").qualifier);
        CHECK_EQUAL("<literal_vec3>1.1 2.2 3.3</literal_vec3>", fmt.get_attribute("obj_0x3", "position").initializer);
    }
