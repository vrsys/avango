...
SUITE(Value)
{
    ...
    TEST(GetterMethod)
    {
        ...
        CHECK(shade::formatter::check_dump_output("<env value=\"SHADE_VERTEX_SHADER\">"
                                                  "<return>"
                                                  "<func_call>"
                                                  "<func_call_name>"
    ...
    {
        CompilationFixture(void) : value(new shade::shaders::Value<shade::vec3>), value_id(value->get_uniq_id()), component(value), acc(resolver)
        {
    ...
    TEST_FIXTURE(CompilationFixture, Attribute)
    {
        ...
        CHECK_EQUAL(shade::formatter::Constants::vec3, fmt.get_attribute(value_id, "value").type);
        CHECK_EQUAL(shade::formatter::Constants::none, fmt.get_attribute(value_id, "value").qualifier);
    }
