...
#ifndef shade_formatter_DumpGenerator
#define shade_formatter_DumpGenerator shade_formatter_DumpGenerator
...
namespace shade
{
  namespace formatter
  {
    ...
    private:
      ...
      std::string get_type_str(Constants::Type);
...
#endif /* shade_formatter_DumpGenerator */
