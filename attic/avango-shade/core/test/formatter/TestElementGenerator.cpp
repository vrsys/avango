...
SUITE(TestElementGenerator)
{
    ...
    void generate_noop(shade::formatter::Generator & generator) { generator.handle_verbatim("noop;"); }

    std::string translate_function_name(const std::string& name, const shade::parser::ValueList& param, const shade::parser::ScopeLayer& scope, std::ostream& error_log)
    {
    ...
    struct Generators
    {
        Generators(void) : scope(global_scope)
        {
    ...
    void generate_looped_noop(shade::formatter::Generator & generator) { generate_forloop(generator, generate_noop, "j", "i", "list_end"); }

    void generate_optimized_looped_noop(shade::formatter::Generator & generator) { generate_optimized_forloop(generator, generate_noop, "j", 1, 2); }
    ...
    void generate_special_noop(shade::formatter::Generator & generator) { generator.handle_verbatim("special_noop;"); }
    ...
    void generate_looped_noop_for_function_definition(shade::formatter::Generator & generator) { generate_forloop(generator, generate_noop, "i", "u", "v"); }

    void generate_optimized_looped_noop_for_function_definition(shade::formatter::Generator & generator) { generate_optimized_forloop(generator, generate_noop, "i", 1, 2); }
    ...
    TEST_FIXTURE(Generators, TestSelf)
    {
        ...
        CHECK(shade::formatter::check_dump_output("<self>"
    ...
    void generate_call(shade::formatter::Generator & generator, const std::string& func_name, const int arg1, const int arg2 = -1, const bool use_objref = true)
    {
        generator.handle_function_call_begin();
        generator.handle_function_call_name_begin();
