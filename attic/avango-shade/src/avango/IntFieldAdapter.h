...
#ifndef AVANGO_SHADE_INTFIELDADAPTER_H
#define AVANGO_SHADE_INTFIELDADAPTER_H
...
{
/**
 * Registers a int field with appropriate getter and setter functions
 *
 * \ingroup av_shade
 */
class IntFieldAdapter : public FieldAdapter
{
  public:
