...
av::shade::LightSource::LightSource(::osg::LightSource* osglightsource)
    : Node(osglightsource), mOsgLightSource(osglightsource), mGLLightPosition(dynamic_cast<av::shade::Shader*>(av::Type::createInstanceOfType("av::shade::GLLightPosition")))
{
    ...
    AV_FC_ADD_ADAPTOR_FIELD(LightNum, boost::bind(&LightSource::getLightNumCB, this, _1), boost::bind(&LightSource::setLightNumCB, this, _1));
    AV_FC_ADD_ADAPTOR_FIELD(Position, boost::bind(&LightSource::getPositionCB, this, _1), boost::bind(&LightSource::setPositionCB, this, _1));
...
/* static */ void av::shade::LightSource::initClass()
{
...
::osg::LightSource* av::shade::LightSource::getOsgLightSource() const { return mOsgLightSource; }
...
/* virtual */ void av::shade::LightSource::getLightNumCB(const av::SFInt::GetValueEvent& event) { *(event.getValuePtr()) = getLightNum(); }

/* virtual */ void av::shade::LightSource::setLightNumCB(const av::SFInt::SetValueEvent& event) { setLightNum(event.getValue()); }

/* virtual */ void av::shade::LightSource::getPositionCB(const av::osg::SFVec4::GetValueEvent& event)
{
    ::osg::Light* light = mOsgLightSource->getLight();
    if(!light)
        return;
...
/* virtual */ void av::shade::LightSource::setPositionCB(const av::osg::SFVec4::SetValueEvent& event)
{
    ::osg::Light* light = mOsgLightSource->getLight();
    if(!light)
        return;
