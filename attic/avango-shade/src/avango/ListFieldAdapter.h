...
#ifndef AVANGO_SHADE_LISTFIELDADAPTER_H
#define AVANGO_SHADE_LISTFIELDADAPTER_H
...
namespace av
{
  ...
  {
    /**
     * Registers a list field with appropriate getter and setter functions
     *
     * \ingroup av_shade
     */
    class ListFieldAdapter : public FieldAdapter
    {
    public:
