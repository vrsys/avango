...
namespace
{
  ...
  public:
    ...
    ObjrefGetter(shade::types::ObjrefAccessor* accessor) :
      mAccessor(accessor)
    {
    }
  ...
  public:
    ...
    ObjrefSetter(shade::types::ObjrefAccessor* accessor) :
      mAccessor(accessor)
    {
    }
...
av::shade::ObjrefFieldAdapter::hash(void) const
{
...
void
av::shade::ObjrefFieldAdapter::bindField(::shade::Type* type, const std::string& name, av::FieldContainer* container) const
{
