...
av::shade::State::State() : mOsgStateSet(new ::osg::StateSet), mState(new ::shade::osg::Wrapper(mOsgStateSet.get()))
{
    AV_FC_ADD_FIELD(Shader, 0);
    AV_FC_ADD_ADAPTOR_FIELD(DataVariance, boost::bind(&State::getDataVarianceCB, this, _1), boost::bind(&State::setDataVarianceCB, this, _1));
}

av::shade::State::~State() {}

void av::shade::State::initClass()
{
...
void av::shade::State::applyState(::osg::Node* node) { node->setStateSet(mOsgStateSet.get()); }

/* virtual */ void av::shade::State::getDataVarianceCB(const SFDataVariance::GetValueEvent& event) { *(event.getValuePtr()) = mOsgStateSet->getDataVariance(); }

/* virtual */ void av::shade::State::setDataVarianceCB(const SFDataVariance::SetValueEvent& event) { mOsgStateSet->setDataVariance(event.getValue()); }

/* virtual */ void av::shade::State::fieldHasChanged(const av::Field& field)
{
...
void av::shade::State::update(void)
{
