...
#ifndef AVANGO_SHADE_VEC3FIELDADAPTER_H
#define AVANGO_SHADE_VEC3FIELDADAPTER_H
...
namespace av
{
  ...
  {
    /**
     * Registers a vec3 field with appropriate getter and setter functions
     *
     * \ingroup av_shade
     */
    class Vec3FieldAdapter : public FieldAdapter
    {
    public:
