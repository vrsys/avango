...
av::vrpn::TrackerInformation::TrackerInformation() : ::av::FieldContainer()
{
    ...
    AV_FC_ADD_ADAPTOR_FIELD(Pos, boost::bind(&av::vrpn::TrackerInformation::getPOSCB, this, _1), boost::bind(&av::vrpn::TrackerInformation::setPOSCB, this, _1));
    AV_FC_ADD_ADAPTOR_FIELD(Quat, boost::bind(&av::vrpn::TrackerInformation::getQUATCB, this, _1), boost::bind(&av::vrpn::TrackerInformation::setQUATCB, this, _1));
...
void av::vrpn::TrackerInformation::initClass()
{
...
void av::vrpn::TrackerInformation::updateMatrix()
{
    ::osg::Matrixf pos_mat;
...
void av::vrpn::TrackerInformation::getPOSCB(const av::osg::SFVec3::GetValueEvent& event) { *(event.getValuePtr()) = mPos; }
void av::vrpn::TrackerInformation::setPOSCB(const av::osg::SFVec3::SetValueEvent& event)
{
    mPos = (event.getValue());
    updateMatrix();
}

void av::vrpn::TrackerInformation::getQUATCB(const av::osg::SFQuat::GetValueEvent& event) { *(event.getValuePtr()) = mQuat; }
void av::vrpn::TrackerInformation::setQUATCB(const av::osg::SFQuat::SetValueEvent& event)
{
