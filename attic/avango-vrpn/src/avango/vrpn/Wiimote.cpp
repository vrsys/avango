...
void av::vrpn::Wiimote::openVRPNConnectionsTemplateFunc() { mVRPNAnalogOutput = boost::shared_ptr<vrpn_Analog_Output_Remote>(new vrpn_Analog_Output_Remote(mVRPNID.c_str())); }

void av::vrpn::Wiimote::closeVRPNConnectionsTemplateFunc() {}

void av::vrpn::Wiimote::triggerVRPNMainLoopTemplateFunc() { mVRPNAnalogOutput->mainloop(); }

void av::vrpn::Wiimote::getRumbleCB(const av::SFBool::GetValueEvent& event) { *(event.getValuePtr()) = mRumbling; }
...
void av::vrpn::Wiimote::getLED3CB(const av::SFBool::GetValueEvent& event) { *(event.getValuePtr()) = true; }
...
bool av::vrpn::Wiimote::update_channel(const vrpn_int32 channel, const bool value)
{
