...
{
    auto getter = [func]() -> std::string { return extract<std::string>(func()); };
...
void init_GuiResourceNode()
{
    ...
    class_<av::gua::gui::GuiResourceNode, av::Link<av::gua::gui::GuiResourceNode>, bases<av::gua::TransformNode>, boost::noncopyable>("GuiResourceNode", "docstring", no_init)
