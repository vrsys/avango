...
av::gua::gui::GuiResourceNode::GuiResourceNode(std::shared_ptr<::gua::GuiResource> guaGuiResource)
    : av::gua::TransformNode(std::make_shared<::gua::node::TransformNode>()), m_guaGuiResource(guaGuiResource), m_initialized(false), m_distributed(false), m_textureName(""),
      m_size(::gua::math::vec2(-1.f)), m_clearCallbackHandle()
{
    AV_FC_ADD_ADAPTOR_FIELD(TextureName, std::bind(&GuiResourceNode::getTextureNameCB, this, std::placeholders::_1), std::bind(&GuiResourceNode::setTextureNameCB, this, std::placeholders::_1));

    AV_FC_ADD_ADAPTOR_FIELD(URL, std::bind(&GuiResourceNode::getURLCB, this, std::placeholders::_1), std::bind(&GuiResourceNode::setURLCB, this, std::placeholders::_1));

    AV_FC_ADD_ADAPTOR_FIELD(Size, std::bind(&GuiResourceNode::getSizeCB, this, std::placeholders::_1), std::bind(&GuiResourceNode::setSizeCB, this, std::placeholders::_1));

    AV_FC_ADD_ADAPTOR_FIELD(Interactive, std::bind(&GuiResourceNode::getInteractiveCB, this, std::placeholders::_1), std::bind(&GuiResourceNode::setInteractiveCB, this, std::placeholders::_1));
...
av::gua::gui::GuiResourceNode::~GuiResourceNode() { ApplicationInstance::get().removeCallback(m_clearCallbackHandle); }

void av::gua::gui::GuiResourceNode::initClass()
{
...
std::shared_ptr<::gua::GuiResource> av::gua::gui::GuiResourceNode::getGuaGuiResource() const { return m_guaGuiResource; }

void av::gua::gui::GuiResourceNode::getTextureNameCB(const SFString::GetValueEvent& event) { *(event.getValuePtr()) = m_textureName; }

void av::gua::gui::GuiResourceNode::setTextureNameCB(const SFString::SetValueEvent& event)
{
    if(m_textureName == "")
    {
...
void av::gua::gui::GuiResourceNode::setURLCB(const SFString::SetValueEvent& event)
{
...
void av::gua::gui::GuiResourceNode::getSizeCB(const SFVec2::GetValueEvent& event) { *(event.getValuePtr()) = m_size; }

void av::gua::gui::GuiResourceNode::setSizeCB(const SFVec2::SetValueEvent& event)
{
...
void av::gua::gui::GuiResourceNode::setInteractiveCB(const SFBool::SetValueEvent& event) { m_guaGuiResource->set_interactive(event.getValue()); }
...
bool av::gua::gui::GuiResourceNode::check_completeness() const { return m_guaGuiResource->get_url() != "" && m_textureName != "" && m_size != ::gua::math::vec2(-1.f); }

void av::gua::gui::GuiResourceNode::init()
{
    if(!m_initialized)
    {
...
void av::gua::gui::GuiResourceNode::clearCallback()
{
    if(m_distributed)
    {
...
void av::gua::gui::GuiResourceNode::on_loaded(std::function<void()> const& callback) const { m_guaGuiResource->on_loaded.connect(callback); }

void av::gua::gui::GuiResourceNode::on_javascript_callback(std::function<void(std::string const&, std::vector<std::string> const&)> const& callback) const
{
    m_guaGuiResource->on_javascript_callback.connect(callback);
}

void av::gua::gui::GuiResourceNode::add_javascript_callback(std::string const& name) { m_guaGuiResource->add_javascript_callback(name); }

void av::gua::gui::GuiResourceNode::add_javascript_getter(std::string const& name, std::function<std::string()> callback) { m_guaGuiResource->add_javascript_getter(name, callback); }

void av::gua::gui::GuiResourceNode::go_forward()
{
    m_guaGuiResource->go_forward();
...
void av::gua::gui::GuiResourceNode::go_back()
{
    m_guaGuiResource->go_back();
...
void av::gua::gui::GuiResourceNode::go_to_history_offset(int offset)
{
    m_guaGuiResource->go_to_history_offset(offset);
...
void av::gua::gui::GuiResourceNode::reload()
{
    m_guaGuiResource->reload();
...
void av::gua::gui::GuiResourceNode::focus()
{
    m_guaGuiResource->focus();
...
void av::gua::gui::GuiResourceNode::inject_keyboard_event(int key, int scancode, int action, int mods) const
{
...
void av::gua::gui::GuiResourceNode::inject_char_event(unsigned c) const
{
...
void av::gua::gui::GuiResourceNode::inject_mouse_position_relative(::gua::math::vec2 const& position) const
{
    m_guaGuiResource->inject_mouse_position_relative(position);
...
void av::gua::gui::GuiResourceNode::inject_mouse_position(::gua::math::vec2 const& position) const
{
    m_guaGuiResource->inject_mouse_position(position);
...
void av::gua::gui::GuiResourceNode::inject_mouse_button(int button, int action, int mods) const
{
...
void av::gua::gui::GuiResourceNode::inject_mouse_wheel(::gua::math::vec2 const& direction) const
{
    m_guaGuiResource->inject_mouse_wheel(direction);
...
void av::gua::gui::GuiResourceNode::call_javascript(std::string const& method, std::vector<std::string> const& args) const
{
