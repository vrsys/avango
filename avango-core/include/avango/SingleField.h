...
class SingleField : public Field
{
  ...
  public:
    ...
    class GetValueEvent : public Event
    {
      ...
      protected:
        GetValueEvent(const Field* field, ValueType* value_ptr) : Event(field), mValuePtr(value_ptr) {}
    ...
    class SetValueEvent : public Event
    {
      ...
      protected:
        SetValueEvent(Field* field, const ValueType& value) : Event(field), mValue(value) {}
    ...
    SingleField() : Field(), mValue(Value()), mHasGetValueCallback(false), mHasSetValueCallback(false) { AV_ASSERT(validateRequirements()); }

    SingleField(const SingleField&) : Field() { AV_ASSERT(validateRequirements()); }
    ...
    static void initClass(const std::string& classname, const std::string& parentname)
    {
        ...
        {
            sClassTypeId = Field::registerType(classname, parentname, new CreateA<SingleField<Value>>);
        }
    }
    ...
    void bind(FieldContainer* container, const std::string& name, bool owned, const GetValueCallback& get_cb, const SetValueCallback& set_cb, const Value& init)
    {
        addGetValueCallback(get_cb);
        addSetValueCallback(set_cb);
    ...
    virtual void setValue(const Value& v) { setValue(v, 0); }
    ...
    /* virtual */ void clear() { setValue(Value()); }
    ...
    template <typename T>
    friend bool operator==(const SingleField<T>&, const SingleField<T>&);
...
template <typename Value>
inline bool operator==(const SingleField<Value>& a, const SingleField<Value>& b)
{
...
template <>
AV_DLL void av::SingleField<double>::pullValueImpl(av::Field* fromField);
template <>
AV_DLL void av::SingleField<float>::pullValueImpl(av::Field* fromField);
template <>
AV_DLL void av::SingleField<int32_t>::pullValueImpl(av::Field* fromField);
template <>
AV_DLL void av::SingleField<int64_t>::pullValueImpl(av::Field* fromField);
template <>
AV_DLL void av::SingleField<uint32_t>::pullValueImpl(av::Field* fromField);
template <>
AV_DLL void av::SingleField<uint64_t>::pullValueImpl(av::Field* fromField);
template <>
AV_DLL void av::SingleField<bool>::pullValueImpl(av::Field* fromField);
} // namespace av
