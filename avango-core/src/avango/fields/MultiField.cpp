...
void av::MultiField<float>::pullValueImpl(av::Field* fromField)
{
  ...
  {
    throw std::invalid_argument( "pullValue: type mismatch. " + getTypeId().getName() +
                                 " <--> " + fromField->getTypeId().getName());
  }
}
...
template<> void
av::MultiField<float>::push(av::Msg& msg)
{
  getValue();
...
template<> void
av::MultiField<double>::push(av::Msg& msg)
{
  getValue();
  av_pushMsg(msg, mValue);
}
...
template<> void
av::MultiField<int32_t>::push(av::Msg& msg)
{
  getValue();
  av_pushMsg(msg, mValue);
}
...
template<> void
av::MultiField<uint32_t>::push(av::Msg& msg)
{
  getValue();
  av_pushMsg(msg, mValue);
}
...
template<> void
av::MultiField<int64_t>::push(av::Msg& msg)
{
  getValue();
  av_pushMsg(msg, mValue);
}
...
template<> void
av::MultiField<uint64_t>::push(av::Msg& msg)
{
  getValue();
  av_pushMsg(msg, mValue);
}
