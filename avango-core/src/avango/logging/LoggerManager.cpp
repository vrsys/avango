...
av::logging::LoggerManager::LoggerMap& av::logging::LoggerManager::getLoggerMap() { return mLoggerMap; }

av::logging::Logger& av::logging::LoggerManager::getRootLogger() { return *mRootLogger; }

av::logging::Logger& av::logging::LoggerManager::getLogger(const std::string& name)
{
