...
av::NetGroup::NetGroup(NetNode* net_node, Maestro_ClSv_Options& options) : MaestroMerge(options), mNetNode(net_node), mUpcallSerializer()
{
    if(!net_node)
    {
...
av::NetGroup::~NetGroup(){AVANGO_LOG(logger, logging::TRACE, "av::NetGroup::~NetGroup: ")}

av::UpcallSerializer& av::NetGroup::upcallSerializer()
{
    return mUpcallSerializer;
}

void av::NetGroup::cast(av::Msg& msg)
{
...
void av::NetGroup::send(const std::string& destEID, av::Msg& msg)
{
    Maestro_Message maestro_msg;
    maestro_msg.write(msg.getBuffer(), msg.getSize());
...
void av::NetGroup::Merge_Join_Callback(Maestro_EndpID& /*myeid*/)
{
...
void av::NetGroup::Merge_SetState_Callback(Maestro_EndpID& fragment, Maestro_Message& stateMessage)
{
...
void av::NetGroup::Merge_GetState_Callback(Maestro_EndpID& fragment, Maestro_Message& stateMessage)
{
...
void av::NetGroup::Merge_RemoveState_Callback(Maestro_EndpID& fragment)
{
...
void av::NetGroup::Merge_ReceiveCast_Callback(Maestro_EndpID& /*origin*/, Maestro_Message& msg)
{
...
void av::NetGroup::Merge_ReceiveSend_Callback(Maestro_EndpID& /*origin*/, Maestro_Message& msg)
{
...
void av::NetGroup::Merge_AcceptedView_Callback(MaestroMergeViewData& view_data, Maestro_Message& msg)
{
...
void av::NetGroup::Merge_Block_Callback()
{
...
void av::NetGroup::Merge_UnBlock_Callback()
{
...
void av::NetGroup::Merge_Exit_Callback()
{
