...
av::OutputStream::OutputStream() : std::ostream(0), mWriteAction(0), mBinary(false) {}

av::OutputStream::OutputStream(std::ostream& os) : std::ostream(os.rdbuf()), mWriteAction(0), mBinary(false) {}

av::OutputStream::OutputStream(std::streambuf* sb) : std::ostream(sb), mWriteAction(0), mBinary(false) {}

av::OutputStream& av::OutputStream::operator=(std::ostream& os)
{
    (void)rdbuf(os.rdbuf());
    return *this;
}

av::OutputStream& av::OutputStream::operator=(std::streambuf* sb)
{
    (void)rdbuf(sb);
    return *this;
}

void av::OutputStream::enableBinary(bool on) { mBinary = on; }

bool av::OutputStream::isBinaryEnabled() const { return mBinary; }

void av::OutputStream::setWriteAction(av::WriteAction* writeAction) { mWriteAction = writeAction; }

av::WriteAction* av::OutputStream::getWriteAction() { return mWriteAction; }

av::OutputStream& av::endl(av::OutputStream& os)
{
    std::endl(os);
    return os;
}

av::OutputStream& av::flush(av::OutputStream& os)
{
    std::flush(os);
    return os;
}
