...
#if !defined(AV_DAEMON_KINECT_TRACK_H)
#define AV_DAEMON_KINECT_TRACK_H
...
namespace av
{
  ...
  {
    /**
     * An Avango NG device for processing KinectTrack udp packets (ASCII protocol).
     * (from A.R.T. GmbH)
     *
     * \ingroup av_daemon
     */
    class AV_DAEMON_DLL KinectTrack : public Device
    {
      AV_BASE_DECLARE();
