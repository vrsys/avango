...
void av::daemon::DeviceSensor::initClass()
{
...
/* virtual */ void av::daemon::DeviceSensor::evaluate()
{
...
void av::daemon::DeviceSensor::updateMatrix()
{
    ::gua::math::mat4 mat;
    getMatrix(mat);
...
void av::daemon::DeviceSensor::updateButtons()
{
...
void av::daemon::DeviceSensor::updateValues()
{
...
void av::daemon::DeviceSensor::updateLEDs()
{
...
void av::daemon::DeviceSensor::getMatrix(::gua::math::mat4& mat)
{
...
float av::daemon::DeviceSensor::getValue(int v)
{
    if((v >= 0) && (v < sMaxValues))
    {
        const char* stationstr = Station.getValue().c_str();
        float value = DeviceService.getValue()->getValue(stationstr, v);
        if(ResetValuesOnRead.getValue())
            DeviceService.getValue()->setValue(stationstr, v, 0.0f);
        return value;
    }
...
bool av::daemon::DeviceSensor::getButton(int b)
{
...
bool av::daemon::DeviceSensor::getLED(int l)
{
    if((l >= 0) && (l < sMaxLEDs))
    {
        const char* stationstr = Station.getValue().c_str();
...
void av::daemon::DeviceSensor::setLED(int l, bool val)
{
    if((l >= 0) && (l < sMaxLEDs))
    {
        const char* stationstr = Station.getValue().c_str();
