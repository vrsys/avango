...
av::daemon::HMDTrack::HMDTrack() : Device(), mRequiredFeatures({"port", "server"}), mPort("7770"), mServer("127.0.0.1") {}

void av::daemon::HMDTrack::initClass()
{
...
/* virtual */ void av::daemon::HMDTrack::startDevice()
{
    if(!parseFeatures())
        return;
...
/* virtual */ void av::daemon::HMDTrack::readLoop()
{
...
/* virtual */ void av::daemon::HMDTrack::stopDevice()
{
#if 0
  mVHMDTrack->exit();
#endif
...
const std::vector<std::string>& av::daemon::HMDTrack::queryFeatures() { return mRequiredFeatures; }

bool av::daemon::HMDTrack::parseFeatures()
{
