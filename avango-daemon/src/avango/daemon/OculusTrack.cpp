...
av::daemon::OculusTrack::OculusTrack()
  : Device()
...
void
av::daemon::OculusTrack::initClass()
{
...
/* virtual */ void
av::daemon::OculusTrack::startDevice()
{
  if (!parseFeatures())
    return;
...
/* virtual */ void
av::daemon::OculusTrack::readLoop()
{
  ...
  while (mKeepRunning) {
    ...
    std::memcpy( &matrix, reinterpret_cast<::gua::math::mat4f*>(message.data()),
      sizeof(::gua::math::mat4f));
...
/* virtual */ void
av::daemon::OculusTrack::stopDevice()
{
#if 0
  mOculusTrack->exit();
#endif
...
av::daemon::OculusTrack::queryFeatures()
{
  return mRequiredFeatures;
}

bool
av::daemon::OculusTrack::parseFeatures()
{
