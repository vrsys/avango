...
av::daemon::VRPNClient::VRPNClient() : mStopped(true), mVRPNAnalog(0), mVRPNButton(0), mVRPNTracker(0) { mRequiredFeatures.push_back("server"); }
...
void av::daemon::VRPNClient::initClass()
{
...
const std::vector<std::string>& av::daemon::VRPNClient::queryFeatures() { return mRequiredFeatures; }

bool av::daemon::VRPNClient::parseFeatures()
{
...
/* virtual */ void av::daemon::VRPNClient::startDevice()
{
    if(!parseFeatures())
    {
...
/* virtual */ void av::daemon::VRPNClient::readLoop()
{
    while(mKeepRunning)
    {
        if(!mStopped)
...
/* virtual */ void av::daemon::VRPNClient::stopDevice()
{
...
void av::daemon::VRPNClient::handleAnalog(const vrpn_ANALOGCB a)
{
...
void av::daemon::VRPNClient::handleButton(const vrpn_BUTTONCB b)
{
    NumStationMap::iterator ns;
...
void av::daemon::VRPNClient::handleTracker(const vrpn_TRACKERCB t)
{
    NumStationMap::iterator ns;
