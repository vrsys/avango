...
class TuioCursor : public TuioContainer
{
  ...
  public:
     ...
     */
    TuioCursor(TuioTime ttime, long si, int ci, float xp, float yp) : TuioContainer(ttime, si, xp, yp) { cursor_id = ci; };
     ...
     * @param	yp	the Y coordinate to assign
     */
    TuioCursor(long si, int ci, float xp, float yp) : TuioContainer(si, xp, yp) { cursor_id = ci; };
     ...
     */
    TuioCursor(TuioCursor* tcur) : TuioContainer(tcur) { cursor_id = tcur->getCursorID(); };
     ...
     */
    int getCursorID() { return cursor_id; };
};
}; // namespace TUIO
#endif
