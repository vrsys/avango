...
class KeyboardDevice(avango.script.Script):
    ...
    KeyPageDown = avango.SFBool()
    KeyPageUp = avango.SFBool()
    KeyShift =  avango.SFBool()
    KeyCtrl =  avango.SFBool()
    KeyAlt =  avango.SFBool()
    KeyInsert =  avango.SFBool()
    KeyDelete = avango.SFBool()
    KeyHome = avango.SFBool()
    KeyEnd = avango.SFBool()
    KeyEsc = avango.SFBool()
    KeySpace = avango.SFBool()
    KeyEnter = avango.SFBool()
    KeyAltReturn = avango.SFBool()
    ...
    def connect(self, eventfields):
        ...
        self.KeyPageUp.connect_from(eventfields.KeyPageUp)
        self.KeyPageDown.connect_from(eventfields.KeyPageDown)
        self.KeyShift.connect_from(eventfields.KeyShift)
        self.KeyCtrl.connect_from(eventfields.KeyCtrl)
        self.KeyAlt.connect_from(eventfields.KeyAlt)
        self.KeyInsert.connect_from(eventfields.KeyInsert)
        self.KeyDelete.connect_from(eventfields.KeyDelete)
        self.KeyHome.connect_from(eventfields.KeyHome)
        self.KeyEnd.connect_from(eventfields.KeyEnd)
        ...
        self.KeyAltReturn.connect_from(eventfields.KeyAltReturn)
...
class MouseDevice(avango.script.Script):
    ...
    def connect(self, eventfields, camera, window):
        self.MouseTransform.connect_from(camera.MouseTransform)
        self.MouseViewerTransform.connect_from(camera.MouseViewerTransform)
        self.MouseNearTransform.connect_from(camera.MouseNearTransform)
