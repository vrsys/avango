...
struct Maestro_ClSv_DelayedMessage : public Maestro_Base {
  ...
  int operator ==(Maestro_ClSv_DelayedMessage &) {
    return 0;
  }
...
protected:
    ...
    virtual void clSv_AcceptedView_Callback(Maestro_ClSv_ViewData& ,
					    Maestro_Message &) {}
    // Message callbacks:
    
    virtual void clSv_ReceiveCast_Callback(Maestro_EndpID &, 
					   Maestro_Message &)  {}
    
    virtual void clSv_ReceiveScast_Callback(Maestro_EndpID &, 
					    Maestro_Message &) {}
    
    virtual void clSv_ReceiveSend_Callback(Maestro_EndpID &, 
					   Maestro_Message &)  {}
    
    virtual void clSv_ReceiveLsend_Callback(Maestro_EndpID &, 
					    Maestro_Message &) {}
    ...
    virtual void rcvState_Callback(Maestro_EndpID &, 
				   Maestro_Message &) {}
