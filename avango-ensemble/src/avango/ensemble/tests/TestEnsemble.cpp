...
namespace
{
  ...
  public:
    ...
    group_test(Maestro_GrpMemb_Options &ops) : Maestro_GroupMember(ops)
    {
      std::cout << "group_test::group_test(): constructor called." << std::endl;
    }

    virtual ~group_test()
    {
      std::cout << "group_test::group_test(): destructor called." << std::endl;
    }

  private:

    void grpMemb_ViewMsg_Callback(Maestro_GrpMemb_ViewData& viewData,
                                  Maestro_Message& /*OUT*/ /*viewMsg*/)
    {
    ...
    void grpMemb_MergeState_Callback(Maestro_MessageList& /*in*/ /*stateMsgs*/,
    ...
    void grpMemb_ViewStateInfo_Callback(Maestro_EndpID /*in*/ &origin,
                                        ...
                                        Maestro_Message /*out*/ &/*next_view_msg*/,
                                        int /*out*/ &/*final*/)
    {
    ...
    void grpMemb_AcceptedView_Callback(Maestro_GrpMemb_ViewData& /*viewData*/,
                                       Maestro_Message &/*msg*/)
    {
      std::cout << "group_test::grpMemb_AcceptedView_Callback(): " << line << std::endl;
    }
    ...
    {
      std::cout << "group_test::grpMemb_Block_Callback(): " << line << std::endl;
    }

    // The member has left the group:
    virtual void grpMemb_Exit_Callback()
    {
      std::cout << "group_test::grpMemb_Exit_Callback(): " << line << std::endl;
    }
