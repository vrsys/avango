...
namespace av
{
  namespace gua
  {
    ...
    public:
       ...
       */
      CollisionShapeNode(std::shared_ptr< ::gua::physics::CollisionShapeNode> guanode =
                         std::make_shared< ::gua::physics::CollisionShapeNode>("")); // use defined type to circumvent compiler bug in VS8
