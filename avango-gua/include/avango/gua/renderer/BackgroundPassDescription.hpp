...
class AV_GUA_DLL BackgroundPassDescription : public av::gua::PipelinePassDescription
{
  ...
  public:
    ...
    BackgroundPassDescription(
        std::shared_ptr<::gua::BackgroundPassDescription> const& BackgroundPassDescription = std::shared_ptr<::gua::BackgroundPassDescription>(new ::gua::BackgroundPassDescription()));
