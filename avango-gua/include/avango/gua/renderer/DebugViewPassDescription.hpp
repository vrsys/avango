...
namespace av
{
  namespace gua
  {
    ...
    public:
       ...
       */
      DebugViewPassDescription(std::shared_ptr< ::gua::DebugViewPassDescription> const& DebugViewPassDescription =
                                std::shared_ptr< ::gua::DebugViewPassDescription>(new ::gua::DebugViewPassDescription()) );
