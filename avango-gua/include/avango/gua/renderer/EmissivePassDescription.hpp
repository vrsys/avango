...
namespace av
{
  namespace gua
  {
    ...
    public:
       ...
       */
      EmissivePassDescription(std::shared_ptr< ::gua::EmissivePassDescription> const& EmissivePassDescription =
                                std::shared_ptr< ::gua::EmissivePassDescription>(new ::gua::EmissivePassDescription()) );
