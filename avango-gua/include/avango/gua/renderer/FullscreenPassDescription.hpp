...
class AV_GUA_DLL FullscreenPassDescription : public av::gua::PipelinePassDescription
{
  ...
  public:
    ...
    FullscreenPassDescription(
        std::shared_ptr<::gua::FullscreenPassDescription> const& FullscreenPassDescription = std::shared_ptr<::gua::FullscreenPassDescription>(new ::gua::FullscreenPassDescription()));
