...
class AV_GUA_DLL ResolvePassDescription : public av::gua::PipelinePassDescription
{
  ...
  public:
     ...
     */
    ResolvePassDescription(std::shared_ptr<::gua::ResolvePassDescription> const& ResolvePassDescription = std::shared_ptr<::gua::ResolvePassDescription>(new ::gua::ResolvePassDescription()));
