...
namespace av
{
  namespace gua
  {
    ...
    public:
       ...
       */
      SPointsPassDescription(std::shared_ptr< ::gua::SPointsPassDescription> const& SPointsPassDescription =
                             std::shared_ptr< ::gua::SPointsPassDescription>(new ::gua::SPointsPassDescription()) );
