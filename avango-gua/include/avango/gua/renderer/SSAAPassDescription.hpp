...
class AV_GUA_DLL SSAAPassDescription : public av::gua::PipelinePassDescription
{
  ...
  public:
     ...
     */
    SSAAPassDescription(std::shared_ptr<::gua::SSAAPassDescription> const& SSAAPassDescription = std::shared_ptr<::gua::SSAAPassDescription>(new ::gua::SSAAPassDescription()));
