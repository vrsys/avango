...
class AV_GUA_DLL TriMeshPassDescription : public av::gua::PipelinePassDescription
{
  ...
  public:
     ...
     */
    TriMeshPassDescription(std::shared_ptr<::gua::TriMeshPassDescription> const& TriMeshPassDescription = std::shared_ptr<::gua::TriMeshPassDescription>(new ::gua::TriMeshPassDescription()));
