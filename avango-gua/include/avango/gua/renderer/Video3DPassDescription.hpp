...
namespace av
{
  namespace gua
  {
    ...
    public:
       ...
       */
      Video3DPassDescription(std::shared_ptr< ::gua::Video3DPassDescription> const& Video3DPassDescription =
                             std::shared_ptr< ::gua::Video3DPassDescription>(new ::gua::Video3DPassDescription()) );
