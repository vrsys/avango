...
void init_Vec2()
{
    ...
    class_<::gua::math::vec2>("Vec2", no_init)
        ...
        .def(init<::gua::math::vec2>()) ADD_VECTOR_OPERATORS_2D(::gua::math::vec2)
...
void init_Vec2i()
{
    ...
    class_<::gua::math::vec2i>("Vec2i", no_init)
        ...
        .def(init<::gua::math::vec2i>()) ADD_VECTOR_OPERATORS_2D(::gua::math::vec2i)
...
void init_Vec2ui()
{
    ...
    class_<::gua::math::vec2ui>("Vec2ui", no_init)
        ...
        .def(init<unsigned, unsigned>())
        .def(init<::gua::math::vec2ui>()) ADD_VECTOR_OPERATORS_2D(::gua::math::vec2ui)
...
void init_Vec3()
{
    ...
    class_<::gua::math::vec3>("Vec3", no_init)
        ...
        .def(init<::gua::math::vec3::value_type, ::gua::math::vec3::value_type, ::gua::math::vec3::value_type>())
        .def(init<::gua::math::vec3>()) ADD_VECTOR_OPERATORS_3D_4D(::gua::math::vec3)
...
void init_Vec3i()
{
    ...
    class_<::gua::math::vec3i>("Vec3i", no_init)
        ...
        .def(init<::gua::math::vec3i::value_type, ::gua::math::vec3i::value_type, ::gua::math::vec3i::value_type>())
        .def(init<::gua::math::vec3i>()) ADD_VECTOR_OPERATORS_3D_4D(::gua::math::vec3i)
...
void init_Vec3ui()
{
    ...
    class_<::gua::math::vec3ui>("Vec3ui", no_init)
        ...
        .def(init<::gua::math::vec3ui::value_type, ::gua::math::vec3ui::value_type, ::gua::math::vec3ui::value_type>())
        .def(init<::gua::math::vec3ui>()) ADD_VECTOR_OPERATORS_3D_4D(::gua::math::vec3ui)
...
void init_Vec4()
{
    ...
    class_<::gua::math::vec4>("Vec4", no_init)
        ...
        .def(init<::gua::math::vec4::value_type, ::gua::math::vec4::value_type, ::gua::math::vec4::value_type, ::gua::math::vec4::value_type>())
        .def(init<::gua::math::vec4>()) ADD_VECTOR_OPERATORS_3D_4D(::gua::math::vec4)
...
void init_Vec4i()
{
    ...
    class_<::gua::math::vec4i>("Vec4i", no_init)
        ...
        .def(init<::gua::math::vec4i::value_type, ::gua::math::vec4i::value_type, ::gua::math::vec4i::value_type, ::gua::math::vec4i::value_type>())
        .def(init<::gua::math::vec4i>()) ADD_VECTOR_OPERATORS_3D_4D(::gua::math::vec4i)
...
void init_Vec4ui()
{
    ...
    class_<::gua::math::vec4ui>("Vec4ui", no_init)
        ...
        .def(init<::gua::math::vec4ui::value_type, ::gua::math::vec4ui::value_type, ::gua::math::vec4ui::value_type, ::gua::math::vec4ui::value_type>())
        .def(init<::gua::math::vec4ui>()) ADD_VECTOR_OPERATORS_3D_4D(::gua::math::vec4ui)
...
::gua::math::mat4::value_type getMat3Element(::gua::math::mat3 const& mat, int row, int col) { return mat[row + col * 3]; }

void setMat3Element(::gua::math::mat3& mat, int row, int col, ::gua::math::mat3::value_type val) { mat[row + col * 3] = val; }
...
::gua::math::mat4::value_type getMat4Element(::gua::math::mat4 const& mat, int row, int col) { return mat[row + col * 4]; }

void setMat4Element(::gua::math::mat4& mat, int row, int col, ::gua::math::mat4::value_type val) { mat[row + col * 4] = val; }
...
void setTranslate1(::gua::math::mat4& mat, ::gua::math::vec3 const& vec)
{
    mat[12] = vec[0];
    mat[13] = vec[1];
    mat[14] = vec[2];
...
void setTranslate2(::gua::math::mat4& mat, ::gua::math::mat4::value_type x, ::gua::math::mat4::value_type y, ::gua::math::mat4::value_type z)
{
    mat[12] = x;
    mat[13] = y;
    mat[14] = z;
...
::gua::math::quat const getRotate1(::gua::math::mat4 const& mat) { return ::gua::math::quat::from_matrix(mat); }
...
::gua::math::mat4 const makeRot3(::gua::math::quat const& quat) { return quat.to_matrix(); }

::gua::math::mat4 const makeRot4(::gua::math::vec4 const& rotation_axis) { return scm::math::make_rotation(rotation_axis.x, rotation_axis.y, rotation_axis.z, rotation_axis.w); }

::gua::math::mat4 const makeScale3(::gua::math::mat4::value_type value) { return scm::math::make_scale(value, value, value); }

void init_Mat4()
{
    void (*translate1)(::gua::math::mat4&, ::gua::math::vec3 const&) = &scm::math::translate;

    void (*translate2)(::gua::math::mat4&, ::gua::math::mat4::value_type, ::gua::math::mat4::value_type, ::gua::math::mat4::value_type) = &scm::math::translate;

    void (*rotate1)(::gua::math::mat4&, ::gua::math::mat4::value_type, ::gua::math::vec3 const&) = &scm::math::rotate;

    void (*rotate2)(::gua::math::mat4&, ::gua::math::mat4::value_type, ::gua::math::mat4::value_type, ::gua::math::mat4::value_type, ::gua::math::mat4::value_type) = &scm::math::rotate;

    void (*scale1)(::gua::math::mat4&, ::gua::math::vec3 const&) = &scm::math::scale;

    void (*scale2)(::gua::math::mat4&, ::gua::math::mat4::value_type, ::gua::math::mat4::value_type, ::gua::math::mat4::value_type) = &scm::math::scale;

    ::gua::math::mat4 const (*inverse)(::gua::math::mat4 const&) = &scm::math::inverse;
    ::gua::math::mat4 const (*transpose)(::gua::math::mat4 const&) = &scm::math::transpose;

    // eye, center, up
    ::gua::math::mat4 const (*makeLookAt)(::gua::math::vec3 const&, ::gua::math::vec3 const&, ::gua::math::vec3 const&) = &scm::math::make_look_at_matrix;
    ::gua::math::mat4 const (*makeLookAtInv)(::gua::math::vec3 const&, ::gua::math::vec3 const&, ::gua::math::vec3 const&) = &scm::math::make_look_at_matrix_inv;
    ...
    // global methods
    ::gua::math::mat4 const (*makeTrans1)(::gua::math::vec3 const&) = &scm::math::make_translation;
    ::gua::math::mat4 const (*makeTrans2)(::gua::math::mat4::value_type, ::gua::math::mat4::value_type, ::gua::math::mat4::value_type) = &scm::math::make_translation;

    ::gua::math::mat4 const (*makeRot1)(::gua::math::mat4::value_type, ::gua::math::vec3 const&) = &scm::math::make_rotation;

    ::gua::math::mat4 const (*makeRot2)(::gua::math::mat4::value_type, ::gua::math::mat4::value_type, ::gua::math::mat4::value_type, ::gua::math::mat4::value_type) = &scm::math::make_rotation;

    ::gua::math::mat4 const (*makeScale1)(::gua::math::vec3 const&) = &scm::math::make_scale;

    ::gua::math::mat4 const (*makeScale2)(::gua::math::mat4::value_type, ::gua::math::mat4::value_type, ::gua::math::mat4::value_type) = &scm::math::make_scale;

    def("make_identity_mat", &::gua::math::mat4::identity, return_value_policy<copy_const_reference>());
...
void normalizeQuat(::gua::math::quat& quat) { quat = scm::math::normalize(quat); }

void conjugateQuat(::gua::math::quat& quat) { quat = scm::math::conjugate(quat); }
...
void init_Quat()
{
    ::gua::math::quat::value_type const (*magnitude)(::gua::math::quat const&) = &scm::math::magnitude;

    class_<::gua::math::quat>("Quat", no_init)
        .def("__init__", make_constructor(&constructorQuat<::gua::math::quat>))
        .def(init<::gua::math::quat::value_type, ::gua::math::quat::value_type, ::gua::math::quat::value_type, ::gua::math::quat::value_type>())
