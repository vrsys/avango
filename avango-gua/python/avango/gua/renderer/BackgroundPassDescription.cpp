...
void init_BackgroundPassDescription()
{
    ...
    class_<av::gua::BackgroundPassDescription, av::Link<av::gua::BackgroundPassDescription>, bases<av::gua::PipelinePassDescription>, boost::noncopyable>(
        "BackgroundPassDescription", "docstring", no_init);
