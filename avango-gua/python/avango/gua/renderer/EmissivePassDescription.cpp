...
void init_EmissivePassDescription()
{
    ...
    class_<av::gua::EmissivePassDescription, av::Link<av::gua::EmissivePassDescription>, bases<av::gua::PipelinePassDescription>, boost::noncopyable>("EmissivePassDescription", "docstring", no_init);
}
