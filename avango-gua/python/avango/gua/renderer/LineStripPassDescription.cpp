...
void init_LineStripPassDescription()
 {
  ...
  class_<av::gua::LineStripPassDescription,
         av::Link<av::gua::LineStripPassDescription>,
         bases<av::gua::PipelinePassDescription>, boost::noncopyable >("LineStripPassDescription", "docstring", no_init)
         ;
 }
