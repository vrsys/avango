...
void init_MaterialShaderDescription()
{
    ...
    class_<av::gua::MaterialShaderDescription, av::Link<av::gua::MaterialShaderDescription>, bases<av::FieldContainer>, boost::noncopyable>("MaterialShaderDescription", "docstring", no_init)
