...
void init_MaterialShaderMethod()
{
    ...
    class_<av::gua::MaterialShaderMethod, av::Link<av::gua::MaterialShaderMethod>, bases<av::FieldContainer>, boost::noncopyable>("MaterialShaderMethod", "docstring", no_init)
