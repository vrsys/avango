...
void init_OcclusionSlaveResolvePassDescription()
{
    ...
    class_<av::gua::OcclusionSlaveResolvePassDescription, av::Link<av::gua::OcclusionSlaveResolvePassDescription>, bases<av::gua::PipelinePassDescription>, boost::noncopyable>(
        "OcclusionSlaveResolvePassDescription", "docstring", no_init);
}
