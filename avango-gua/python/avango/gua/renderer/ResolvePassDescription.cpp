...
void init_ResolvePassDescription()
{
    ...
    class_<av::gua::ResolvePassDescription, av::Link<av::gua::ResolvePassDescription>, bases<av::gua::PipelinePassDescription>, boost::noncopyable>("ResolvePassDescription", "docstring", no_init);
