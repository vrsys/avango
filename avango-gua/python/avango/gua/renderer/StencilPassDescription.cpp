...
void init_StencilPassDescription()
{
    ...
    class_<av::gua::StencilPassDescription, av::Link<av::gua::StencilPassDescription>, bases<av::gua::PipelinePassDescription>, boost::noncopyable>("StencilPassDescription", "docstring", no_init);
}
