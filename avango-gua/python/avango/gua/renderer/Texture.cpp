...
void createTextureCube(
    std::string const& name, std::string const& file_px, std::string const& file_nx, std::string const& file_py, std::string const& file_ny, std::string const& file_pz, std::string const& file_nz)
{
    std::shared_ptr<::gua::Texture> new_tex(new gua::TextureCube(file_px, file_nx, file_py, file_ny, file_pz, file_nz));
