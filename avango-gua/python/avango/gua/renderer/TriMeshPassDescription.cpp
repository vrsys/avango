...
void init_TriMeshPassDescription()
{
    ...
    class_<av::gua::TriMeshPassDescription, av::Link<av::gua::TriMeshPassDescription>, bases<av::gua::PipelinePassDescription>, boost::noncopyable>("TriMeshPassDescription", "docstring", no_init);
}
