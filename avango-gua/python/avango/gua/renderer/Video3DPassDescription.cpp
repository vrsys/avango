...
void init_Video3DPassDescription()
{
    ...
    class_<av::gua::Video3DPassDescription, av::Link<av::gua::Video3DPassDescription>, bases<av::gua::PipelinePassDescription>, boost::noncopyable>("Video3DPassDescription", "docstring", no_init);
}
