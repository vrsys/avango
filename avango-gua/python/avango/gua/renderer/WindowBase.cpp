...
void init_WindowBase()
{
    ...
    enum_<av::gua::WindowBase::Mode>("StereoMode")
        ...
        .value("SIDE_BY_SIDE_SOFTWARE_MVR", av::gua::WindowBase::SIDE_BY_SIDE_SOFTWARE_MVR)
        .value("SIDE_BY_SIDE_HARDWARE_MVR", av::gua::WindowBase::SIDE_BY_SIDE_HARDWARE_MVR)
