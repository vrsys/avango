...
void av_pushMsg(av::Msg& netMsg, const ::gua::math::mat4& buf) { throw std::runtime_error("not implemented."); }
void av_popMsg(av::Msg& netMsg, ::gua::math::mat4& buf) { throw std::runtime_error("not implemented."); }

void av_pushMsg(av::Msg& netMsg, const ::gua::math::mat3& buf) { throw std::runtime_error("not implemented."); }
void av_popMsg(av::Msg& netMsg, ::gua::math::mat3& buf) { throw std::runtime_error("not implemented."); }

void av_pushMsg(av::Msg& netMsg, const ::gua::math::quat& buf) { throw std::runtime_error("not implemented."); }
void av_popMsg(av::Msg& netMsg, ::gua::math::quat& buf) { throw std::runtime_error("not implemented."); }

void av_pushMsg(av::Msg& netMsg, const ::gua::math::vec4& buf) { throw std::runtime_error("not implemented."); }
void av_popMsg(av::Msg& netMsg, ::gua::math::vec4& buf) { throw std::runtime_error("not implemented."); }
void av_pushMsg(av::Msg& netMsg, const ::gua::math::vec4i& buf) { throw std::runtime_error("not implemented."); }
void av_popMsg(av::Msg& netMsg, ::gua::math::vec4i& buf) { throw std::runtime_error("not implemented."); }
void av_pushMsg(av::Msg& netMsg, const ::gua::math::vec4ui& buf) { throw std::runtime_error("not implemented."); }
void av_popMsg(av::Msg& netMsg, ::gua::math::vec4ui& buf) { throw std::runtime_error("not implemented."); }

void av_pushMsg(av::Msg& netMsg, const ::gua::math::vec3& buf) { throw std::runtime_error("not implemented."); }
void av_popMsg(av::Msg& netMsg, ::gua::math::vec3& buf) { throw std::runtime_error("not implemented."); }
void av_pushMsg(av::Msg& netMsg, const ::gua::math::vec3i& buf) { throw std::runtime_error("not implemented."); }
void av_popMsg(av::Msg& netMsg, ::gua::math::vec3i& buf) { throw std::runtime_error("not implemented."); }
void av_pushMsg(av::Msg& netMsg, const ::gua::math::vec3ui& buf) { throw std::runtime_error("not implemented."); }
void av_popMsg(av::Msg& netMsg, ::gua::math::vec3ui& buf) { throw std::runtime_error("not implemented."); }

void av_pushMsg(av::Msg& netMsg, const ::gua::math::vec2& buf) { throw std::runtime_error("not implemented."); }
void av_popMsg(av::Msg& netMsg, ::gua::math::vec2& buf) { throw std::runtime_error("not implemented."); }
void av_pushMsg(av::Msg& netMsg, const ::gua::math::vec2i& buf) { throw std::runtime_error("not implemented."); }
void av_popMsg(av::Msg& netMsg, ::gua::math::vec2i& buf) { throw std::runtime_error("not implemented."); }
void av_pushMsg(av::Msg& netMsg, const ::gua::math::vec2ui& buf) { throw std::runtime_error("not implemented."); }
void av_popMsg(av::Msg& netMsg, ::gua::math::vec2ui& buf) { throw std::runtime_error("not implemented."); }

void av_pushMsg(av::Msg& netMsg, const ::gua::utils::Color3f& buf) { throw std::runtime_error("not implemented."); }
void av_popMsg(av::Msg& netMsg, ::gua::utils::Color3f& buf) { throw std::runtime_error("not implemented."); }

void av_pushMsg(av::Msg& netMsg, const ::gua::physics::CollisionShape& buf) { throw std::runtime_error("not implemented."); }
void av_popMsg(av::Msg& netMsg, ::gua::physics::CollisionShape& buf) { throw std::runtime_error("not implemented."); }

void av_pushMsg(av::Msg& netMsg, const ::gua::physics::Constraint& buf) { throw std::runtime_error("not implemented."); }
void av_popMsg(av::Msg& netMsg, ::gua::physics::Constraint& buf) { throw std::runtime_error("not implemented."); }

//void av_pushMsg(av::Msg& netMsg, const ::gua::Camera& buf) { throw std::runtime_error("not implemented."); }
//void av_popMsg(av::Msg& netMsg, ::gua::Camera& buf) { throw std::runtime_error("not implemented."); }

void av_pushMsg(av::Msg& netMsg, const ::gua::RayNode& buf) { throw std::runtime_error("not implemented."); }
void av_popMsg(av::Msg& netMsg, ::gua::RayNode& buf) { throw std::runtime_error("not implemented."); }

void av_pushMsg(av::Msg& netMsg, const ::gua::ScreenNode& buf) { throw std::runtime_error("not implemented."); }
void av_popMsg(av::Msg& netMsg, ::gua::ScreenNode& buf) { throw std::runtime_error("not implemented."); }

void av_pushMsg(av::Msg& netMsg, const ::gua::TexturedQuadNode& buf) { throw std::runtime_error("not implemented."); }
void av_popMsg(av::Msg& netMsg, ::gua::TexturedQuadNode& buf) { throw std::runtime_error("not implemented."); }

void av_pushMsg(av::Msg& netMsg, const ::gua::GeometryNode& buf) { throw std::runtime_error("not implemented."); }
void av_popMsg(av::Msg& netMsg, ::gua::GeometryNode& buf) { throw std::runtime_error("not implemented."); }

void av_pushMsg(av::Msg& netMsg, const ::gua::VolumeNode& buf) { throw std::runtime_error("not implemented."); }
void av_popMsg(av::Msg& netMsg, ::gua::VolumeNode& buf) { throw std::runtime_error("not implemented."); }

void av_pushMsg(av::Msg& netMsg, const ::gua::SceneGraph& buf) { throw std::runtime_error("not implemented."); }
void av_popMsg(av::Msg& netMsg, ::gua::SceneGraph& buf) { throw std::runtime_error("not implemented."); }
