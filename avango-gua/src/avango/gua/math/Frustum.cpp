...
::gua::Frustum* av::gua::Frustum::getGuaFrustum() const { return m_guaFrustum; }

/* virtual */ void av::gua::Frustum::getClipNearCB(const SFDouble::GetValueEvent& event) { *(event.getValuePtr()) = m_guaFrustum->get_clip_near(); }

/* virtual */ void av::gua::Frustum::setClipNearCB(const SFDouble::SetValueEvent& event)
{
    // std::cout << "Error in av::gua::Frustum: Frustum is read-only structure!" << std::endl;
}

/* virtual */ void av::gua::Frustum::getClipFarCB(const SFDouble::GetValueEvent& event) { *(event.getValuePtr()) = m_guaFrustum->get_clip_far(); }

/* virtual */ void av::gua::Frustum::setClipFarCB(const SFDouble::SetValueEvent& event)
{
    // std::cout << "Error in av::gua::Frustum: Frustum is read-only structure!" << std::endl;
}

/* virtual */ void av::gua::Frustum::getCameraTransformCB(const SFMatrix4::GetValueEvent& event) { *(event.getValuePtr()) = m_guaFrustum->get_camera_transform(); }

/* virtual */ void av::gua::Frustum::setCameraTransformCB(const SFMatrix4::SetValueEvent& event)
{
    // std::cout << "Error in av::gua::Frustum: Frustum is read-only structure!" << std::endl;
}

/* virtual */ void av::gua::Frustum::getScreenTransformCB(const SFMatrix4::GetValueEvent& event) { *(event.getValuePtr()) = m_guaFrustum->get_screen_transform(); }

/* virtual */ void av::gua::Frustum::setScreenTransformCB(const SFMatrix4::SetValueEvent& event)
{
    // std::cout << "Error in av::gua::Frustum: Frustum is read-only structure!" << std::endl;
}

/* virtual */ void av::gua::Frustum::getViewMatrixCB(const SFMatrix4::GetValueEvent& event) { *(event.getValuePtr()) = m_guaFrustum->get_view(); }

/* virtual */ void av::gua::Frustum::setViewMatrixCB(const SFMatrix4::SetValueEvent& event)
{
    // std::cout << "Error in av::gua::Frustum: Frustum is read-only structure!" << std::endl;
}

/* virtual */ void av::gua::Frustum::getProjectionMatrixCB(const SFMatrix4::GetValueEvent& event) { *(event.getValuePtr()) = m_guaFrustum->get_projection(); }

/* virtual */ void av::gua::Frustum::setProjectionMatrixCB(const SFMatrix4::SetValueEvent& event)
{
    // std::cout << "Error in av::gua::Frustum: Frustum is read-only structure!" << std::endl;
}

/* virtual */ void av::gua::Frustum::getCornersCB(const MFVec3::GetValueEvent& event) { *(event.getValuePtr()) = m_guaFrustum->get_corners(); }

/* virtual */ void av::gua::Frustum::setCornersCB(const MFVec3::SetValueEvent& event)
{
    // std::cout << "Error in av::gua::Frustum: Frustum is read-only structure!" << std::endl;
}
