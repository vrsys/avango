...
av::gua::Constraint::Constraint(::gua::physics::Constraint* guaconstraint) : m_guaConstraint(guaconstraint)
{
    AV_FC_ADD_ADAPTOR_FIELD(BodyA, std::bind(&Constraint::getBodyACB, this, std::placeholders::_1), std::bind(&Constraint::setBodyACB, this, std::placeholders::_1));

    AV_FC_ADD_ADAPTOR_FIELD(BodyB, std::bind(&Constraint::getBodyBCB, this, std::placeholders::_1), std::bind(&Constraint::setBodyBCB, this, std::placeholders::_1));

    AV_FC_ADD_ADAPTOR_FIELD(Enabled, std::bind(&Constraint::getEnabledCB, this, std::placeholders::_1), std::bind(&Constraint::setEnabledCB, this, std::placeholders::_1));
...
void av::gua::Constraint::initClass()
{
...
::gua::physics::Constraint* av::gua::Constraint::getGuaConstraint() const { return m_guaConstraint; }

void av::gua::Constraint::getBodyACB(const SFRigidBodyNode::GetValueEvent& event)
{
...
void av::gua::Constraint::setBodyACB(const SFRigidBodyNode::SetValueEvent& event) { m_guaConstraint->set_body_a(event.getValue()->getGuaNode().get()); }

void av::gua::Constraint::getBodyBCB(const SFRigidBodyNode::GetValueEvent& event)
{
...
void av::gua::Constraint::setBodyBCB(const SFRigidBodyNode::SetValueEvent& event) { m_guaConstraint->set_body_b(event.getValue()->getGuaNode().get()); }

void av::gua::Constraint::getEnabledCB(const SFBool::GetValueEvent& event) { *(event.getValuePtr()) = m_guaConstraint->enabled(); }

void av::gua::Constraint::setEnabledCB(const SFBool::SetValueEvent& event) { m_guaConstraint->set_enabled(event.getValue()); }
