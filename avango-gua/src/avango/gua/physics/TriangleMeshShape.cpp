...
av::gua::TriangleMeshShape::TriangleMeshShape(::gua::physics::TriangleMeshShape* guashape)
    : CollisionShape(guashape), m_guaShape(reinterpret_cast<::gua::physics::TriangleMeshShape*>(CollisionShape::getGuaShape()))
{
    AV_FC_ADD_ADAPTOR_FIELD(Scaling, std::bind(&TriangleMeshShape::getScalingCB, this, std::placeholders::_1), std::bind(&TriangleMeshShape::setScalingCB, this, std::placeholders::_1));
}

av::gua::TriangleMeshShape::~TriangleMeshShape() {}

void av::gua::TriangleMeshShape::initClass()
{
...
::gua::physics::TriangleMeshShape* av::gua::TriangleMeshShape::getGuaShape() const { return m_guaShape; }

void av::gua::TriangleMeshShape::getScalingCB(const SFVec3::GetValueEvent& event) { *(event.getValuePtr()) = m_guaShape->get_scaling(); }
