...
std::shared_ptr< ::gua::LightVisibilityPassDescription> const&
av::gua::LightVisibilityPassDescription::getGuaLightVisibilityPassDescription() const
{
    return m_guaLightVisibilityPassDescription;
}
