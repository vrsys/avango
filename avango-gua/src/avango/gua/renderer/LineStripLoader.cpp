...
av::gua::LineStripLoader::LineStripLoader(::gua::LineStripLoader* guaLineStripLoader)
    : m_guaLineStripLoader(guaLineStripLoader)
{}
...
av::Link<av::gua::Node>
av::gua::LineStripLoader::createGeometryFromFile(std::string const& nodeName,
                                               std::string const& fileName,
                                               av::gua::Material const& fallbackMaterial,
                                               Flags flags) const
{

    auto gua_node(m_guaLineStripLoader->create_geometry_from_file(
...
::gua::LineStripLoader*
av::gua::LineStripLoader::getGuaLineStripLoader() const
{
    return m_guaLineStripLoader;
}

av::gua::Node*
av::gua::LineStripLoader::createChildren(std::shared_ptr< ::gua::node::Node> root) const {
