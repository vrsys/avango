...
av::gua::Material::Material(std::shared_ptr<::gua::Material> const& guaMaterial) : m_guaMaterial(guaMaterial), m_distributed(false)
{
    AV_FC_ADD_ADAPTOR_FIELD(ShaderName, std::bind(&Material::getShaderNameCB, this, std::placeholders::_1), std::bind(&Material::setShaderNameCB, this, std::placeholders::_1));

    AV_FC_ADD_ADAPTOR_FIELD(
        EnableBackfaceCulling, std::bind(&Material::getEnableBackfaceCullingCB, this, std::placeholders::_1), std::bind(&Material::setEnableBackfaceCullingCB, this, std::placeholders::_1));
...
void av::gua::Material::initClass()
{
...
void av::gua::Material::getShaderNameCB(const SFString::GetValueEvent& event) { *(event.getValuePtr()) = m_guaMaterial->get_shader_name(); }

void av::gua::Material::setShaderNameCB(const SFString::SetValueEvent& event)
{
...
void av::gua::Material::getEnableBackfaceCullingCB(const SFBool::GetValueEvent& event) { *(event.getValuePtr()) = !m_guaMaterial->get_show_back_faces(); }

void av::gua::Material::setEnableBackfaceCullingCB(const SFBool::SetValueEvent& event) { m_guaMaterial->set_show_back_faces(!event.getValue()); }
...
void av::gua::Material::setEnableVirtualTexturingCB(const SFBool::SetValueEvent& event) { m_guaMaterial->set_enable_virtual_texturing(event.getValue()); }
#endif

std::shared_ptr<::gua::Material> const& av::gua::Material::getGuaMaterial() const { return m_guaMaterial; }
