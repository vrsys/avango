...
void av::gua::MaterialShaderDescription::getVertexMethodsCB(const MFMaterialShaderMethod::GetValueEvent& event) { *(event.getValuePtr()) = m_vertexMethods; }

void av::gua::MaterialShaderDescription::setVertexMethodsCB(const MFMaterialShaderMethod::SetValueEvent& event)
{
...
void av::gua::MaterialShaderDescription::getFragmentMethodsCB(const MFMaterialShaderMethod::GetValueEvent& event) { *(event.getValuePtr()) = m_fragmentMethods; }

void av::gua::MaterialShaderDescription::setFragmentMethodsCB(const MFMaterialShaderMethod::SetValueEvent& event)
{
...
void av::gua::MaterialShaderDescription::load_from_file(std::string const& file)
{
...
void av::gua::MaterialShaderDescription::load_from_json(std::string const& json)
{
...
std::shared_ptr<::gua::MaterialShaderDescription> const& av::gua::MaterialShaderDescription::getGuaMaterialShaderDescription() const { return m_guaMaterialShaderDescription; }
