...
av::gua::ResolvePassDescription::ResolvePassDescription(std::shared_ptr<::gua::ResolvePassDescription> const& guaResolvePassDescription)
    : PipelinePassDescription(guaResolvePassDescription), m_guaResolvePassDescription(guaResolvePassDescription)
{
    AV_FC_ADD_ADAPTOR_FIELD(
        BackgroundColor, std::bind(&ResolvePassDescription::getBackgroundColorCB, this, std::placeholders::_1), std::bind(&ResolvePassDescription::setBackgroundColorCB, this, std::placeholders::_1));
    ...
    AV_FC_ADD_ADAPTOR_FIELD(
        BackgroundMode, std::bind(&ResolvePassDescription::getBackgroundModeCB, this, std::placeholders::_1), std::bind(&ResolvePassDescription::setBackgroundModeCB, this, std::placeholders::_1));

    AV_FC_ADD_ADAPTOR_FIELD(
        EnableFog, std::bind(&ResolvePassDescription::getEnableFogCB, this, std::placeholders::_1), std::bind(&ResolvePassDescription::setEnableFogCB, this, std::placeholders::_1));

    AV_FC_ADD_ADAPTOR_FIELD(FogStart, std::bind(&ResolvePassDescription::getFogStartCB, this, std::placeholders::_1), std::bind(&ResolvePassDescription::setFogStartCB, this, std::placeholders::_1));
    ...
    AV_FC_ADD_ADAPTOR_FIELD(
        VignetteColor, std::bind(&ResolvePassDescription::getVignetteColorCB, this, std::placeholders::_1), std::bind(&ResolvePassDescription::setVignetteColorCB, this, std::placeholders::_1));

    AV_FC_ADD_ADAPTOR_FIELD(FogEnd, std::bind(&ResolvePassDescription::getFogEndCB, this, std::placeholders::_1), std::bind(&ResolvePassDescription::setFogEndCB, this, std::placeholders::_1));

    AV_FC_ADD_ADAPTOR_FIELD(
        ToneMappingMode, std::bind(&ResolvePassDescription::getToneMappingModeCB, this, std::placeholders::_1), std::bind(&ResolvePassDescription::setToneMappingModeCB, this, std::placeholders::_1));

    AV_FC_ADD_ADAPTOR_FIELD(Exposure, std::bind(&ResolvePassDescription::getExposureCB, this, std::placeholders::_1), std::bind(&ResolvePassDescription::setExposureCB, this, std::placeholders::_1));
    ...
    AV_FC_ADD_ADAPTOR_FIELD(
        HorizonFade, std::bind(&ResolvePassDescription::getHorizonFadeCB, this, std::placeholders::_1), std::bind(&ResolvePassDescription::setHorizonFadeCB, this, std::placeholders::_1));

    AV_FC_ADD_ADAPTOR_FIELD(
        EnableSSAO, std::bind(&ResolvePassDescription::getEnableSSAOCB, this, std::placeholders::_1), std::bind(&ResolvePassDescription::setEnableSSAOCB, this, std::placeholders::_1));

    AV_FC_ADD_ADAPTOR_FIELD(
        SSAORadius, std::bind(&ResolvePassDescription::getSSAORadiusCB, this, std::placeholders::_1), std::bind(&ResolvePassDescription::setSSAORadiusCB, this, std::placeholders::_1));

    AV_FC_ADD_ADAPTOR_FIELD(
        SSAOIntensity, std::bind(&ResolvePassDescription::getSSAOIntensityCB, this, std::placeholders::_1), std::bind(&ResolvePassDescription::setSSAOIntensityCB, this, std::placeholders::_1));

    AV_FC_ADD_ADAPTOR_FIELD(
        SSAOFalloff, std::bind(&ResolvePassDescription::getSSAOFalloffCB, this, std::placeholders::_1), std::bind(&ResolvePassDescription::setSSAOFalloffCB, this, std::placeholders::_1));
    ...
    AV_FC_ADD_ADAPTOR_FIELD(
        DebugTiles, std::bind(&ResolvePassDescription::getDebugTilesCB, this, std::placeholders::_1), std::bind(&ResolvePassDescription::setDebugTilesCB, this, std::placeholders::_1));
}

void av::gua::ResolvePassDescription::initClass()
{
...
void av::gua::ResolvePassDescription::getBackgroundColorCB(const SFColor::GetValueEvent& event) { *(event.getValuePtr()) = m_guaResolvePassDescription->background_color(); }

void av::gua::ResolvePassDescription::setBackgroundColorCB(const SFColor::SetValueEvent& event) { m_guaResolvePassDescription->background_color(event.getValue()); }

void av::gua::ResolvePassDescription::getBackgroundTextureCB(const SFString::GetValueEvent& event) { *(event.getValuePtr()) = m_guaResolvePassDescription->background_texture(); }

void av::gua::ResolvePassDescription::setBackgroundTextureCB(const SFString::SetValueEvent& event) { m_guaResolvePassDescription->background_texture(event.getValue()); }

void av::gua::ResolvePassDescription::getAlternativeBackgroundTextureCB(const SFString::GetValueEvent& event)
{
...
void av::gua::ResolvePassDescription::getBackgroundTextureBlendFactorCB(const SFFloat::GetValueEvent& event)
{
    *(event.getValuePtr()) = m_guaResolvePassDescription->background_texture_blend_factor();
}

void av::gua::ResolvePassDescription::setBackgroundTextureBlendFactorCB(const SFFloat::SetValueEvent& event) { m_guaResolvePassDescription->background_texture_blend_factor(event.getValue()); }
...
void av::gua::ResolvePassDescription::setBackgroundModeCB(const SFUInt::SetValueEvent& event)
{
...
void av::gua::ResolvePassDescription::setEnableFogCB(const SFBool::SetValueEvent& event) { m_guaResolvePassDescription->enable_fog(event.getValue()); }

void av::gua::ResolvePassDescription::getFogStartCB(const SFFloat::GetValueEvent& event) { *(event.getValuePtr()) = m_guaResolvePassDescription->fog_start(); }

void av::gua::ResolvePassDescription::setFogStartCB(const SFFloat::SetValueEvent& event) { m_guaResolvePassDescription->fog_start(event.getValue()); }
...
void av::gua::ResolvePassDescription::getVignetteColorCB(const SFVec4::GetValueEvent& event) { *(event.getValuePtr()) = m_guaResolvePassDescription->vignette_color(); }

void av::gua::ResolvePassDescription::setVignetteColorCB(const SFVec4::SetValueEvent& event) { m_guaResolvePassDescription->vignette_color(::gua::math::vec4f(event.getValue())); }
...
void av::gua::ResolvePassDescription::setToneMappingModeCB(const SFUInt::SetValueEvent& event)
{
...
std::shared_ptr<::gua::ResolvePassDescription> const& av::gua::ResolvePassDescription::getGuaResolvePassDescription() const { return m_guaResolvePassDescription; }

void av::gua::ResolvePassDescription::getEnvironmentLightingColorCB(const SFColor::GetValueEvent& event) { *(event.getValuePtr()) = m_guaResolvePassDescription->environment_lighting(); }

void av::gua::ResolvePassDescription::setEnvironmentLightingColorCB(const SFColor::SetValueEvent& event) { m_guaResolvePassDescription->environment_lighting(event.getValue()); }

void av::gua::ResolvePassDescription::getEnvironmentLightingModeCB(const SFUInt::GetValueEvent& event)
{
    *(event.getValuePtr()) = static_cast<unsigned>(m_guaResolvePassDescription->environment_lighting_mode());
}

void av::gua::ResolvePassDescription::setEnvironmentLightingModeCB(const SFUInt::SetValueEvent& event)
{
...
void av::gua::ResolvePassDescription::getEnvironmentLightingTextureCB(const SFString::GetValueEvent& event) { *(event.getValuePtr()) = m_guaResolvePassDescription->environment_lighting_texture(); }

void av::gua::ResolvePassDescription::setEnvironmentLightingTextureCB(const SFString::SetValueEvent& event) { m_guaResolvePassDescription->environment_lighting_texture(event.getValue()); }

void av::gua::ResolvePassDescription::getAlternativeEnvironmentLightingTextureCB(const SFString::GetValueEvent& event)
{
    *(event.getValuePtr()) = m_guaResolvePassDescription->alternative_environment_lighting_texture();
}

void av::gua::ResolvePassDescription::setAlternativeEnvironmentLightingTextureCB(const SFString::SetValueEvent& event)
{
    m_guaResolvePassDescription->alternative_environment_lighting_texture(event.getValue());
}

void av::gua::ResolvePassDescription::getEnvironmentLightingTextureBlendFactorCB(const SFFloat::GetValueEvent& event)
{
    *(event.getValuePtr()) = m_guaResolvePassDescription->environment_lighting_texture_blend_factor();
}

void av::gua::ResolvePassDescription::setEnvironmentLightingTextureBlendFactorCB(const SFFloat::SetValueEvent& event)
{
...
void av::gua::ResolvePassDescription::setEnableSSAOCB(const SFBool::SetValueEvent& event) { m_guaResolvePassDescription->ssao_enable(event.getValue()); }
...
void av::gua::ResolvePassDescription::setDebugTilesCB(const SFBool::SetValueEvent& event) { m_guaResolvePassDescription->debug_tiles(event.getValue()); }
...
void av::gua::ResolvePassDescription::setEnableScreenSpaceShadowCB(const SFBool::SetValueEvent& event) { m_guaResolvePassDescription->screen_space_shadows(event.getValue()); }

void av::gua::ResolvePassDescription::getScreenSpaceShadowRadiusCB(const SFFloat::GetValueEvent& event) { *(event.getValuePtr()) = m_guaResolvePassDescription->screen_space_shadow_radius(); }

void av::gua::ResolvePassDescription::setScreenSpaceShadowRadiusCB(const SFFloat::SetValueEvent& event) { m_guaResolvePassDescription->screen_space_shadow_radius(event.getValue()); }

void av::gua::ResolvePassDescription::getScreenSpaceShadowMaxRadiusPXCB(const SFFloat::GetValueEvent& event)
{
