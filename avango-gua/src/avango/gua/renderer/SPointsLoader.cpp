...
av::gua::SPointsLoader::SPointsLoader(::gua::SPointsLoader* guaSPointsLoader) : m_guaSPointsLoader(guaSPointsLoader) {}

// av::gua::SPointsLoader::~SPointsLoader()
//{}

av::Link<av::gua::Node> av::gua::SPointsLoader::load(std::string const& nodename, std::string const& fileName) const
{
...
void av::gua::SPointsLoader::initClass()
{
...
::gua::SPointsLoader* av::gua::SPointsLoader::getGuaSPointsLoader() const { return m_guaSPointsLoader; }

av::gua::Node* av::gua::SPointsLoader::createChildren(std::shared_ptr<::gua::node::Node> root) const
{
