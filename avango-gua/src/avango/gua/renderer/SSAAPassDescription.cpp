...
av::gua::SSAAPassDescription::SSAAPassDescription(std::shared_ptr<::gua::SSAAPassDescription> const& guaSSAAPassDescription)
    : PipelinePassDescription(guaSSAAPassDescription), m_guaSSAAPassDescription(guaSSAAPassDescription)
{
    AV_FC_ADD_ADAPTOR_FIELD(Mode, std::bind(&SSAAPassDescription::getModeCB, this, std::placeholders::_1), std::bind(&SSAAPassDescription::setModeCB, this, std::placeholders::_1));
    AV_FC_ADD_ADAPTOR_FIELD(
        FxaaQualitySubpix, std::bind(&SSAAPassDescription::getFxaaQualitySubpixCB, this, std::placeholders::_1), std::bind(&SSAAPassDescription::setFxaaQualitySubpixCB, this, std::placeholders::_1));
    AV_FC_ADD_ADAPTOR_FIELD(
        FxaaEdgeThreshold, std::bind(&SSAAPassDescription::getFxaaEdgeThresholdCB, this, std::placeholders::_1), std::bind(&SSAAPassDescription::setFxaaEdgeThresholdCB, this, std::placeholders::_1));
    AV_FC_ADD_ADAPTOR_FIELD(
        FxaaThresholdMin, std::bind(&SSAAPassDescription::getFxaaThresholdMinCB, this, std::placeholders::_1), std::bind(&SSAAPassDescription::setFxaaThresholdMinCB, this, std::placeholders::_1));
...
void av::gua::SSAAPassDescription::initClass()
{
...
std::shared_ptr<::gua::SSAAPassDescription> const& av::gua::SSAAPassDescription::getGuaSSAAPassDescription() const { return m_guaSSAAPassDescription; }
...
void av::gua::SSAAPassDescription::getPinholeErrorCorrectionCB(const SFBool::GetValueEvent& event) { *(event.getValuePtr()) = m_guaSSAAPassDescription->enable_pinhole_correction(); }

void av::gua::SSAAPassDescription::setPinholeErrorCorrectionCB(const SFBool::SetValueEvent& event) { m_guaSSAAPassDescription->enable_pinhole_correction(event.getValue()); }