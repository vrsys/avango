...
av::gua::TriMeshLoader::TriMeshLoader(::gua::TriMeshLoader* guaTriMeshLoader) : m_guaTriMeshLoader(guaTriMeshLoader) {}

// av::gua::TriMeshLoader::~TriMeshLoader()
//{}

av::Link<av::gua::Node> av::gua::TriMeshLoader::createGeometryFromFile(std::string const& nodeName, std::string const& fileName, av::gua::Material const& fallbackMaterial, Flags flags) const
{
    auto gua_node(m_guaTriMeshLoader->create_geometry_from_file(nodeName, fileName, fallbackMaterial.getGuaMaterial(), flags));
    auto root(createChildren(gua_node));

    return av::Link<av::gua::Node>(root);
}

av::Link<av::gua::Node> av::gua::TriMeshLoader::createGeometryFromFile(std::string const& nodeName, std::string const& fileName, Flags flags) const
{
...
void av::gua::TriMeshLoader::initClass()
{
...
::gua::TriMeshLoader* av::gua::TriMeshLoader::getGuaTriMeshLoader() const { return m_guaTriMeshLoader; }

av::gua::Node* av::gua::TriMeshLoader::createChildren(std::shared_ptr<::gua::node::Node> root) const
{
