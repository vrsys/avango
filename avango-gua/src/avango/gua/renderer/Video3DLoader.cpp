...
av::gua::Video3DLoader::Video3DLoader(::gua::Video3DLoader* guaVideo3DLoader) : m_guaVideo3DLoader(guaVideo3DLoader) {}

// av::gua::Video3DLoader::~Video3DLoader()
//{}

av::Link<av::gua::Node> av::gua::Video3DLoader::load(std::string const& nodename, std::string const& fileName) const
{
...
void av::gua::Video3DLoader::initClass()
{
...
::gua::Video3DLoader* av::gua::Video3DLoader::getGuaVideo3DLoader() const { return m_guaVideo3DLoader; }

av::gua::Node* av::gua::Video3DLoader::createChildren(std::shared_ptr<::gua::node::Node> root) const
{
