...
av::gua::SPointsNode::SPointsNode(std::shared_ptr<::gua::node::SPointsNode> guanode) : GeometryNode(guanode), m_guaSPointsNode(guanode)
{
    AV_FC_ADD_ADAPTOR_FIELD(Geometry, std::bind(&SPointsNode::getGeometryCB, this, std::placeholders::_1), std::bind(&SPointsNode::setGeometryCB, this, std::placeholders::_1));

    AV_FC_ADD_ADAPTOR_FIELD(Material, std::bind(&SPointsNode::getMaterialCB, this, std::placeholders::_1), std::bind(&SPointsNode::setMaterialCB, this, std::placeholders::_1));

    AV_FC_ADD_ADAPTOR_FIELD(RenderToGBuffer, std::bind(&SPointsNode::getRenderToGBufferCB, this, std::placeholders::_1), std::bind(&SPointsNode::setRenderToGBufferCB, this, std::placeholders::_1));
...
void av::gua::SPointsNode::initClass()
{
...
void av::gua::SPointsNode::getGeometryCB(const SFString::GetValueEvent& event) { *(event.getValuePtr()) = m_guaSPointsNode->get_spoints_description(); }

void av::gua::SPointsNode::setGeometryCB(const SFString::SetValueEvent& event) { m_guaSPointsNode->set_spoints_description(event.getValue()); }

void av::gua::SPointsNode::getMaterialCB(const SFMaterial::GetValueEvent& event)
{
    if(m_Material.isValid())
    {
...
void av::gua::SPointsNode::setMaterialCB(const SFMaterial::SetValueEvent& event)
{
...
void av::gua::SPointsNode::getRenderToGBufferCB(const SFBool::GetValueEvent& event)
{
    //  *(event.getValuePtr()) = m_guaSPointsNode->get_render_to_gbuffer();
}

void av::gua::SPointsNode::setRenderToGBufferCB(const SFBool::SetValueEvent& event)
{
    //  m_guaSPointsNode->set_render_to_gbuffer(event.getValue());
}

void av::gua::SPointsNode::getRenderToStencilBufferCB(const SFBool::GetValueEvent& event)
{
    //  *(event.getValuePtr()) = m_guaSPointsNode->get_render_to_stencil_buffer();
}

void av::gua::SPointsNode::setRenderToStencilBufferCB(const SFBool::SetValueEvent& event)
{
