...
av::gua::SpotLightNode::SpotLightNode(std::shared_ptr< ::gua::node::SpotLightNode> guanode)
    : av::gua::Node(guanode),
      m_guaNode(std::dynamic_pointer_cast< ::gua::node::SpotLightNode>(Node::getGuaNode()))
{
...
std::shared_ptr< ::gua::node::SpotLightNode>
