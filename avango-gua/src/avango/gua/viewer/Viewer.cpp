...
av::gua::Viewer::Viewer() : m_renderer(nullptr), m_loop(), m_ticker(m_loop, 1.f / 60.f)
{
    ...
    AV_FC_ADD_ADAPTOR_FIELD(DesiredFPS,
                            [this](av::SFFloat::GetValueEvent const& e) { *(e.getValuePtr()) = 1.f / m_ticker.get_tick_time(); },
                            [this](av::SFFloat::SetValueEvent const& e) { m_ticker.set_tick_time(1.f / e.getValue()); });
