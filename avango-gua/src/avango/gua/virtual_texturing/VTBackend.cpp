...
const void av::gua::VTBackend::start_backend() const {
  ::gua::VTBackend::get_instance().start_backend();
}
const void av::gua::VTBackend::stop_backend() const {
  ::gua::VTBackend::get_instance().stop_backend();
}
const void
av::gua::VTBackend::add_camera(av::gua::CameraNode const &camera) const {
  ::gua::VTBackend::get_instance().add_camera(camera.getGuaNode());
}
