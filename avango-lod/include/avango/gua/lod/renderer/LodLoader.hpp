  ...
  namespace gua
  {
    ...
    namespace lod {
      ...
      public:
        ...
        av::Link<av::gua::Node> loadLodPointcloud(std::string const& nodeName,
                                                  std::string const& fileName,
                                                  av::Link<av::gua::Material> const& fallbackMaterial,
                                                  Flags flags = DEFAULTS) const;

        av::Link<av::gua::Node> loadLodPointcloud(std::string const& fileName,
                                                  Flags flags = DEFAULTS) const;

        av::Link<av::gua::Node> loadLodTrimesh(std::string const& nodeName,
                                               std::string const& fileName,
                                               av::Link<av::gua::Material> const& fallbackMaterial,
                                               Flags flags = DEFAULTS) const;

        av::Link<av::gua::Node> loadLodTrimesh(std::string const& fileName,
                                               Flags flags = DEFAULTS) const;
