...
class AV_GUA_LOD_DLL MLodPassDescription : public av::gua::PipelinePassDescription
{
  ...
  public:
     ...
     */
    MLodPassDescription(std::shared_ptr<::gua::MLodPassDescription> const& MLodPassDescription = std::shared_ptr<::gua::MLodPassDescription>(new ::gua::MLodPassDescription()));
