...
av::Link<av::gua::Node> loadLodPointcloud1(
                                          av::gua::lod::LodLoader const& loader,
                                          std::string const& nodeName,
                                          std::string const& fileName,
                                          av::Link<av::gua::Material> const& fallbackMaterial,
                                          int flags) {

   return loader.loadLodPointcloud(nodeName, fileName, fallbackMaterial,
                                static_cast<av::gua::lod::LodLoader::Flags>(flags));
}

av::Link<av::gua::Node> loadLodPointcloud2(
                                          av::gua::lod::LodLoader const& loader,
                                          std::string const& fileName,
                                          int flags) {

   return loader.loadLodPointcloud(fileName,
                                static_cast<av::gua::lod::LodLoader::Flags>(flags));
}

av::Link<av::gua::Node> loadLodTrimesh1(
                                          av::gua::lod::LodLoader const& loader,
                                          std::string const& nodeName,
                                          std::string const& fileName,
                                          av::Link<av::gua::Material> const& fallbackMaterial,
   ...
   return loader.loadLodTrimesh(nodeName, fileName, fallbackMaterial,
                                static_cast<av::gua::lod::LodLoader::Flags>(flags));
}

av::Link<av::gua::Node> loadLodTrimesh2(
                                          av::gua::lod::LodLoader const& loader,
                                          std::string const& fileName,
                                          int flags) {

   return loader.loadLodTrimesh(fileName,
                                static_cast<av::gua::lod::LodLoader::Flags>(flags));
}
...
void init_LodLoader()
{
  class_<av::gua::lod::LodLoader,
         av::Link<av::gua::lod::LodLoader>,
         bases<av::FieldContainer>, boost::noncopyable> ("LodLoader", "docstring", no_init)
