...
void init_MLodPassDescription()
 {
  ...
  class_<av::gua::lod::MLodPassDescription,
         av::Link<av::gua::lod::MLodPassDescription>,
         bases<av::gua::PipelinePassDescription>, boost::noncopyable >("MLodPassDescription", "docstring", no_init)
         ;
 }
