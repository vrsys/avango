...
void init_NURBSPassDescription()
{
    ...
    class_<av::gua::nurbs::NURBSPassDescription, av::Link<av::gua::nurbs::NURBSPassDescription>, bases<av::gua::PipelinePassDescription>, boost::noncopyable>(
        "NURBSPassDescription", "docstring", no_init);
}
