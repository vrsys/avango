...
av::gua::nurbs::NURBSNode::NURBSNode(std::shared_ptr<::gua::node::NURBSNode> guanode) : GeometryNode(guanode), m_guaNURBSNode(guanode)
{
    AV_FC_ADD_ADAPTOR_FIELD(Geometry, std::bind(&NURBSNode::getGeometryCB, this, std::placeholders::_1), std::bind(&NURBSNode::setGeometryCB, this, std::placeholders::_1));

    AV_FC_ADD_ADAPTOR_FIELD(Material, std::bind(&NURBSNode::getMaterialCB, this, std::placeholders::_1), std::bind(&NURBSNode::setMaterialCB, this, std::placeholders::_1));

    AV_FC_ADD_ADAPTOR_FIELD(
        PixelErrorTolerance, std::bind(&NURBSNode::getPixelErrorToleranceCB, this, std::placeholders::_1), std::bind(&NURBSNode::setPixelErrorToleranceCB, this, std::placeholders::_1));

    AV_FC_ADD_ADAPTOR_FIELD(WireframeMode, std::bind(&NURBSNode::getWireframeModeCB, this, std::placeholders::_1), std::bind(&NURBSNode::setWireframeModeCB, this, std::placeholders::_1));
...
void av::gua::nurbs::NURBSNode::on_distribute(av::gua::NetTransform& netNode)
{
...
void av::gua::nurbs::NURBSNode::on_undistribute(av::gua::NetTransform& netNode)
{
...
void av::gua::nurbs::NURBSNode::initClass()
{
...
void av::gua::nurbs::NURBSNode::getMaterialCB(const SFMaterial::GetValueEvent& event)
{
    if(m_Material.isValid())
    {
...
void av::gua::nurbs::NURBSNode::setMaterialCB(const SFMaterial::SetValueEvent& event)
{
...
std::shared_ptr<::gua::node::NURBSNode> av::gua::nurbs::NURBSNode::getGuaNURBSNode() const { return m_guaNURBSNode; }
...
void av::gua::nurbs::NURBSNode::getWireframeModeCB(const SFBool::GetValueEvent& event) { *(event.getValuePtr()) = m_guaNURBSNode->wireframe(); }

void av::gua::nurbs::NURBSNode::setWireframeModeCB(const SFBool::SetValueEvent& event) { m_guaNURBSNode->wireframe(event.getValue()); }