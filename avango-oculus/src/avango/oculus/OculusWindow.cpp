...
av::oculus::OculusWindow::OculusWindow(std::shared_ptr<::gua::OculusWindow> const& guaOculusWindow) : av::gua::GlfwWindow(guaOculusWindow), m_guaOculusWindow(guaOculusWindow)
{
...
void av::oculus::OculusWindow::initClass()
{
...
std::shared_ptr<::gua::OculusWindow> const& av::oculus::OculusWindow::getGuaOculusWindow() const { return m_guaOculusWindow; }

void av::oculus::OculusWindow::evaluate() { SensorOrientation.setValue(m_guaOculusWindow->get_hmd_sensor_orientation()); }
