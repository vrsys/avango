...
av::osg::Geometry::Geometry(::osg::Geometry* osggeometry) :
  Drawable(osggeometry),
  mOsgGeometry(osggeometry)
{
  AV_FC_ADD_ADAPTOR_FIELD(VertexArray,   boost::bind(&Geometry::getVertexArrayCB,   this, _1),
                                         boost::bind(&Geometry::setVertexArrayCB,   this, _1));
  AV_FC_ADD_ADAPTOR_FIELD(NormalArray,   boost::bind(&Geometry::getNormalArrayCB,   this, _1),
                                         boost::bind(&Geometry::setNormalArrayCB,   this, _1));
  AV_FC_ADD_ADAPTOR_FIELD(ColorArray,    boost::bind(&Geometry::getColorArrayCB,    this, _1),
                                         boost::bind(&Geometry::setColorArrayCB,    this, _1));
  AV_FC_ADD_ADAPTOR_FIELD(TexCoordArray, boost::bind(&Geometry::getTexCoordArrayCB, this, _1),
                                         boost::bind(&Geometry::setTexCoordArrayCB, this, _1));
  AV_FC_ADD_ADAPTOR_FIELD(NormalBinding, boost::bind(&Geometry::getNormalBindingCB, this, _1),
                                         boost::bind(&Geometry::setNormalBindingCB, this, _1));
  AV_FC_ADD_ADAPTOR_FIELD(ColorBinding,  boost::bind(&Geometry::getColorBindingCB,  this, _1),
                                         boost::bind(&Geometry::setColorBindingCB,  this, _1));
...
::osg::Geometry*
av::osg::Geometry::getOsgGeometry() const
{
  return mOsgGeometry;
}

/* virtual */ void
av::osg::Geometry::evaluateLocalSideEffect()
{
  ...
  if (mode < DISABLED && mOsgGeometry->getVertexArray() != 0)
  {
    ...
    MFUInt::ContainerType &prim_inds =
      const_cast<MFUInt::ContainerType&>(PrimitiveIndices.getValue());
#else
    ...
    if (prim_inds.empty())
    {
      if (prim_lengths.empty())
      {
        const GLsizei num_vertices =
          static_cast<GLsizei>(mOsgGeometry->getVertexArray()->getNumElements());
    ...
    else
    {
      ...
      {
        int cur_index = 0;
        for (MFInt::ContainerType::const_iterator prim_length = prim_lengths.begin();
             prim_length != prim_lengths.end(); ++prim_length)
        {
          if (cur_index + *prim_length <= static_cast<int>(prim_inds.size()))
          {
            ...
            prim_sets.push_back(new ::osg::DrawElementsUInt(mode, num_indices,
                                                            &prim_inds[cur_index]));
...
/* virtual */ void
av::osg::Geometry::getVertexArrayCB(const MFVec3::GetValueEvent& event)
{
  ::osg::ref_ptr< ::osg::Vec3Array> array =
    dynamic_cast< ::osg::Vec3Array*>(mOsgGeometry->getVertexArray());
  if (array.valid())
  {
...
/* virtual */ void
av::osg::Geometry::setVertexArrayCB(const MFVec3::SetValueEvent& event)
{
...
/* virtual */ void
av::osg::Geometry::getNormalArrayCB(const MFVec3::GetValueEvent& event)
{
  ::osg::ref_ptr< ::osg::Vec3Array> array =
    dynamic_cast< ::osg::Vec3Array*>(mOsgGeometry->getNormalArray());
  if (array.valid())
  {
    const ::osg::Vec3* data_pointer = static_cast<const ::osg::Vec3* >(array->getDataPointer());
    MFVec3::ContainerType tmpContainer(data_pointer, data_pointer+array->getNumElements());
...
/* virtual */ void
av::osg::Geometry::setNormalArrayCB(const MFVec3::SetValueEvent& event)
{
  if (!event.getValue().empty())
  {
    ::osg::ref_ptr< ::osg::Vec3Array> array =
...
/* virtual */ void
av::osg::Geometry::getColorArrayCB(const MFVec4::GetValueEvent& event)
{
  ::osg::ref_ptr< ::osg::Vec4Array> array =
    dynamic_cast< ::osg::Vec4Array*>(mOsgGeometry->getColorArray());
  if (array.valid())
  {
...
/* virtual */ void
av::osg::Geometry::setColorArrayCB(const MFVec4::SetValueEvent& event)
{
  if (!event.getValue().empty())
  {
    ::osg::ref_ptr< ::osg::Vec4Array> array =
...
/* virtual */ void
av::osg::Geometry::getTexCoordArrayCB(const MFVec2::GetValueEvent& event)
{
  ::osg::ref_ptr< ::osg::Vec2Array> array =
    dynamic_cast< ::osg::Vec2Array*>(mOsgGeometry->getTexCoordArray(0u));
  if (array.valid())
  {
...
/* virtual */ void
av::osg::Geometry::setTexCoordArrayCB(const MFVec2::SetValueEvent& event)
{
  if (!event.getValue().empty())
  {
    ::osg::ref_ptr< ::osg::Vec2Array> array =
...
/* virtual */ void
av::osg::Geometry::getNormalBindingCB(const SFInt::GetValueEvent& event)
{
  *event.getValuePtr() = static_cast<int>(mOsgGeometry->getNormalBinding());
}

/* virtual */ void
av::osg::Geometry::setNormalBindingCB(const SFInt::SetValueEvent& event)
{
  mOsgGeometry->setNormalBinding(static_cast< ::osg::Geometry::AttributeBinding>(event.getValue()));
}

/* virtual */ void
av::osg::Geometry::getColorBindingCB(const SFInt::GetValueEvent& event)
{
  *event.getValuePtr() = static_cast<int>(mOsgGeometry->getColorBinding());
}

/* virtual */ void
av::osg::Geometry::setColorBindingCB(const SFInt::SetValueEvent& event)
{
  mOsgGeometry->setColorBinding(static_cast< ::osg::Geometry::AttributeBinding>(event.getValue()));
}
