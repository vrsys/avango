...
{
template <class Type>
struct select_link_type
{
    using type = Type;
    static Type get_value(boost::python::object obj) { return boost::python::extract<type>(obj); }
};

template <class Type>
struct select_link_type<av::Link<Type>>
{
    using type = Type;
...
template <class Type>
typename Type::ValueType Field_get_value(Type& self)
{
    return self.getValue();
}

template <class Type>
void Field_set_value(Type& self, boost::python::object value)
{
...
template <class Type>
void register_field(std::string name)
{
...
{
  public:
    MultiFieldWrapper(Type& Field) : mField(Field) {}
  ...
  public:
    int getSize(void) { return mField.getSize(); }
    ...
    void remove(boost::python::object value) { mField.remove1Value(SelectType::get_value(value)); }

    void append(boost::python::object value) { mField.add1Value(SelectType::get_value(value)); }
...
template <class Type>
MultiFieldWrapper<Type> MultiField_get_value(Type& self)
{
    return MultiFieldWrapper<Type>(self);
}

template <class Type>
void MultiField_set_value(Type& self, boost::python::object value)
{
    using value_type = typename Type::ValueType;
...
template <class Type>
void register_multifield(std::string name)
{
