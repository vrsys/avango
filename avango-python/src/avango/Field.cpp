...
namespace
{
std::string get_type_name(av::Field* self) { return self->getTypeId().getName(); }

bool Field_equals(const av::Field* a, const av::Field* b) { return (a == b); }

long Field_hash(const av::Field* self) { return reinterpret_cast<long>(self); }

void connect_from_dependant(av::Field* self, av::Field* other) { self->connectFrom(other, true); }

void connect_weak_from(av::Field* self, av::Field* other) { self->connectFrom(other, false); }
...
list FieldGetConnectedFields(av::Field* self)
{
