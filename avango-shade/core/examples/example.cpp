...
void example::set_display_func(boost::function<void (void)> func)
{
  display_func = func;
}

void example::set_distance(double dist)
{
  distance = dist;
}
...
void example::run_main_loop(void)
{
  glutMainLoop();
}

void example::set_still_camera(void)
{
  rot_speed = 0.;
}
