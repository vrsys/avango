...
namespace shade
{
  namespace shaders
  {
    SHADE_TEMPLATE_T_INIT(PerStageGettable, "",
        SHADE_ENV_DEFS(vertex_stage, (get_vertex))
        SHADE_ENV_DEFS(fragment_stage, (get_fragment))
        SHADE_ENV_DEFS(geometry_stage, (get_geometry)),
        SHADE_NONE)
  }
}
