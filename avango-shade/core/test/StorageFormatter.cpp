...
shade::StorageFormatter::StorageFormatter(ShaderEnvironment env) :
  Formatter(env)
{
}
...
boost::shared_ptr<shade::formatter::Generator> shade::StorageFormatter::begin_insert_init_attribute(formatter::Constants::Type type, const std::string& obj, const std::string& name, formatter::Constants::Qualifier qualifier)
{
  m_cur_key = obj+name;
  m_cur_type = type;
...
void shade::StorageFormatter::insert_self_argument(formatter::Constants::Type type, const std::string& name)
{
  m_self_arguments[m_cur_self_name].push_back(std::make_pair(type, name));
}
...
void shade::StorageFormatter::begin_dispatcher_add_arg(formatter::Constants::Type arg)
{
  m_args[m_cur_fun_name].push_back(arg);
}
...
void shade::StorageFormatter::insert_inline_dispatcher(shade::ObjectMap::Index i, const std::string& obj, const std::string& class_, const std::string& name)
{
  insert_dispatcher(i, obj, name);
}

void shade::StorageFormatter::insert_dispatcher_add_arg(const std::string& name)
{
  m_dispatches_args[m_cur_fun_name][m_cur_dispatch_self].push_back(name);
}
...
void shade::StorageFormatter::insert_property_dispatcher(shade::ObjectMap::Index self, const std::string& obj)
{
  m_properties[m_cur_property][self] = obj;
}

void shade::StorageFormatter::insert_deferred_property_dispatcher(shade::ObjectMap::Index i, shade::ObjectMap::Index obj, const std::string& iface_getter, const std::string& getter, const std::string& iface_setter, const std::string& setter)
{
...
bool shade::StorageFormatter::has_attribute(const std::string& obj, const std::string& name) const
{
  return (m_attributes.find(obj+name) != m_attributes.end());
}

shade::StorageFormatter::Attribute shade::StorageFormatter::get_attribute(const std::string& obj, const std::string& name) const
{
  return m_attributes.find(obj+name)->second;
}


const std::vector<std::pair<shade::formatter::Constants::Type, std::string> >& shade::StorageFormatter::get_self_argument(const std::string& name) const
{
  return m_self_arguments.find(name)->second;
}


bool shade::StorageFormatter::has_function(const std::string& class_, const std::string& name) const
{
  return (m_args.find(get_method_name(class_, name)) != m_args.end());
}
...
bool shade::StorageFormatter::has_function_dispatch(const std::string& class_, const std::string& name, ObjectMap::Index i) const
{
  ...
  const std::map< ObjectMap::Index, std::pair<std::string, std::string> >& function =
    m_dispatches.find(get_method_name(class_, name))->second;
...
std::string shade::StorageFormatter::get_function_return(const std::string& class_, const std::string& name) const
{
  return m_dispatches_default_return.find(get_method_name(class_, name))->second;
}
...
void shade::StorageFormatter::add_arg_inline_method(formatter::Constants::Type arg)
{
  m_inline_methods_args[m_cur_inline_method_name].push_back(arg);
}
...
void shade::StorageFormatter::invoke(const std::string& class_, const std::string& main)
{
  m_invoke = get_method_name(class_, main);
}

const std::string& shade::StorageFormatter::get_invoke(void)
{
  return m_invoke;
}
...
void shade::StorageFormatter::begin_initialize(const std::string& name, bool invoke)
{
  m_cur_initialize_function = name;
}
...
void shade::StorageFormatter::insert_sources(const std::string& sources)
{
  m_sources = sources;
}

const std::vector< std::pair<std::string, shade::ObjectMap::Index> >& shade::StorageFormatter::get_initializers(void)
{
  return m_initializers;
}

const std::string& shade::StorageFormatter::get_imported_sources(void)
{
  return m_sources;
}

std::string shade::StorageFormatter::get_method_name(const std::string& class_, const std::string& main) const
{
  return class_+"_"+main;
}


bool shade::StorageFormatter::has_inline_method(const std::string& class_, const std::string& name) const
{
  return (m_inline_methods.find(get_method_name(class_, name)) != m_inline_methods.end());
}
