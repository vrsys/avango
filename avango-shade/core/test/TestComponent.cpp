...
namespace
{
  ...
  {
  public:
    uniform_mockup(shade::formatter::Constants::Type type) :
      shade::Type(type)
    {};
    ...
    /*virtual*/ bool is_writable(const shade::ShaderEnvironment& se) const
    {
      return false;
    }

    /*virtual*/ void upload(boost::shared_ptr<shade::GLSLWrapper> wrapper, LinkIndex index) const
    {
  ...
  template<class Qualifier = shade::local> class vec3_mockup : public shade::TypeBase<vec3_mockup<Qualifier>, Qualifier>
  {
  public:
    vec3_mockup(void) :
      shade::TypeBase<vec3_mockup<Qualifier>, Qualifier>(shade::formatter::Constants::vec3),
      m_dirty(true),
      m_upload(false),
      m_upload_status(false)
    {
      union
      {
    ...
    /*virtual*/ void generate_constructor(shade::formatter::Generator& generator) const
    {
      generator.handle_verbatim("mockup");
    }
  ...
  public:
    ...
    { return invoke< shade::void_<> >("LightSource_initialize_impl"); }

    virtual shade::vec3<> illuminate(shade::vec3<>, shade::vec3<>) { return shade::vec3<>(); };
    virtual shade::vec3<> get_intensity(shade::vec2<>)
    { return invoke_inline< shade::vec3<> >(std::string("return value;\n")); };

    virtual shade::vec3<> illuminate_vertex(shade::vec3<>, shade::vec3<>)
    { return shade::vec3<>(); }
  ...
  shade::MethodAccessor LightSource::methods[] =
  {
    LightSource::def(&LightSource::get_intensity, "get_intensity"),
  ...
  shade::AttributeAccessor LightSource::attributes[] =
  {
    LightSource::def(&LightSource::intensity, "intensity"),
    LightSource::def(&LightSource::light_sum, "light_sum"),
  ...
  {
  public:
    virtual shade::vec3<> illuminate(shade::vec3<>, shade::vec3<>)
    { return invoke< shade::vec3<> >("PointLightSource_illuminate_impl"); };
  ...
  {
    PointLightSource::def(&PointLightSource::position, "position"),
    PointLightSource::def(&PointLightSource::quality, "quality"),
    shade::AttributeAccessor()
  };
  ...
  public:
    ...
    { return invoke< shade::void_<> >("Material_fragment_impl"); };

    virtual shade::void_<> shade(void)
    { return invoke< shade::void_<> >("Material_shade_impl"); };

    virtual shade::void_<> transform(void)
    { return invoke< shade::void_<> >("Material_transform_impl"); };

    virtual shade::void_<> noop(void)
    { return shade::void_<>(); }
  ...
  shade::MethodAccessor Material::methods[] =
  {
    Material::def(&Material::shade, "shade", shade::fragment_shader),
  ...
  {
    Material::def(&Material::color, "color"),
    Material::def(&Material::light, "light"),
    Material::def(&Material::color_sum, "color_sum"),
    shade::AttributeAccessor()
  };
}
