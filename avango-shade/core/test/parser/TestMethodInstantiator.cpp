...
namespace
{
  ...
  {
  public:
    ReferenceParameter(int ref) :
      m_ref(ref)
    {
    }

    /*virtual*/ void handle(Generator& generator)
    {
  ...
  boost::shared_ptr<Parameter> make_reference_parameter(int ref)
  {
    return boost::shared_ptr<Parameter>(new ReferenceParameter(ref));
  }

  class IdentifierParameter : public Parameter
  {
  public:
    IdentifierParameter(const std::string& id) :
      m_id(id)
    {
    }
  ...
  boost::shared_ptr<Parameter> make_identifier_parameter(const std::string& id)
  {
    return boost::shared_ptr<Parameter>(new IdentifierParameter(id));
  }
