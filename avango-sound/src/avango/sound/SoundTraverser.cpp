...
av::sound::SoundTraverser::SoundTraverser() : mCheckTraversal(false), mHaveCallbackHandle(false)
{
...
av::sound::SoundTraverser::~SoundTraverser()
{
    ...
    for(SoundRenderers::const_iterator each_renderer = renderers.begin(); each_renderer != renderers.end(); ++each_renderer)
    {
...
/*static*/ void av::sound::SoundTraverser::initClass()
{
...
void av::sound::SoundTraverser::traverse(av::Link<av::gua::Node> rootNode, ::gua::math::mat4 absolutTransform) const
{
    ...
    if(rootNode->getTypeId().isOfType(::av::gua::Node::getClassTypeId()))
    {
        ...
        for(ChildNodes::const_iterator each_child = children.begin(); each_child != children.end(); ++each_child)
        {
...
void av::sound::SoundTraverser::fieldHasChanged(const av::Field& field)
{
    if(&field == &Traverse)
    {
...
void av::sound::SoundTraverser::render()
{
...
void av::sound::SoundTraverser::evaluate()
{
    if(mCheckTraversal)
    {
        Application& app = ApplicationInstance::get();
