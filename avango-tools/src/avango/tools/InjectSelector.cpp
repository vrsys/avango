...
void av::tools::InjectSelector::initClass()
{
...
/* virtual */ void av::tools::InjectSelector::evaluate()
{
    ...
    for(MFTargetHolder::ContainerType::iterator holder = selected_targets.begin(); holder != selected_targets.end(); ++holder)
    {
