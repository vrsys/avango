...
av::tools::NameSelector::NameSelector() : mNamesDirty(true)
{
...
void av::tools::NameSelector::initClass()
{
...
/* virtual */ void av::tools::NameSelector::fieldHasChanged(const av::Field& field)
{
...
/* virtual */ void av::tools::NameSelector::evaluate()
{
...
bool av::tools::NameSelector::isSelectable(av::FieldContainer& object)
{
