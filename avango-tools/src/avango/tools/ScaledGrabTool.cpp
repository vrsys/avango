...
av::tools::ScaledGrabTool::ScaledGrabTool() : mScale(1.0)
{
...
void av::tools::ScaledGrabTool::initClass()
{
...
/* virtual */ void av::tools::ScaledGrabTool::evaluateAddedTarget(TargetHolder& holder)
{
...
/* virtual */ void av::tools::ScaledGrabTool::evaluateKeptTarget(TargetHolder& holder)
{
    // const SFContainer::ValueType &target_obj = holder.Target.getValue();
