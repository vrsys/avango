...
void av::tools::TargetHolder::initClass()
{
...
av::tools::TargetHolder::FindList av::tools::TargetHolder::find(Type type)
{
...
/* virtual */ bool av::tools::TargetHolder::keep() { return (Keep.getValue() || !ParentTargets.isEmpty()); }

void av::tools::TargetHolder::find(Type type, FindList& foundHolders)
{
    ...
    for(MFTargetHolder::ContainerType::const_iterator parent_holder = parent_targets.begin(); parent_holder != parent_targets.end(); ++parent_holder)
    {
