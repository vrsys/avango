...
av::tools::TypeSelector::TypeSelector() : mTypesDirty(true)
{
...
void av::tools::TypeSelector::initClass()
{
...
/* virtual */ void av::tools::TypeSelector::fieldHasChanged(const av::Field& field)
{
...
/* virtual */ void av::tools::TypeSelector::evaluate()
{
    ...
    if(mTypesDirty)
    {
        ...
        for(MFContainer::ContainerType::const_iterator sel_object = sel_objects.begin(); sel_object != sel_objects.end(); ++sel_object)
        {
            mTypes.insert((*sel_object)->getTypeId());
        }

        const MFTargetHolder::ContainerType& sel_targets = SelectableTargetTypes.getValue();
        for(MFTargetHolder::ContainerType::const_iterator sel_holder = sel_targets.begin(); sel_holder != sel_targets.end(); ++sel_holder)
        {
...
bool av::tools::TypeSelector::isSelectable(const av::FieldContainer& object)
{
