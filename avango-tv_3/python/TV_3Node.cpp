...
void init_TV_3Node()
{
  ...
  enum_<av::gua::tv_3::TV_3Node::NodeSpatialFilterMode>("SpatialFilterMode")
    .value("S_NEAREST", av::gua::tv_3::TV_3Node::S_NEAREST)
    .value("S_LINEAR",  av::gua::tv_3::TV_3Node::S_LINEAR)
    ;

  enum_<av::gua::tv_3::TV_3Node::NodeTemporalFilterMode>("TemporalFilterMode")
    .value("T_NEAREST", av::gua::tv_3::TV_3Node::T_NEAREST)
    .value("T_LINEAR",  av::gua::tv_3::TV_3Node::T_LINEAR)
    ;
