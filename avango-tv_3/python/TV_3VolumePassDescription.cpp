...
void init_TV_3VolumePassDescription()
 {
  ...
  class_<av::gua::tv_3::TV_3VolumePassDescription,
         av::Link<av::gua::tv_3::TV_3VolumePassDescription>,
         bases<av::gua::PipelinePassDescription>, boost::noncopyable >("TV_3VolumePassDescription", "docstring", no_init)
         ;
 }
