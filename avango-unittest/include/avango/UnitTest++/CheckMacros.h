...
#define CHECK(value)                                                                                                                                                                                   \
    ...
    {                                                                                                                                                                                                  \
        ...
        {                                                                                                                                                                                              \
            UnitTest::CurrentTest::Results()->OnTestFailure(UnitTest::TestDetails(*UnitTest::CurrentTest::Details(), __LINE__), "Unhandled exception in CHECK(" #value ")");                           \
        }                                                                                                                                                                                              \
    } while(0)
...
#define CHECK_EQUAL(expected, actual)                                                                                                                                                                  \
    ...
    {                                                                                                                                                                                                  \
        ...
        {                                                                                                                                                                                              \
            UnitTest::CurrentTest::Results()->OnTestFailure(UnitTest::TestDetails(*UnitTest::CurrentTest::Details(), __LINE__), "Unhandled exception in CHECK_EQUAL(" #expected ", " #actual ")");     \
        }                                                                                                                                                                                              \
    } while(0)
...
#define CHECK_CLOSE(expected, actual, tolerance)                                                                                                                                                       \
    ...
    {                                                                                                                                                                                                  \
        ...
        {                                                                                                                                                                                              \
            UnitTest::CurrentTest::Results()->OnTestFailure(UnitTest::TestDetails(*UnitTest::CurrentTest::Details(), __LINE__), "Unhandled exception in CHECK_CLOSE(" #expected ", " #actual ")");     \
        }                                                                                                                                                                                              \
    } while(0)
...
#define CHECK_ASSERT(expression) CHECK_THROW(expression, UnitTest::AssertException);
