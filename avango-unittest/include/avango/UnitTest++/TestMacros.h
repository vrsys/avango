...
#define TEST_FIXTURE_EX(Fixture, Name, List)                                                                                                                                                           \
    ...
    {                                                                                                                                                                                                  \
        ...
        {                                                                                                                                                                                              \
            if(ctorOk)                                                                                                                                                                                 \
            {                                                                                                                                                                                          \
                UnitTest::CurrentTest::Results()->OnTestFailure(UnitTest::TestDetails(m_details, __LINE__), "Unhandled exception while destroying fixture " #Fixture);                                 \
            }                                                                                                                                                                                          \
            else                                                                                                                                                                                       \
            {                                                                                                                                                                                          \
                UnitTest::CurrentTest::Results()->OnTestFailure(UnitTest::TestDetails(m_details, __LINE__), "Unhandled exception while constructing fixture " #Fixture);                               \
            }                                                                                                                                                                                          \
        }                                                                                                                                                                                              \
    }                                                                                                                                                                                                  \
