...
class MultiValueField : public Field
{
  public:
    ...
    static void initClass(const std::string& classname, const std::string& parentname)
    {
        ...
        {
            sClassTypeId = Field::registerType(classname, parentname, new CreateA<MultiValueField<Value>>());
        }
    }
     ...
     */
    virtual bool valueHasChanged(unsigned int i) const { return mChangedValues.at(i); }
     ...
     * Field::reset().
     */
    virtual void resetChangedFlags() { mChangedValues = std::vector<bool>(mValue.size(), false); }
     ...
     */
    virtual void setAllValues(const ContainerType& v) { setAllValues(v, 0); }

    /**
     * Same as MultiField::getValue().
     */
    virtual const ContainerType& getAllValues() const { return mValue; }
     ...
     */
    virtual int getSize() { return mValue.size(); }

    /**
     * Returns if field is empty.
     */
    virtual bool isEmpty() { return mValue.empty(); }
     ...
     */
    virtual void set1Value(const Value& v, unsigned int i, bool trigger_field_change = true) { set1Value(v, i, 0, trigger_field_change); }

    /**
     * Returns value at position i.
     */
    virtual const Value get1Value(unsigned int i) const { return mValue.at(i); }
     ...
     */
    void triggerFieldChange(Field* triggered_from) { fieldChanged(false, triggered_from); }
    ...
    template <typename T>
    friend bool operator==(const MultiValueField<T>&, const MultiValueField<T>&);
...
template <>
AV_UTILS_DLL void av::utils::MultiValueField<double>::pullValueImpl(av::Field* fromField);
template <>
AV_UTILS_DLL void av::utils::MultiValueField<float>::pullValueImpl(av::Field* fromField);
template <>
AV_UTILS_DLL void av::utils::MultiValueField<int32_t>::pullValueImpl(av::Field* fromField);
template <>
AV_UTILS_DLL void av::utils::MultiValueField<int64_t>::pullValueImpl(av::Field* fromField);
template <>
AV_UTILS_DLL void av::utils::MultiValueField<uint32_t>::pullValueImpl(av::Field* fromField);
template <>
AV_UTILS_DLL void av::utils::MultiValueField<uint64_t>::pullValueImpl(av::Field* fromField);
template <>
AV_UTILS_DLL void av::utils::MultiValueField<bool>::pullValueImpl(av::Field* fromField);

template <typename Value>
bool operator==(const MultiValueField<Value>& a, const MultiValueField<Value>& b)
{
 ...
 */
#ifdef AV_INSTANTIATE_FIELD_TEMPLATES
template class AV_UTILS_DLL MultiValueField<::gua::math::mat4>;
// template class AV_UTILS_DLL MultiValueField< ::scm::math::mat<double, 4, 4> >;
template class AV_UTILS_DLL MultiValueField<::gua::math::vec2>;
// template class AV_UTILS_DLL MultiValueField< ::scm::math::vec<double, 2> >;
template class AV_UTILS_DLL MultiValueField<::gua::math::vec3>;
// template class AV_UTILS_DLL MultiValueField< ::scm::math::vec<double, 3> >;
template class AV_UTILS_DLL MultiValueField<::gua::math::vec4>;
// template class AV_UTILS_DLL MultiValueField< ::scm::math::vec<double, 4> >;
...
template <typename Value>
inline void MultiValueField<Value>::push(Msg& msg)
{
    AV_ASSERT(mValue.size() == mChangedValues.size());
    typename ContainerType::const_iterator i(mValue.begin());
...
template <typename Value>
inline void MultiValueField<Value>::pop(Msg& msg)
{
    int count;
