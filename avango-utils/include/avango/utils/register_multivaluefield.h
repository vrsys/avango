...
{
template <class Type>
class MultiValueFieldWrapper
{
  public:
    MultiValueFieldWrapper(Type& Field) : mField(Field) {}
...
template <class Type>
MultiValueFieldWrapper<Type> MultiValueField_get_all_values(Type& self)
{
    return MultiValueFieldWrapper<Type>(self);
}

template <class Type>
void MultiValueField_set_all_values(Type& self, boost::python::object value)
{
...
template <class Type>
void MultiValueField_set_some_values(Type& self, boost::python::object value, boost::python::object inds)
{
    using value_type = typename Type::ValueType;
...
template <class Type>
void register_multivaluefield(std::string name)
{
