...
/* virtual */ void
av::utils::PCLPointCloud::fieldHasChanged(const av::Field& field)
{
...
/* virtual */ void
av::utils::PCLPointCloud::evaluate()
{
...
void
av::utils::PCLPointCloud::loadPCDFile(std::string filename)
{
  ...
  } else
  {
    ...
    {
      points.push_back(::osg::Vec3f(cloud.points[i].x, cloud.points[i].y,
          cloud.points[i].z));
