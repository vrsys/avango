...
/* virtual */ void
av::utils::ProximitySensor::evaluate()
{
...
void
av::utils::ProximitySensor::set_proximity_value(double proximity)
{
...
void
av::utils::ProximitySensor::set_switch_value(int switch_)
{
...
double
av::utils::ProximitySensor::smooth(double x)
{
  if (x<=0.)
    return 0.;
  else if (x>=1.)
