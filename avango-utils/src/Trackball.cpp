...
av::utils::Trackball::Trackball() : mTimeLastMovement(0.0), mLastDirection(0.0, 0.0), mLastProjected(0.0, 0.0, 0.0), mDragging(false), mSpinning(false), mReset(false)
{
...
void av::utils::Trackball::reset()
{
    if(CenterToBoundingSphere.getValue() && Enable.getValue())
    {
        ...
        ::gua::math::vec3 offset_inv = ::gua::math::vec3(-offset.x, -offset.y, -offset.z);
...
/* virtual */ void av::utils::Trackball::fieldHasChanged(const av::Field& field)
{
