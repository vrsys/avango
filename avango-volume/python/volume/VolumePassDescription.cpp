...
void init_VolumePassDescription()
{
    ...
    class_<av::gua::VolumePassDescription, av::Link<av::gua::VolumePassDescription>, bases<av::gua::PipelinePassDescription>, boost::noncopyable>("VolumePassDescription", "docstring", no_init);
}
