...
av::gua::VolumeLoader::VolumeLoader(::gua::VolumeLoader* guaVolumeLoader) : m_guaVolumeLoader(guaVolumeLoader) {}

// av::gua::VolumeLoader::~VolumeLoader()
//{}

av::Link<av::gua::Node> av::gua::VolumeLoader::load(std::string const& nodename, std::string const& fileName, Flags flags) const
{
...
void av::gua::VolumeLoader::initClass()
{
...
::gua::VolumeLoader* av::gua::VolumeLoader::getGuaVolumeLoader() const { return m_guaVolumeLoader; }

av::gua::Node* av::gua::VolumeLoader::createChildren(std::shared_ptr<::gua::node::Node> root) const
{
