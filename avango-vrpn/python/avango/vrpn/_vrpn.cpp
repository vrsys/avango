...
BOOST_PYTHON_MODULE(_vrpn)
{
  ...
  class_<av::vrpn::Service, av::Link<av::vrpn::Service>, bases<av::FieldContainer>, boost::noncopyable >("Service",
            "Docstring", no_init);
      register_field<av::vrpn::SFService>("SFService");
      register_multifield<av::vrpn::MFService>("MFService");

  class_<av::vrpn::Button, av::Link<av::vrpn::Button>, bases<av::FieldContainer>, boost::noncopyable >("Button",
			  "Docstring", no_init);
