...
def start():
    ...
    device.Station.value = "oculus-head-0"  # 0 for first xbox controller
    ...
    monkey.Transform.value = avango.gua.make_trans_mat(0.0, -1.0, 0.0)*avango.gua.make_scale_mat(0.1)
