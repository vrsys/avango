...
def start():
    ...
    # multi_view_explorer.my_constructor(multi_view_trans_node, 4.0, 2.0)
    ...
    pipeline_description = avango.gua.nodes.PipelineDescription(
        # Passes=[dynamic_tri_pass, lvis_pass, res_pass],  
        Passes=[ plod_pass, dynamic_tri_pass, lvis_pass,res_pass],  
