...
class LocalizedImageController:
    ...
    def __init__(self, dt_loader, aux_loader, graph, parent, aux_path, atlas_path):
        self.graph = graph
        self.parent = parent
        ...
        # Create loaders
        self.dynamic_tri_loader = dt_loader
        ...
        self.photo_projector = PhotoProjection()
        self.photo_projector.my_constructor()
        self.photo_projector.set_localized_image_list(self.localized_images)
        self.photo_projector.Graph.value = graph
        self.photo_projector.Texture.value = atlas_path

        graph.Root.value.Children.value.append(self.photo_projector.group_node)
        # self.parent.Children.value.append(self.photo_projector.group_node)
    ...
    def setup_localized_images(self):
        ...
        self.dynamic_triangle_node.Material.value.EnableBackfaceCulling.value = False
...
class LocalizedImageQuad:
    ...
    def setup(self):
        ...
        print('x min max y min max', self.tile_pos_x, self.tile_pos_x + self.tile_w, self.tile_pos_y, self.tile_pos_y + self.tile_h)
