...
def init_lcd_wall_tracking():
    ...
    _dtrack.stations[10] = avango.daemon.Station('tracking-lcd-glasses-2') # Mitsubishi 3D-TV glasses
...
def init_mouse(EVENT_STRING, STATION_STRING):
    ...
    init_hid_device(EVENT_STRING = EVENT_STRING, STATION_STRING = STATION_STRING, VALUE_MAPPINGS = _value_mappings, BUTTON_MAPPINGS = _button_mappings)#, TIMEOUT = '6')    
...
def init_keypad(EVENT_STRING, STATION_STRING):
    ...
    _button_mappings.append( (9, "EV_KEY::KEY_BACKSPACE") )
    _button_mappings.append( (31, "EV_KEY::KEY_KP0") )
    _button_mappings.append( (19, "EV_KEY::KEY_KP1") )
    _button_mappings.append( (20, "EV_KEY::KEY_KP2") )
    _button_mappings.append( (21, "EV_KEY::KEY_KP3") )
    _button_mappings.append( (22, "EV_KEY::KEY_KP4") )
    _button_mappings.append( (27, "EV_KEY::KEY_ENTER") )
    _button_mappings.append( (29, "EV_KEY::KEY_KP5") )
    #_button_mappings.append( (15, "EV_KEY::KEY_KP6") )
    _button_mappings.append( (30, "EV_KEY::KEY_KP6") )
    _button_mappings.append( (18, "EV_KEY::KEY_KP9") )
    _button_mappings.append( (25, "EV_KEY::KEY_KP7") )
    _button_mappings.append( (26, "EV_KEY::KEY_KP8") )
    _button_mappings.append( (12, "EV_KEY::KEY_KPSLASH") )
    _button_mappings.append( (10, "EV_KEY::KEY_KPASTERISK") )
    _button_mappings.append( (23, "EV_KEY::KEY_KPMINUS") )
    _button_mappings.append( (24, "EV_KEY::KEY_KPPLUS") )
    _button_mappings.append( (17, "EV_KEY::KEY_KPDOT") )
...
#_button_mapping = [(0, "EV_KEY::KEY_VOLUMEUP"), (1, "EV_KEY::KEY_VOLUMEDOWN")] # dragging & reference
#_button_mapping = [(1, "EV_KEY::KEY_VOLUMEDOWN"), (2, "EV_KEY::KEY_VOLUMEUP")] # reference & lens
_button_mapping = [(0, "EV_KEY::KEY_VOLUMEUP"), (1, "EV_KEY::KEY_PAGEUP"), (2, "EV_KEY::KEY_VOLUMEDOWN")] # dragging & reference & lens
...
## gunpointer (green)
#_button_mapping = [(0, "EV_KEY::KEY_ESC")] # dragging
#_button_mapping = [(1, "EV_KEY::KEY_ESC")] # lens
#_button_mapping = [(2, "EV_KEY::KEY_ESC"), (0, "EV_KEY::KEY_ENTER")]
