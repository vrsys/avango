...
def init_dbl_tracking():
    ...
    _dtrack.stations[4] = avango.daemon.Station('buw-pointer-white') 
    ...
    _dtrack.stations[34] = avango.daemon.Station('Volifoni1')
    _dtrack.stations[35] = avango.daemon.Station('Volifoni2')
    _dtrack.stations[36] = avango.daemon.Station('Volifoni3')
    _dtrack.stations[37] = avango.daemon.Station('Volifoni4')
    _dtrack.stations[38] = avango.daemon.Station('Volifoni5')
...
_button_mapping_buw_pointer =  [(0, "EV_KEY::BTN_TRIGGER_HAPPY10"),
                                (1, "EV_KEY::BTN_SELECT"),
                                (2, "EV_KEY::BTN_TRIGGER_HAPPY11"), 
                                (3, "EV_KEY::BTN_TR2"), 
                                (4,"EV_KEY::BTN_TRIGGER_HAPPY9"),
                                (5, "EV_KEY::BTN_START")]
init_hid_device(EVENT_STRING = get_event_string(1, "BUW VR Pointer"), STATION_STRING = "white-pointer", BUTTON_MAPPINGS = _button_mapping_buw_pointer)
# _button_mapping_buw_pointer_black =  [(0, "EV_KEY::BTN_TRIGGER_HAPPY4"),
#                                 (1, "EV_KEY::BTN_SELECT"),
#                                 (2, "EV_KEY::BTN_TRIGGER_HAPPY5"), 
#                                 (3, "EV_KEY::BTN_TR2"), 
#                                 (4,"EV_KEY::BTN_TRIGGER_HAPPY3"),
#                                 (5, "EV_KEY::BTN_START")]

_button_mapping_buw_pointer_black =  [(0, "EV_KEY::BTN_TRIGGER_HAPPY4"),
                                (1, "EV_KEY::BTN_TRIGGER_HAPPY5"), 
                                (2,"EV_KEY::BTN_TRIGGER_HAPPY3")]

init_hid_device(EVENT_STRING = get_event_string(1, "BUW VR Pointer"), STATION_STRING = "black-pointer", BUTTON_MAPPINGS = _button_mapping_buw_pointer_black)
