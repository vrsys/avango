...
class PhotoProjection(avango.script.Script):
  ...
  def update_perspective(self):
    if self.last_lense_pos:
      ...
      print('Photo Projection: Update Perspective')
      ...
      tile_scale =  0.2
      self.screen.Width.value = self.localized_image_list[closest_id].img_w_half / 3.04* (1/tile_scale)
      self.screen.Height.value = self.localized_image_list[closest_id].img_h_half / 3.04 * (1/tile_scale)
