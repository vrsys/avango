...
def init_lcd_wall_tracking():
  ...
  # head tracking  
  _dtrack.stations[17] = avango.daemon.Station('tracking-oculus-1')  # New Oculus Rift prototype
  _dtrack.stations[18] = avango.daemon.Station('tracking-oculus-2')  # Old Oculus Rift prototype
