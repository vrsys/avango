...
monkey1.Material.value.set_uniform("Color", avango.gua.Vec4(1.0, 0.766, 0.336,
                                                            1.0))
monkey1.Material.value.set_uniform("Roughness", 0.3)
monkey1.Material.value.set_uniform("Metalness", 1.0)

monkey2.Material.value.set_uniform("Color", avango.gua.Vec4(1.0, 0.266, 0.136,
                                                            1.0))
...
nettrans.Children.value = [monkey_transform1, light, screen]

graph.Root.value.Children.value = [nettrans, monkey_transform2]
