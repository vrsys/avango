...
class SpacemouseInput(MultiDofInput):
    ...
    def update_input(self): # override respective base class function    
        ...
        MultiDofInput.set_and_filter_dof(self, ID = 0, VALUE = _x, MIN = -0.76, MAX = 0.82, NEG_THRESHOLD = -4, POS_THRESHOLD = 4)
        MultiDofInput.set_and_filter_dof(self, ID = 1, VALUE = _y, MIN = -0.7, MAX = 0.6, NEG_THRESHOLD = -4, POS_THRESHOLD = 4)
        MultiDofInput.set_and_filter_dof(self, ID = 2, VALUE = _z, MIN = -0.95, MAX = 0.8, NEG_THRESHOLD = -4, POS_THRESHOLD = 4)
        MultiDofInput.set_and_filter_dof(self, ID = 3, VALUE = _rx, MIN = -0.82, MAX = 0.8, NEG_THRESHOLD = -8, POS_THRESHOLD = 8)
        MultiDofInput.set_and_filter_dof(self, ID = 4, VALUE = _ry, MIN = -0.5, MAX = 0.6, NEG_THRESHOLD = -8, POS_THRESHOLD = 8)
        MultiDofInput.set_and_filter_dof(self, ID = 5, VALUE = _rz, MIN = -0.86, MAX = 0.77, NEG_THRESHOLD = -8, POS_THRESHOLD = 8)
      
        _button0 = self.get_button0()
        _button1 = self.get_button1()
